...
def build_image():
    ...
    run_cmd(["nasm", "-f", "bin", "tests/programs/ovltest.asm", "-o", os.path.join(BUILDDIR, "ovltest.com")])
    run_cmd(["nasm", "-f", "bin", "tests/programs/overlay.asm", "-o", os.path.join(BUILDDIR, "overlay.exe")])
    run_cmd([
