...
- Minimal XMS support covers `INT 2Fh AX=4300h/4310h` plus XMS entry functions for version, query, allocate, free, move, lock, unlock, and handle info. `scripts/test_xms.py` covers detection, query, allocation, conventional-to-XMS-to-conventional data movement, and move bounds rejection.
