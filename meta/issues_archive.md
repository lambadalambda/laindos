...
- [x] [Preserve FAT16 Dirty Window On Flush Failure](issues/preserve-fat16-dirty-window-on-flush-failure.md)
- [x] [Flush Dirty FAT16 Window Despite Pending FAT Error](issues/flush-dirty-fat16-window-despite-pending-fat-error.md)
- [x] [Keep CD Refresh Read Method Consistent](issues/keep-cd-refresh-read-method-consistent.md)
- [x] [Preserve DI In CD Sector Fetch](issues/preserve-di-in-cd-sector-fetch.md)
