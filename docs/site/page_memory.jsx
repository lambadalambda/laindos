...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [644, "    mov word [cs:exec_env_seg], 0"],
      [646, "    mov bx, ENV_PARAS"],
      [647, "    call alloc_mem_direct"],
      [649, "    mov [cs:exec_env_seg], ax"],
      [652, "    dec ax"],
      [653, "    mov ds, ax"],
      ...
      [695, "assign_exec_environment_owner:"],
      [699, "    mov bx, [cs:exec_env_seg]"],
      [704, "    dec bx"],
      [709, "    mov ax, [cs:cur_psp]"],
