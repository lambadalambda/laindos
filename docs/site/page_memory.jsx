...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [480, "assign_exec_environment_owner:"],
      [484, "    mov bx, [cs:exec_env_seg]"],
      [489, "    dec bx"],
      [496, "    mov ax, [cs:cur_psp]"],
      [497, "    mov [ds:1], ax"]],
    hi: [{a: "alloc_exec_environment_start"}, {a: "alloc_exec_environment_temp_owner"}, {a: "free_exec_environment_start"}, 480, 496, 497],
