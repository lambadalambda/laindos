...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1246, "    je .as_set"],
      [598, "    xor ax, ax"],
      [1250, "    mov al, [cs:alloc_strat]"],
      [1253, "    cmp bl, 2"],
      [1255, "    mov [cs:alloc_strat], bl"],
      [1292, ".alloc_mem:"],
      [1299, "    mov al, [cs:alloc_strat]"],
      [980, "    cmp al, 2"],
      [1305, "    jmp near .am_find_last"],
      [1305, "    cmp al, 1"],
      [1309, "    jmp near .am_find_best"],
      [1311, "    cmp word [cs:am_req], 1"],
      [1313, "    cmp word [cs:am_req], SMALL_ALLOC_HIGH_MAX"],
      [1313, "    jmp near .am_find_last"],
      [1317, "    mov si, [cs:mcb_first]"],
      [1330, "    cmp ax, [cs:am_req]"],
      [1332, ".am_use:"],
      [955, "    mov ax, [cs:cur_psp]"],
      [1398, ".am_find_last:"],
      [1422, ".am_find_best:"],
      [1479, ".am_nomem:"],
      [1482, ".am_scan_largest:"],
      [1503, "    mov ax, 8"]],
  ...
  },
  {
    ...
    code: [
      ...
      [1535, "    mov si, es"],
      [1536, "    dec si"],
      [1320, "    cmp byte [ds:0], MCB_SIG_M"],
      [1322, "    cmp byte [ds:0], MCB_SIG_Z"],
      [1545, "    mov word [ds:1], 0"],
      [1546, "    call mcb_merge_free_forward"],
      [1553, ".resize_mem:"],
      [1560, "    mov [cs:rm_req], bx"],
      [1559, "    mov si, es"],
      [1329, "    mov ax, [ds:3]"],
      [1573, "    jae .rm_shrink"],
      [1581, "    cmp byte [es:0], MCB_SIG_M"],
      [1586, "    cmp word [es:1], 0"],
      [1590, "    add ax, cx"],
      [1493, "    cmp ax, bx"],
      [1605, "    mov byte [es:0], dl"],
      [1350, "    mov byte [ds:0], MCB_SIG_M"],
      [1349, "    mov word [es:3], cx"],
      [1612, "    mov word [ds:3], bx"],
      [1614, "    mov ax, [ds:3]"],
      [1624, "    mov byte [es:0], dl"],
      [1345, "    mov word [es:1], 0"],
