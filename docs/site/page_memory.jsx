...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1262, "    je .as_set"],
      [614, "    xor ax, ax"],
      [1266, "    mov al, [cs:alloc_strat]"],
      [1269, "    cmp bl, 2"],
      [1271, "    mov [cs:alloc_strat], bl"],
      [1308, ".alloc_mem:"],
      [1317, "    mov al, [cs:alloc_strat]"],
      [996, "    cmp al, 2"],
      [1321, "    jmp near .am_find_last"],
      [1323, "    cmp al, 1"],
      [1325, "    jmp near .am_find_best"],
      [1327, "    cmp word [cs:am_req], 1"],
      [1329, "    cmp word [cs:am_req], SMALL_ALLOC_HIGH_MAX"],
      [1321, "    jmp near .am_find_last"],
      [1333, "    mov si, [cs:mcb_first]"],
      [1346, "    cmp ax, [cs:am_req]"],
      [1348, ".am_use:"],
      [971, "    mov ax, [cs:cur_psp]"],
      [1414, ".am_find_last:"],
      [1438, ".am_find_best:"],
      [1495, ".am_nomem:"],
      [1498, ".am_scan_largest:"],
      [1519, "    mov ax, 8"]],
  ...
  },
  {
    ...
    code: [
      ...
      [1551, "    mov si, es"],
      [1552, "    dec si"],
      [1336, "    cmp byte [ds:0], MCB_SIG_M"],
      [1338, "    cmp byte [ds:0], MCB_SIG_Z"],
      [1561, "    mov word [ds:1], 0"],
      [1562, "    call mcb_merge_free_forward"],
      [1569, ".resize_mem:"],
      [1576, "    mov [cs:rm_req], bx"],
      [1577, "    mov si, es"],
      [1345, "    mov ax, [ds:3]"],
      [1589, "    jae .rm_shrink"],
      [1597, "    cmp byte [es:0], MCB_SIG_M"],
      [1602, "    cmp word [es:1], 0"],
      [1606, "    add ax, cx"],
      [1509, "    cmp ax, bx"],
      [1621, "    mov byte [es:0], dl"],
      [1366, "    mov byte [ds:0], MCB_SIG_M"],
      [1365, "    mov word [es:3], cx"],
      [1628, "    mov word [ds:3], bx"],
      [1612, "    mov ax, [ds:3]"],
      [1642, "    mov byte [es:0], dl"],
      [1361, "    mov word [es:1], 0"],
      [1628, "    mov word [ds:3], bx"],
      [1690, "    mov [es:0x02], ax"],
      [1733, ".rm_cant_grow:"],
      [1511, "    mov bx, ax"],
