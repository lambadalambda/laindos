...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [3816, "%if (HMA_OFF + (kernel_end - kernel_entry)) > (KERNEL_STACK_TOP - KERNEL_STACK_GUARD_BYTES)"],
      [3817, "%error \"kernel leaves too little HMA stack guard\""],
      [3819, "%if (kernel_end - kernel_entry) > ((MEM_TOP - LOAD_SEG) * 16)"],
      [3820, "%error \"kernel exceeds boot load area\""],
      [3822, "%if (FAT_SEG + 0x120) > CD_BUF"],
      [3823, "%error \"FAT buffer overlaps CD_BUF\""],
      [3825, "%if (CD_BUF + CD_BUF_PARAS) > SEC_BUF"],
      [3826, "%error \"CD_BUF overlaps SEC_BUF\""],
      [3828, "%if (SEC_BUF + SECTOR_BUF_PARAS) > READ_CACHE_BUF"],
      [3829, "%error \"SEC_BUF overlaps READ_CACHE_BUF\""],
      [3831, "%if (READ_CACHE_BUF + SECTOR_BUF_PARAS) > ROOT_SEG"],
      [3832, "%error \"READ_CACHE_BUF overlaps ROOT_SEG\""],
      [3834, "%if (ROOT_SEG + ROOT_BUF_PARAS) > MCB_START"],
      [3835, "%error \"ROOT_SEG overlaps MCB arena\""],
      [3837, "%if MCB_START >= MEM_TOP"],
      [3838, "%error \"MCB arena is empty\""],
      [3840, "%if ENABLE_EMS && EMS_FRAME_SEG <= MCB_START"],
      [3841, "%error \"EMS frame must be inside conventional arena\""],
      [3852, "%if ENABLE_XMS && XMS_MAX_KB > 15360"],
  ...
  },
  {
    ...
    code: [
      [2498, "do_terminate:"],
      [2508, "%if ENABLE_EMS"],
      [2365, "    mov word [cs:ems_alloc_pages], 0"],
      [2512, "    mov word [cs:xms_alloc_kb], 0"],
      [2513, "    call release_inherited_handles"],
      [2514, "    call close_owned_handles"],
      [2516, "    mov si, [cs:mcb_first]"],
      [2518, "    mov ds, si"],
      [2525, "    mov ax, [cs:cur_psp]"],
      [2526, "    cmp word [ds:1], ax"],
      [2528, "    mov word [ds:1], 0"],
      [2532, "    call mcb_walk_next"],
      [2536, "    call mcb_coalesce_all_free"],
      [2541, "    mov ax, [0x16]"],
  ...
  },
  {
    ...
    code: [
      ...
      [1844, "init_xms_size:"],
      [1846, "    mov word [cs:xms_total_kb], 0"],
      [1847, "    mov ah, 0x88"],
      [1848, "    int 0x15"],
      [1853, "    cmp ax, XMS_MAX_KB - 64"],
      [1855, "    mov ax, XMS_MAX_KB - 64"],
      [1857, "    mov [cs:xms_total_kb], ax"],
      [1879, "int2f_handler:"],
      [1889, "    cmp ax, 0x4300"],
      [1891, "    cmp ax, 0x4310"],
      [1897, "    mov al, 0x80"],
      [1900, "    mov bx, xms_entry"],
      [1913, "xms_entry:"],
      [1930, "    cmp ah, 0x08"],
      [1932, "    cmp ah, 0x09"],
      [1934, "    cmp ah, 0x0A"],
      [1936, "    cmp ah, 0x0B"],
      [1973, "    mov ax, [cs:xms_total_kb]"],
      [1997, "    cmp word [cs:xms_alloc_kb], 0"],
      [1983, "    cmp dx, [cs:xms_total_kb]"],
      [1985, "    mov [cs:xms_alloc_kb], dx"],
      [2000, "    mov ax, 1"],
      [1987, "    mov dx, 1"],
      [1999, "    mov word [cs:xms_alloc_kb], 0"],
      [2003, ".move:"],
      [2012, "    test ax, 1"],
      [2020, "    call xms_prepare_endpoint"],
      [2020, "    call xms_prepare_endpoint"],
      [2074, "    mov ax, 0x8700"],
  ...
  },
  {
    ...
    code: [
      ...
      [1644, "%if ENABLE_EMS"],
      [1645, "    mov [es:0x67*4], word int67_handler"],
      [1647, "%else"],
      [1648, "    mov [es:0x67*4], word int67_absent_handler"],
      [2231, "%if !ENABLE_EMS"],
      [2232, "int67_absent_handler:"],
      [2233, "    mov ah, 0x80"],
      [2237, "%if ENABLE_EMS"],
      [2238, "int67_handler:"],
      [2262, ".frame:"],
      [2264, "    mov bx, EMS_FRAME_SEG"],
      [2266, ".pages:"],
      [2267, "    mov bx, EMS_TOTAL_PAGES"],
      [2272, ".alloc:"],
      [2277, "    cmp bx, EMS_TOTAL_PAGES"],
      [2279, "    mov [cs:ems_alloc_pages], bx"],
      [2287, ".map:"],
      [2292, "    cmp al, 3"],
      [2294, "    cmp bx, [cs:ems_alloc_pages]"],
      [2319, "    call ems_copy_16k"],
      [2319, "    call ems_copy_16k"],
      [2337, "    mov [cs:si+ems_map_pages], bx"],
      [2365, "    mov word [cs:ems_alloc_pages], 0"],
      [2389, "ems_clear_map:"],
