...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [632, "    mov word [cs:exec_env_seg], 0"],
      [634, "    mov bx, ENV_PARAS"],
      [635, "    call alloc_mem_direct"],
      [637, "    mov [cs:exec_env_seg], ax"],
      [640, "    dec ax"],
      [641, "    mov ds, ax"],
      ...
      [683, "assign_exec_environment_owner:"],
      [687, "    mov bx, [cs:exec_env_seg]"],
      [692, "    dec bx"],
      [697, "    mov ax, [cs:cur_psp]"],
      [698, "    mov [ds:1], ax"]],
