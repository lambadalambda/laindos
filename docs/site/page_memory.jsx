...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [4301, "%if MCB_START >= MEM_TOP"],
      [4302, "%error \"MCB arena is empty\""],
      [4304, "%if ENABLE_EMS && EMS_FRAME_SEG <= MCB_START"],
      [4305, "%error \"EMS frame must be inside conventional arena\""],
      [4316, "%if ENABLE_XMS && XMS_MAX_KB > 15360"],
      [{a: "xms_backing_limit_error"}, "%error \"XMS BIOS move backing must remain below 16 MiB\""]],
    hi: [4277, 4280, 4283, 4277, 4277, 4277, 4280, 4283, 4277, 4316],
