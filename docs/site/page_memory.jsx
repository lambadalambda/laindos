...
const MEM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [49, "    mov word [es:1], 0"],
      [53, "    mov word [es:3], cx"],
      [54, "    mov byte [ds:0], MCB_SIG_M"],
      [56, "    mov word [ds:3], ax"],
      [60, "    mov ax, [cs:cur_psp]"],
      [61, "    mov word [ds:1], ax"],
      [63, "    inc ax"]],
    hi: [1, 18, 39, 54, 61, 63],
  ...
  },
  {
    ...
    code: [
      ...
      [427, "    mov word [cs:exec_env_seg], 0"],
      [429, "    mov bx, ENV_PARAS"],
      [430, "    call alloc_mem_direct"],
      [432, "    mov [cs:exec_env_seg], ax"],
      [435, "    dec ax"],
      [436, "    mov ds, ax"],
      ...
      [478, "assign_exec_environment_owner:"],
      [482, "    mov bx, [cs:exec_env_seg]"],
      [487, "    dec bx"],
      [492, "    mov ax, [cs:cur_psp]"],
      [493, "    mov [ds:1], ax"]],
    hi: [{a: "alloc_exec_environment_start"}, {a: "alloc_exec_environment_temp_owner"}, {a: "free_exec_environment_start"}, 478, 492, 493],
