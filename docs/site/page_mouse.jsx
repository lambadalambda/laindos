...
const MOUSE_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [88, ".get_pos:"],
      [89, "    mov bx, [cs:mouse_buttons]"],
      [90, "    mov cx, [cs:mouse_x]"],
      [91, "    mov dx, [cs:mouse_y]"],
      [93, ".set_pos:"],
      [94, "    mov [cs:mouse_x], cx"],
      [99, "    call mouse_clamp_position"],
      [102, ".set_x_range:"],
      [103, "    cmp cx, dx"],
      [105, "    xchg cx, dx"],
      [107, "    mov [cs:mouse_min_x], cx"],
      [113, ".set_y_range:"],
      [118, "    mov [cs:mouse_min_y], cx"],
      [190, ".set_ratio:"],
      [195, "    cmp cx, 2048"],
      [207, "    mov [cs:mouse_ratio_x], cx"],
      [209, "    mov word [cs:mouse_scale_rem_x], 0"],
      [242, "mouse_clamp_position:"],
      [244, "    cmp ax, [cs:mouse_min_x]"],
  ...
  },
  {
    ...
    file: "src/kernel/mouse.inc",
    code: [
      [124, ".get_button_press:"],
      [135, ".get_left_press:"],
      [137, "    mov bx, [cs:mouse_press_count_l]"],
      [138, "    mov cx, [cs:mouse_press_x_l]"],
      [140, "    mov word [cs:mouse_press_count_l], 0"],
      [151, ".get_button_release:"],
      [162, ".get_left_release:"],
      [164, "    mov bx, [cs:mouse_release_count_l]"],
      [165, "    mov cx, [cs:mouse_release_x_l]"],
      [167, "    mov word [cs:mouse_release_count_l], 0"],
      [178, ".get_motion:"],
      [179, "    mov cx, [cs:mouse_motion_x]"],
      [180, "    mov dx, [cs:mouse_motion_y]"],
  ...
  },
  {
    ...
    code: [
      ...
      [355, "    mov al, 0x60"],
      [359, "    mov al, 0x47"],
      [367, "    mov byte [cs:mouse_ps2_enabled], 1"],
      [460, "mouse_poll_ps2:"],
      [465, "    in al, 0x64"],
      [468, "    test al, 0x20"],
      [470, "    in al, 0x60"],
      [471, "    call mouse_ps2_byte"],
      [476, "mouse_ps2_byte:"],
      [485, "    test al, 0x08"],
      [502, "    test byte [cs:mouse_packet0], 0x40"],
      [506, "    test byte [cs:mouse_packet0], 0x10"],
      [516, "    call mouse_scale_x"],
      [517, "    call mouse_apply_delta_x"],
      [531, "    neg ax"],
  ...
  },
  {
    ...
    file: "src/kernel/mouse.inc",
    code: [
      [538, "    mov bx, [cs:mouse_buttons]"],
      [539, "    mov ax, [cs:mouse_new_buttons]"],
      [544, "    or word [cs:mouse_event_mask], 0x0004"],
      [545, "    inc word [cs:mouse_release_count_l]"],
      [554, "    or word [cs:mouse_event_mask], 0x0002"],
      [555, "    inc word [cs:mouse_press_count_l]"],
      [565, "    or word [cs:mouse_event_mask], 0x0010"],
      [575, "    or word [cs:mouse_event_mask], 0x0008"],
      [582, "    mov [cs:mouse_buttons], ax"],
      [583, "    call mouse_invoke_callback"],
      [587, "mouse_invoke_callback:"],
      [589, "    test ax, [cs:mouse_callback_mask]"],
      [599, "    and ax, [cs:mouse_callback_mask]"],
      [600, "    mov bx, [cs:mouse_buttons]"],
      [603, "    mov si, [cs:mouse_event_dx]"],
      [605, "    sti"],
      [606, "    call far [cs:mouse_callback_off]"],
      [607, "    cli"],
      [621, "irq12_handler:"],
      [631, "    in al, 0x60"],
      [634, "    out 0xA0, al"],
