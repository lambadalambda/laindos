...
const MOUSE_SECTIONS = [
  {
    ...
    code: [
      ...
      [55, "    iret"],
      [107, ".reset:"],
      [112, "    mov word [cs:mouse_x], 320"],
      [113, "    mov word [cs:mouse_y], 100"],
      [123, "    mov word [cs:mouse_callback_mask], 0"],
      [127, "    mov word [cs:mouse_ratio_x], 8"],
      [135, "    mov ax, 0xFFFF"],
      [136, "    mov bx, 2"],
      [84, "    iret"],
    ],
    hi: [1, 20, 23, 55, 107, 123, 127, 135, 136],
  ...
  },
  {
    ...
    code: [
      [147, ".get_pos:"],
      [148, "    mov bx, [cs:mouse_buttons]"],
      [149, "    mov cx, [cs:mouse_x]"],
      [150, "    mov dx, [cs:mouse_y]"],
      [152, ".set_pos:"],
      [153, "    mov [cs:mouse_x], cx"],
      [158, "    call mouse_clamp_position"],
      [161, ".set_x_range:"],
      [162, "    cmp cx, dx"],
      [164, "    xchg cx, dx"],
      [166, "    mov [cs:mouse_min_x], cx"],
      [172, ".set_y_range:"],
      [177, "    mov [cs:mouse_min_y], cx"],
      [249, ".set_ratio:"],
      [254, "    cmp cx, 2048"],
      [266, "    mov [cs:mouse_ratio_x], cx"],
      [155, "    mov word [cs:mouse_scale_rem_x], 0"],
      [301, "mouse_clamp_position:"],
      [303, "    cmp ax, [cs:mouse_min_x]"],
      [307, "    cmp ax, [cs:mouse_max_x]"],
      [321, "    mov [cs:mouse_y], ax"],
    ],
    hi: [147, 147, 153, 161, 172, 249, 266, 301],
  ...
  },
  {
    ...
    file: "src/kernel/mouse.inc",
    code: [
      [183, ".get_button_press:"],
      [194, ".get_left_press:"],
      [196, "    mov bx, [cs:mouse_press_count_l]"],
      [197, "    mov cx, [cs:mouse_press_x_l]"],
      [118, "    mov word [cs:mouse_press_count_l], 0"],
      [210, ".get_button_release:"],
      [221, ".get_left_release:"],
      [223, "    mov bx, [cs:mouse_release_count_l]"],
      [224, "    mov cx, [cs:mouse_release_x_l]"],
      [120, "    mov word [cs:mouse_release_count_l], 0"],
      [237, ".get_motion:"],
      [238, "    mov cx, [cs:mouse_motion_x]"],
      [239, "    mov dx, [cs:mouse_motion_y]"],
      [240, "    mov word [cs:mouse_motion_x], 0"],
      [241, "    mov word [cs:mouse_motion_y], 0"],
    ],
    hi: [183, 194, 194, 210, 221, 221, 237, 240, 241],
  ...
  },
  {
    ...
    code: [
      ...
      [414, "    mov al, 0x60"],
      [418, "    mov al, 0x47"],
      [426, "    mov byte [cs:mouse_ps2_enabled], 1"],
      [519, "mouse_poll_ps2:"],
      [463, "    in al, 0x64"],
      [527, "    test al, 0x20"],
      [454, "    in al, 0x60"],
      [530, "    call mouse_ps2_byte"],
      [535, "mouse_ps2_byte:"],
      [544, "    test al, 0x08"],
      [561, "    test byte [cs:mouse_packet0], 0x40"],
      [565, "    test byte [cs:mouse_packet0], 0x10"],
      [575, "    call mouse_scale_x"],
      [576, "    call mouse_apply_delta_x"],
      [590, "    neg ax"],
      [594, "    call mouse_apply_delta_y"],
    ],
    hi: [392, 401, 404, 408, 418, 519, 530, 527, 544, 575, 590, 535],
  ...
  },
  {
    ...
    body: [
      ...
      "Callback invocation is guarded against recursive mouse callbacks. The IRQ12 handler acknowledges both PICs before processing, and the callback itself runs with interrupts enabled so timer ticks and keystrokes keep flowing during long game callbacks. The game receives AX=matched mask, BX=buttons, CX/DX=position, and SI/DI=movement deltas, then returns with RETF. INT 21h calls made from the callback are rejected so DOS file I/O state is not re-entered.",
    ],
    file: "src/kernel/mouse.inc",
    code: [
      [597, "    mov bx, [cs:mouse_buttons]"],
      [598, "    mov ax, [cs:mouse_new_buttons]"],
      [603, "    or word [cs:mouse_event_mask], 0x0004"],
      [604, "    inc word [cs:mouse_release_count_l]"],
      [613, "    or word [cs:mouse_event_mask], 0x0002"],
      [614, "    inc word [cs:mouse_press_count_l]"],
      [624, "    or word [cs:mouse_event_mask], 0x0010"],
      [634, "    or word [cs:mouse_event_mask], 0x0008"],
      [641, "    mov [cs:mouse_buttons], ax"],
      [642, "    call mouse_invoke_callback"],
      [646, "mouse_invoke_callback:"],
      [648, "    test ax, [cs:mouse_callback_mask]"],
      [658, "    and ax, [cs:mouse_callback_mask]"],
      [597, "    mov bx, [cs:mouse_buttons]"],
      [664, "    mov si, [cs:mouse_motion_x]"],
      [665, "    mov di, [cs:mouse_motion_y]"],
      [688, "    sti"],
      [689, "    call far [cs:mouse_callback_off]"],
      [690, "    cli"],
      [704, "irq12_handler:"],
      [714, "    in al, 0x60"],
      [717, "    out 0xA0, al"],
      [718, "    out 0x20, al"],
      [720, "    call mouse_ps2_byte"],
    ],
    hi: [664, 613, 624, 634, 634, 646, 648, 658, 689, 704, 720, 634, 718],
