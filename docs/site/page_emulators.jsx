...
const EMULATOR_CHOICES = [
  {
    ...
    notes: ["QEMU_VGA defaults to `std,retrace=precise` for game runs.", "Use `-serial stdio` or a log file when tests need grep-able output.", "Attach `-device sb16` when a game setup path expects Sound Blaster 16."],
  },
  {
    name: "86Box compare",
    tag: "hardware flavor",
...
const EMULATOR_TARGETS = [
  ...
  ["Wolfenstein 3D", "QEMU VGA retrace", "make test-wolf3d-smoke", "Uses precise retrace so 0x3DA polling loops advance."],
