...
const CASES = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1215, "floppy_media_check:"],
      [1231, "    sub ax, [cs:floppy_check_tick]"],
      [1232, "    cmp ax, 36"],
      [1234, "    mov ah, 0x16"],
      [1236, "    int 0x13"],
      [1237, "    cmp ah, 0x06"],
      [1258, "    repe cmpsw"],
      [1260, "    call floppy_media_remount"],
    ],
    hi: [1232, 1237, 1258],
  ...
  },
  {
    ...
    code: [
      [1867, "cd_audio_or_busy:"],
      [1870, "    call cd_audio_subchannel"],
      [1872, "    mov cx, CD_BUF"],
      [1874, "    cmp byte [es:1], 0x11"],
      [1876, "    or ax, 0x0200"],
    ],
    hi: [1874, 1876],
