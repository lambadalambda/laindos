...
const CASES = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [201, "    ; arena ends at the BIOS conventional-memory line, not at 640K: the"],
      [203, "    mov ax, [mem_kib]"],
      [204, "    mov cl, 6"],
      [205, "    shl ax, cl"],
      [206, "    cmp ax, MEM_TOP"],
      [207, "    jbe .arena_top_ok"],
      [208, "    mov ax, MEM_TOP"],
      [209, ".arena_top_ok:"],
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1227, "floppy_media_check:"],
      [1243, "    sub ax, [cs:floppy_check_tick]"],
      [1244, "    cmp ax, 36"],
      [1246, "    mov ah, 0x16"],
      [1248, "    int 0x13"],
      [1249, "    cmp ah, 0x06"],
      [1270, "    repe cmpsw"],
      [1272, "    call floppy_media_remount"],
    ],
    hi: [1243, 1246, 1270],
