...
const DOSAPI_GROUPS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1999, "    call exec_com_dyn"],
      [2002, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [213, "    cmp ah, 0x11"],
      [214, "    je .fcb_find_first"],
      [215, "    cmp ah, 0x12"],
      [216, "    je .fcb_find_next"],
      [261, "    cmp ah, 0x1A"],
      [262, "    je .set_dta"],
      [295, "    cmp ah, 0x4E"],
      [296, "    je .find_first"],
      ...
      [298, "    je .find_next"],
      [627, ".fcb_find_first:"],
      [671, "    call .fcb_store_dta"],
      [4385, "    call store_find_dta"],
      [4347, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3756, "    je .ioctl_get"],
      [1279, "    cmp al, 6"],
      [3760, "    je .ioctl_input_status"],
      [492, "    cmp al, 8"],
      [3764, "    je .ioctl_removable_drive"],
      [3809, "    mov dx, 0x80D3"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [290, "    je .get_vector"],
      [291, "    cmp ah, 0x36"],
      [292, "    je .get_disk_free"],
      [319, "    cmp ah, 0x5D"],
      [320, "    je .dos_internal"],
      [331, "    cmp ah, 0x71"],
      [332, "    je .lfn_unsupported"],
      [841, ".get_version:"],
      [842, "    mov ax, 0x1E03"],
    ],
    regs: [
