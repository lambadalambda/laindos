...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [316, "    je .print_string"],
      [317, "    cmp ah, 0x01"],
      [318, "    je .read_char_echo"],
      [321, "    cmp ah, 0x06"],
      [322, "    je .direct_console_io"],
      [327, "    cmp ah, 0x0A"],
      [328, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [2236, "    call exec_com_dyn"],
      [2239, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [337, "    cmp ah, 0x11"],
      [338, "    je .fcb_find_first"],
      [339, "    cmp ah, 0x12"],
      [340, "    je .fcb_find_next"],
      [385, "    cmp ah, 0x1A"],
      [386, "    je .set_dta"],
      [423, "    cmp ah, 0x4E"],
      [424, "    je .find_first"],
  ...
  },
  {
    ...
    code: [
      ...
      [416, "    je .get_vector"],
      [417, "    cmp ah, 0x36"],
      [418, "    je .get_disk_free"],
      [447, "    cmp ah, 0x5D"],
      [448, "    je .dos_internal"],
      [459, "    cmp ah, 0x71"],
      [460, "    je .lfn_unsupported"],
      [1012, ".get_version:"],
      [1013, "    mov ax, 0x0005"],
    ],
    regs: [
