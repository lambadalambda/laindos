...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [367, "    je .print_string"],
      [368, "    cmp ah, 0x01"],
      [369, "    je .read_char_echo"],
      [372, "    cmp ah, 0x06"],
      [373, "    je .direct_console_io"],
      [378, "    cmp ah, 0x0A"],
      [379, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [489, "    je .rename_file"],
      [512, "    cmp ah, 0x6C"],
      [513, "    je near .extended_open_create"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [1955, ".exec:"],
      [1956, "    cmp al, 0"],
      [2014, "    call load_exec_program"],
      [2018, "    call exec_com_dyn"],
      [2021, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [388, "    cmp ah, 0x11"],
      [389, "    je .fcb_find_first"],
      [390, "    cmp ah, 0x12"],
      [391, "    je .fcb_find_next"],
      [436, "    cmp ah, 0x1A"],
      [437, "    je .set_dta"],
      [476, "    cmp ah, 0x4E"],
      [477, "    je .find_first"],
  ...
  },
  {
    ...
    code: [
      ...
      [459, "    je .get_version"],
      [462, "    cmp ah, 0x32"],
      [463, "    je near .get_drive_parameter_block"],
      [468, "    cmp ah, 0x35"],
      [469, "    je .get_vector"],
      [470, "    cmp ah, 0x36"],
      [471, "    je .get_disk_free"],
      [500, "    cmp ah, 0x5D"],
      [501, "    je .dos_internal"],
      [514, "    cmp ah, 0x71"],
      [515, "    je .lfn_unsupported"],
      [1067, ".get_version:"],
      [1068, "    mov ax, 0x0005"],
    ],
    regs: [
