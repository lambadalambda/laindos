...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [325, "    je .print_string"],
      [326, "    cmp ah, 0x01"],
      [327, "    je .read_char_echo"],
      [330, "    cmp ah, 0x06"],
      [331, "    je .direct_console_io"],
      [336, "    cmp ah, 0x0A"],
      [337, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [2245, "    call exec_com_dyn"],
      [2248, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [346, "    cmp ah, 0x11"],
      [347, "    je .fcb_find_first"],
      [348, "    cmp ah, 0x12"],
      [349, "    je .fcb_find_next"],
      [394, "    cmp ah, 0x1A"],
      [395, "    je .set_dta"],
      [432, "    cmp ah, 0x4E"],
      [433, "    je .find_first"],
  ...
  },
  {
    ...
    code: [
      ...
      [425, "    je .get_vector"],
      [426, "    cmp ah, 0x36"],
      [427, "    je .get_disk_free"],
      [456, "    cmp ah, 0x5D"],
      [457, "    je .dos_internal"],
      [468, "    cmp ah, 0x71"],
      [469, "    je .lfn_unsupported"],
      [1021, ".get_version:"],
      [1022, "    mov ax, 0x0005"],
    ],
    regs: [
