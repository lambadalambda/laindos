...
const DOSAPI_GROUPS = [
  ...
  },
  {
    ...
    code: [
      [1670, ".exec:"],
      [1671, "    cmp al, 0"],
      [1672, "    je .exec_program"],
      [1673, "    cmp al, 3"],
      [1674, "    je .exec_overlay"],
      [1700, "    call load_exec_program"],
      [1704, "    call exec_com_dyn"],
      [1707, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      ...
      [208, "    cmp ah, 0x4F"],
      [209, "    je .find_next"],
      [3863, "    mov ax, [cs:dta_seg]"],
      [3892, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3249, "    je .ioctl_get"],
      [3252, "    cmp al, 6"],
      [3253, "    je .ioctl_input_status"],
      [3256, "    cmp al, 8"],
      [3257, "    je .ioctl_removable_drive"],
      [3303, "    mov dx, 0x80D3"],
    ],
    regs: [
