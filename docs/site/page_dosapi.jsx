...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [194, "    je .print_string"],
      [195, "    cmp ah, 0x01"],
      [196, "    je .read_char_echo"],
      [199, "    cmp ah, 0x06"],
      [200, "    je .direct_console_io"],
      [205, "    cmp ah, 0x0A"],
      [206, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [2003, "    call exec_com_dyn"],
      [2006, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [215, "    cmp ah, 0x11"],
      [216, "    je .fcb_find_first"],
      [217, "    cmp ah, 0x12"],
      [218, "    je .fcb_find_next"],
      [263, "    cmp ah, 0x1A"],
      [264, "    je .set_dta"],
      [297, "    cmp ah, 0x4E"],
      [298, "    je .find_first"],
      ...
      [300, "    je .find_next"],
      [631, ".fcb_find_first:"],
      [675, "    call .fcb_store_dta"],
      [4389, "    call store_find_dta"],
      [4351, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3760, "    je .ioctl_get"],
      [1283, "    cmp al, 6"],
      [3764, "    je .ioctl_input_status"],
      [494, "    cmp al, 8"],
      [3768, "    je .ioctl_removable_drive"],
      [3813, "    mov dx, 0x80D3"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [292, "    je .get_vector"],
      [293, "    cmp ah, 0x36"],
      [294, "    je .get_disk_free"],
      [321, "    cmp ah, 0x5D"],
      [322, "    je .dos_internal"],
      [333, "    cmp ah, 0x71"],
      [334, "    je .lfn_unsupported"],
      [845, ".get_version:"],
      [846, "    mov ax, 0x1E03"],
    ],
    regs: [
