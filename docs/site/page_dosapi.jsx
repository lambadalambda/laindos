...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [362, "    je .print_string"],
      [363, "    cmp ah, 0x01"],
      [364, "    je .read_char_echo"],
      [367, "    cmp ah, 0x06"],
      [368, "    je .direct_console_io"],
      [373, "    cmp ah, 0x0A"],
      [374, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    calls: "AH=39h-43h,56h,57h,5Ah,5Bh,68h,6Ch",
    prose: [
      "This is the compatibility surface most games hit first: make and remove directories, change directory, create/open/close/read/write/seek files, delete, rename, get or set attributes, get or set file timestamps, create temporary files, create-new, extended open/create, and commit writes.",
    ...
    code: [
      ...
      [484, "    je .rename_file"],
      [507, "    cmp ah, 0x6C"],
      [508, "    je near .extended_open_create"],
    ],
    regs: [
    ...
    tests: ["scripts/test_savewrite.py", "scripts/test_dirmut.py", "scripts/test_findtime.py", "scripts/test_commit.py", "scripts/test_createapi.py"],
  },
  {
    id: "programs",
    ...
    code: [
      ...
      [1950, ".exec:"],
      [1951, "    cmp al, 0"],
      [2007, "    call load_exec_program"],
      [2011, "    call exec_com_dyn"],
      [2014, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
    ...
    tests: ["scripts/test_shell.py", "scripts/test_execparam.py", "scripts/test_spawn.py", "scripts/test_execenv.py", "scripts/test_overlay.py", "scripts/test_tsr.py", "scripts/test_compatapi.py", "scripts/test_norton_commander_launch.py"],
  },
  {
    id: "find",
    ...
    code: [
      [383, "    cmp ah, 0x11"],
      [384, "    je .fcb_find_first"],
      [385, "    cmp ah, 0x12"],
      [386, "    je .fcb_find_next"],
      [431, "    cmp ah, 0x1A"],
      [432, "    je .set_dta"],
      [471, "    cmp ah, 0x4E"],
      [472, "    je .find_first"],
      ...
      [474, "    je .find_next"],
      [848, ".fcb_find_first:"],
      [892, "    call .fcb_store_dta"],
      [{a: "find_first_store_dta"}, "    call store_find_dta"],
      [{a: "find_next_store_dta"}, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    calls: "AH=19h,1Bh,1Ch,25h,29h,2Ah-36h,38h,52h,54h,5Dh,60h,63h,71h",
    prose: [
    ...
    code: [
      ...
      [454, "    je .get_version"],
      [457, "    cmp ah, 0x32"],
      [458, "    je near .get_drive_parameter_block"],
      [463, "    cmp ah, 0x35"],
      [464, "    je .get_vector"],
      [465, "    cmp ah, 0x36"],
      [466, "    je .get_disk_free"],
      [495, "    cmp ah, 0x5D"],
      [496, "    je .dos_internal"],
      [509, "    cmp ah, 0x71"],
      [510, "    je .lfn_unsupported"],
      [1062, ".get_version:"],
      [1063, "    mov ax, 0x0005"],
    ],
    regs: [
...
const DOSAPI_CALLS = [
  {
    ...
    rows: [
      ...
      ["0Dh", "Disk reset", "compat", "Returns success; LainDOS writes synchronously, so there are no DOS disk buffers to flush."],
  ...
  },
  {
    ...
    rows: [
      ...
      ["32h", "Get drive parameter block", "compat", "Returns DS:BX for a kernel-owned DOS 4-style DPB backed by mounted FAT geometry, or AL=FFh for unavailable drives."],
  ...
  },
  {
    ...
    rows: [
      ...
      ["6Ch", "Extended open/create", "compat", "Supports DOS 4-style fail/open/replace and fail/create action bits, returning CX=1 opened, 2 created, or 3 replaced."],
    ],
  },
  {
...
const DOSAPI_SUBFUNCTIONS = [
  ...
  ["AH=37h", "Switch character", "AL=00h returns the stored switch character in DL (default '/'), AL=01h stores DL. Other subfunctions return AL=FFh like genuine DOS 5."],
  ...
  ["AH=6Ch", "Extended open/create", "AX=6C00h uses DS:SI for the path, BL for open mode, CX for create attributes, and DL action bits. Valid actions fail/open/replace existing files and fail/create missing files; success returns CX status."],
          ...
          <div>
            <section style={{ border: `1px solid ${T.line}`, borderRadius: 12, background: T.panel, padding: "18px 20px", marginBottom: 22 }}>
              ...
              <div className="dosapi-stat-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10, marginTop: 14 }}>
                ...
                <MiniStat k="Calls" v="70 AH branches" />
              </div>
            </section>
