...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [133, "    je .print_string"],
      [134, "    cmp ah, 0x01"],
      [135, "    je .read_char_echo"],
      [138, "    cmp ah, 0x06"],
      [139, "    je .direct_console_io"],
      [144, "    cmp ah, 0x0A"],
      [145, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [1966, "    call exec_com_dyn"],
      [1969, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [152, "    cmp ah, 0x11"],
      [153, "    je .fcb_find_first"],
      [154, "    cmp ah, 0x12"],
      [155, "    je .fcb_find_next"],
      [200, "    cmp ah, 0x1A"],
      [201, "    je .set_dta"],
      [234, "    cmp ah, 0x4E"],
      [235, "    je .find_first"],
      ...
      [237, "    je .find_next"],
      [575, ".fcb_find_first:"],
      [619, "    call .fcb_store_dta"],
      [4397, "    call store_find_dta"],
      [4437, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3794, "    je .ioctl_get"],
      [3797, "    cmp al, 6"],
      [3798, "    je .ioctl_input_status"],
      [3801, "    cmp al, 8"],
      [3802, "    je .ioctl_removable_drive"],
      [3848, "    mov dx, 0x80D3"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [229, "    je .get_vector"],
      [230, "    cmp ah, 0x36"],
      [231, "    je .get_disk_free"],
      [258, "    cmp ah, 0x5D"],
      [259, "    je .dos_internal"],
      [270, "    cmp ah, 0x71"],
      [271, "    je .lfn_unsupported"],
      [799, ".get_version:"],
      [800, "    mov ax, 0x1E03"],
    ],
    regs: [
