...
const DOSAPI_GROUPS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1942, "    call exec_com_dyn"],
      [1945, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      ...
      [213, "    je .find_next"],
      [551, ".fcb_find_first:"],
      [595, "    call .fcb_store_dta"],
      [4356, "    call store_find_dta"],
      [4396, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3753, "    je .ioctl_get"],
      [3756, "    cmp al, 6"],
      [3757, "    je .ioctl_input_status"],
      [3760, "    cmp al, 8"],
      [3761, "    je .ioctl_removable_drive"],
      [3807, "    mov dx, 0x80D3"],
    ],
    regs: [
