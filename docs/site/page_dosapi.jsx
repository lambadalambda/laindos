...
const DOSAPI_GROUPS = [
  {
    ...
    code: [
      ...
      [315, "    je .print_string"],
      [316, "    cmp ah, 0x01"],
      [317, "    je .read_char_echo"],
      [320, "    cmp ah, 0x06"],
      [321, "    je .direct_console_io"],
      [326, "    cmp ah, 0x0A"],
      [327, "    je .read_line_buffered"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [2177, ".exec:"],
      [1167, "    cmp al, 0"],
      [2208, "    call load_exec_program"],
      [2212, "    call exec_com_dyn"],
      [2215, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [336, "    cmp ah, 0x11"],
      [337, "    je .fcb_find_first"],
      [338, "    cmp ah, 0x12"],
      [339, "    je .fcb_find_next"],
      [384, "    cmp ah, 0x1A"],
      [385, "    je .set_dta"],
      [422, "    cmp ah, 0x4E"],
      [423, "    je .find_first"],
  ...
  },
  {
    ...
    code: [
      ...
      [415, "    je .get_vector"],
      [416, "    cmp ah, 0x36"],
      [417, "    je .get_disk_free"],
      [446, "    cmp ah, 0x5D"],
      [447, "    je .dos_internal"],
      [458, "    cmp ah, 0x71"],
      [459, "    je .lfn_unsupported"],
      [1016, ".get_version:"],
      [1017, "    mov ax, 0x0005"],
    ],
    regs: [
