...
const DOSAPI_GROUPS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1886, ".exec:"],
      [1887, "    cmp al, 0"],
      [1916, "    call load_exec_program"],
      [1920, "    call exec_com_dyn"],
      [1923, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      [128, "    cmp ah, 0x11"],
      [129, "    je .fcb_find_first"],
      [130, "    cmp ah, 0x12"],
      [131, "    je .fcb_find_next"],
      [176, "    cmp ah, 0x1A"],
      [177, "    je .set_dta"],
      [210, "    cmp ah, 0x4E"],
      [211, "    je .find_first"],
      ...
      [213, "    je .find_next"],
      [549, ".fcb_find_first:"],
      [593, "    call .fcb_store_dta"],
      [4239, "    mov ax, [cs:dta_seg]"],
      [4270, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3667, "    je .ioctl_get"],
      [3670, "    cmp al, 6"],
      [3671, "    je .ioctl_input_status"],
      [3674, "    cmp al, 8"],
      [3675, "    je .ioctl_removable_drive"],
      [3721, "    mov dx, 0x80D3"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [205, "    je .get_vector"],
      [206, "    cmp ah, 0x36"],
      [207, "    je .get_disk_free"],
      [234, "    cmp ah, 0x5D"],
      [235, "    je .dos_internal"],
      [244, "    cmp ah, 0x71"],
      [245, "    je .lfn_unsupported"],
      [750, ".get_version:"],
      [751, "    mov ax, 0x1E03"],
    ],
    regs: [
