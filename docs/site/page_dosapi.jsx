...
const DOSAPI_GROUPS = [
  ...
  },
  {
    ...
    code: [
      [1662, ".exec:"],
      [1663, "    cmp al, 0"],
      [1664, "    je .exec_program"],
      [1665, "    cmp al, 3"],
      [1666, "    je .exec_overlay"],
      [1691, "    call load_exec_program"],
      [1695, "    call exec_com_dyn"],
      [1698, "    call setup_exe_dyn"],
    ],
    regs: [
      ["AH", "4Bh", "EXEC"],
  ...
  },
  {
    ...
    code: [
      ...
      [206, "    cmp ah, 0x4F"],
      [207, "    je .find_next"],
      [3843, "    mov ax, [cs:dta_seg]"],
      [3872, "    call store_find_dta"],
    ],
    regs: [
  ...
  },
  {
    ...
    code: [
      ...
      [3233, "    je .ioctl_get"],
      [3236, "    cmp al, 6"],
      [3237, "    je .ioctl_input_status"],
      [3240, "    cmp al, 8"],
      [3241, "    je .ioctl_removable_drive"],
      [3287, "    mov dx, 0x80D3"],
    ],
    regs: [
  ...
  },
  {
    ...
    tests: ["scripts/test_versionapi.py", "scripts/test_diskfree.py", "scripts/test_datetime.py", "scripts/test_drivedata.py", "scripts/test_multidrive.py"],
  },
];
