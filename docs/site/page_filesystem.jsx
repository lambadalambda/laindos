...
const FS_SECTIONS = [
  {
    ...
    code: [
      ...
      [430, "    test al, al"],
      [434, "    test al, ah"],
      [436, "    cmp word [bx+0x0E], 0"],
      [438, "    cmp byte [bx+0x10], 0"],
      [442, "    mov ax, [bx+0x11]"],
      [468, "    mov byte [cs:kfat_bits], 12"],
      [472, "    cmp byte [bx+0x3A], '6'"],
      [474, "    mov byte [cs:kfat_bits], 16"],
      [479, "    mov ax, [bx+22]"],
      [482, "    mov [cs:kfat_start], ax"],
      [492, "    mov [cs:krsta], ax"],
      [512, "    mov [cs:krsc], ax"],
      [515, "    mov [cs:kdsta], ax"],
      [530, "    sub ax, [cs:kdsta]"],
      [536, "    div cx"],
      [540, "    mov [cs:kmax_cluster], ax"],
    ],
    hi: [429, 468, 474, 492, 515, 540],
