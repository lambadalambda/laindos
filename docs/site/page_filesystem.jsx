...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [476, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [477, "    test al, al"],
      [481, "    test al, ah"],
      [483, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [485, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [489, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [515, "    mov byte [cs:kfat_bits], 12"],
      [519, "    cmp byte [bx+BPB_FS_TYPE+4], '6'"],
      [521, "    mov byte [cs:kfat_bits], 16"],
      [526, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [529, "    mov [cs:kfat_start], ax"],
      [539, "    mov [cs:krsta], ax"],
      [559, "    mov [cs:krsc], ax"],
      [562, "    mov [cs:kdsta], ax"],
      [577, "    sub ax, [cs:kdsta]"],
      [583, "    div cx"],
      [587, "    mov [cs:kmax_cluster], ax"],
    ],
  ...
  },
  {
    ...
    code: [
      [1390, "    mov ax, si"],
      [2999, "    call cluster_lba"],
      [3000, "    cmp byte [cs:rf_cache_valid], 1"],
      [3007, "    mov byte [cs:rf_cache_valid], 0"],
      [3014, "    mov dx, READ_CACHE_BUF"],
      [3016, "    call read_sector"],
      [3020, "    mov byte [cs:rf_cache_valid], 1"],
      [3014, "    mov dx, READ_CACHE_BUF"],
      [3180, ".wf_file:"],
      [2920, "    call activate_drive_for_handle"],
      [2248, "    call fat_alloc_cluster"],
      [3252, "    call wf_get_cluster"],
      [3259, "    mov ax, SEC_BUF"],
      [3265, "    call read_sector"],
      [3293, "    call write_sector"],
      [3296, "    mov byte [cs:rf_cache_valid], 0"],
      [3233, "    call fat_alloc_cluster"],
      [3252, "    call wf_get_cluster"],
      [3256, "    call cluster_lba"],
      [3342, "    mov dx, SEC_BUF"],
      [3265, "    call read_sector"],
      [3259, "    mov ax, SEC_BUF"],
      [3293, "    call write_sector"],
      [3296, "    mov byte [cs:rf_cache_valid], 0"],
      [3407, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2384, ".create_file:"],
      [2229, "    call parse_root_path"],
      [2235, "    call find_in_dir"],
      [2238, "    call find_dir_free"],
      [2426, "    call entry_has_open_handle"],
      [2443, "    mov si, [cs:cf_first_cluster]"],
      [2292, "    call fat_free_chain"],
      [2253, "    call flush_fat"],
      [2258, "    call load_dir_slot"],
      [794, "    mov si, name_buf"],
      [2286, "    call flush_dir_slot"],
      [3473, ".delete_file:"],
      [3481, "    call parse_root_path"],
      [3485, "    call find_in_dir"],
      [2355, "    mov byte [es:di], 0xE5"],
      [3498, "    call flush_dir_slot"],
      [3501, "    call fat_free_chain"],
      [3502, "    call flush_fat"],
      [4555, ".rename_file:"],
      [4566, "    call parse_root_path"],
      [4572, "    call find_in_dir"],
      [4578, "    call entry_has_open_handle"],
      [4592, "    cmp ax, [cs:rn_dir_cluster]"],
      [4606, "    mov si, name_buf"],
      [4611, "    call flush_dir_slot"],
      [4677, ".commit_file:"],
      [4659, "    call flush_handle_dir_entry"],
      [4709, "    call flush_fat"],
    ],
