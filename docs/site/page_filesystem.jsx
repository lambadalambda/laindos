...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1710, "    mov ax, si"],
      [3522, "    call cluster_lba"],
      [3144, "    call read_sectors"],
      [3163, "    cmp byte [cs:rf_cache_valid], 1"],
      [3568, "    call wf_mark_sector_cache"],
      [3183, "    mov dx, READ_CACHE_BUF"],
      [3541, "    call read_sector"],
      [3189, "    mov byte [cs:rf_cache_valid], 1"],
      [3215, "    mov dx, READ_CACHE_BUF"],
      [3409, ".wf_file:"],
      [3428, "    call activate_drive_for_handle"],
      [2312, "    call fat_alloc_cluster"],
      [3517, "    call wf_get_cluster"],
      [3525, "    call wf_prepare_sector_cache"],
      [3559, "    mov ax, WRITE_CACHE_BUF"],
      [3541, "    call read_sector"],
      [3568, "    call wf_mark_sector_cache"],
      [3500, "    call fat_alloc_cluster"],
      [3517, "    call wf_get_cluster"],
      [3522, "    call cluster_lba"],
      [3530, "    mov dx, WRITE_CACHE_BUF"],
      [3541, "    call read_sector"],
      [3559, "    mov ax, WRITE_CACHE_BUF"],
      [3571, "    call wf_flush_sector_cache"],
      [3568, "    call wf_mark_sector_cache"],
      [3674, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3144, 3163, 3189, 3215, 3517, 3525, 3568],
  ...
  },
  {
    ...
    code: [
      ...
      [3740, ".delete_file:"],
      [3753, "    call parse_root_path"],
      [3757, "    call find_in_dir"],
      [2421, "    mov byte [es:di], 0xE5"],
      [3770, "    call flush_dir_slot"],
      [3773, "    call fat_free_chain"],
      [3774, "    call flush_fat"],
      [4970, ".rename_file:"],
      [4986, "    call parse_root_path"],
      [4992, "    call find_in_dir"],
      [4998, "    call entry_has_open_handle"],
      [5014, "    cmp ax, [cs:rn_dir_cluster]"],
      [5028, "    mov si, name_buf"],
      [5033, "    call flush_dir_slot"],
      [5100, ".commit_file:"],
      [5130, "    call wf_flush_handle_dir_entry"],
      [5132, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3740, 3774, 4970, 5100],
