...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [591, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [536, "    test al, al"],
      [540, "    test al, ah"],
      [542, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [544, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [588, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [574, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [577, "    mov [cs:kfat_start], ax"],
      [587, "    mov [cs:krsta], ax"],
      [607, "    mov [cs:krsc], ax"],
      [610, "    mov [cs:kdsta], ax"],
      [625, "    sub ax, [cs:kdsta]"],
      [631, "    div cx"],
      [635, "    mov [cs:kmax_cluster], ax"],
      [637, "    mov byte [cs:kfat_bits], 12"],
      [641, "    cmp ax, 4087"],
      [643, "    mov byte [cs:kfat_bits], 16"],
    ],
    hi: [587, 635, 641, 587, 607, 625],
