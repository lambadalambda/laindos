...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3686, "    call flush_fat"],
      [4880, ".rename_file:"],
      [4919, "    call parse_root_path"],
      [4928, "    call find_in_dir"],
      [4908, "    call entry_has_open_handle"],
      [4924, "    cmp ax, [cs:rn_dir_cluster]"],
      [4938, "    mov si, name_buf"],
      [4943, "    call flush_dir_slot"],
      [5010, ".commit_file:"],
      [5040, "    call wf_flush_handle_dir_entry"],
      [5042, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3652, 3686, 4880, 5010],
