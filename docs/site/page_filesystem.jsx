...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3476, "    call read_sector"],
      [3224, "    mov byte [cs:rf_cache_valid], 1"],
      [3250, "    mov dx, READ_CACHE_BUF"],
      [3390, ".wf_file:"],
      [3119, "    call activate_drive_for_handle"],
      [2423, "    call fat_alloc_cluster"],
      [3546, "    call wf_get_cluster"],
      [3577, "    mov ax, SEC_BUF"],
      [3476, "    call read_sector"],
      [3595, "    call write_sector"],
      [3600, "    mov byte [cs:rf_cache_valid], 0"],
      [3526, "    call fat_alloc_cluster"],
      [3546, "    call wf_get_cluster"],
      [3551, "    call cluster_lba"],
      [3592, "    mov dx, SEC_BUF"],
      [3476, "    call read_sector"],
      [3577, "    mov ax, SEC_BUF"],
      [3595, "    call write_sector"],
      [3600, "    mov byte [cs:rf_cache_valid], 0"],
      [3691, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [3757, ".delete_file:"],
      [3770, "    call parse_root_path"],
      [3774, "    call find_in_dir"],
      [2532, "    mov byte [es:di], 0xE5"],
      [3787, "    call flush_dir_slot"],
      [3790, "    call fat_free_chain"],
      [3791, "    call flush_fat"],
      [4933, ".rename_file:"],
      [4949, "    call parse_root_path"],
      [4955, "    call find_in_dir"],
      [4961, "    call entry_has_open_handle"],
      [4977, "    cmp ax, [cs:rn_dir_cluster]"],
      [4991, "    mov si, name_buf"],
      [4996, "    call flush_dir_slot"],
      [5062, ".commit_file:"],
      [5092, "    call flush_handle_dir_entry"],
      [5094, "    call flush_fat"],
    ],
