...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1382, "    mov ax, si"],
      [2949, "    call cluster_lba"],
      [2950, "    cmp byte [cs:rf_cache_valid], 1"],
      [2957, "    mov byte [cs:rf_cache_valid], 0"],
      [2964, "    mov dx, READ_CACHE_BUF"],
      [2966, "    call read_sector"],
      [2970, "    mov byte [cs:rf_cache_valid], 1"],
      [2964, "    mov dx, READ_CACHE_BUF"],
      [3130, ".wf_file:"],
      [2870, "    call activate_drive_for_handle"],
      [2198, "    call fat_alloc_cluster"],
      [3202, "    call wf_get_cluster"],
      [3209, "    mov ax, SEC_BUF"],
      [3215, "    call read_sector"],
      [3243, "    call write_sector"],
      [3246, "    mov byte [cs:rf_cache_valid], 0"],
      [3183, "    call fat_alloc_cluster"],
      [3202, "    call wf_get_cluster"],
      [3206, "    call cluster_lba"],
      [3292, "    mov dx, SEC_BUF"],
      [3215, "    call read_sector"],
      [3217, "    mov ax, SEC_BUF"],
      [3243, "    call write_sector"],
      [3246, "    mov byte [cs:rf_cache_valid], 0"],
      [3357, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2334, ".create_file:"],
      [2179, "    call parse_root_path"],
      [2185, "    call find_in_dir"],
      [2188, "    call find_dir_free"],
      [2376, "    call entry_has_open_handle"],
      [2393, "    mov si, [cs:cf_first_cluster]"],
      [2242, "    call fat_free_chain"],
      [2203, "    call flush_fat"],
      [2208, "    call load_dir_slot"],
      [786, "    mov si, name_buf"],
      [2236, "    call flush_dir_slot"],
      [3423, ".delete_file:"],
      [3431, "    call parse_root_path"],
      [3435, "    call find_in_dir"],
      [2305, "    mov byte [es:di], 0xE5"],
      [3448, "    call flush_dir_slot"],
      [3451, "    call fat_free_chain"],
      [3452, "    call flush_fat"],
      [4505, ".rename_file:"],
      [4516, "    call parse_root_path"],
      [4522, "    call find_in_dir"],
      [4528, "    call entry_has_open_handle"],
      [4542, "    cmp ax, [cs:rn_dir_cluster]"],
      [4556, "    mov si, name_buf"],
      [4561, "    call flush_dir_slot"],
      [4627, ".commit_file:"],
      [4657, "    call flush_handle_dir_entry"],
      [4659, "    call flush_fat"],
    ],
