...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3612, "    call wf_prepare_sector_cache"],
      [3646, "    mov ax, WRITE_CACHE_BUF"],
      [3628, "    call read_sector"],
      [3655, "    call wf_mark_sector_cache"],
      [3587, "    call fat_alloc_cluster"],
      [3604, "    call wf_get_cluster"],
      [3609, "    call cluster_lba"],
      [3617, "    mov dx, WRITE_CACHE_BUF"],
      [3628, "    call read_sector"],
      [3646, "    mov ax, WRITE_CACHE_BUF"],
      [3658, "    call wf_flush_sector_cache"],
      [3655, "    call wf_mark_sector_cache"],
      [3762, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3157, 3176, 3218, 3270, 3302, 3604, 3612, 3655],
  ...
  },
  {
    ...
    code: [
      ...
      [3828, ".delete_file:"],
      [3841, "    call parse_root_path"],
      [3845, "    call find_in_dir"],
      [3855, "    mov byte [es:di], 0xE5"],
      [3858, "    call flush_dir_slot"],
      [3861, "    call fat_free_chain"],
      [3862, "    call flush_fat"],
      [5059, ".rename_file:"],
      [5075, "    call parse_root_path"],
      [5081, "    call find_in_dir"],
      [5087, "    call entry_has_open_handle"],
      [5103, "    cmp ax, [cs:rn_dir_cluster]"],
      [5117, "    mov si, name_buf"],
      [5122, "    call flush_dir_slot"],
      [5189, ".commit_file:"],
      [5219, "    call wf_flush_handle_dir_entry"],
      [5221, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3828, 3862, 5059, 5189],
