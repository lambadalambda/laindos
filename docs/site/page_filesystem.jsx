...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1545, "    mov ax, si"],
      [3283, "    call cluster_lba"],
      [3284, "    cmp byte [cs:rf_cache_valid], 1"],
      [3291, "    mov byte [cs:rf_cache_valid], 0"],
      [3330, "    mov dx, READ_CACHE_BUF"],
      [3610, "    call read_sector"],
      [3304, "    mov byte [cs:rf_cache_valid], 1"],
      [3330, "    mov dx, READ_CACHE_BUF"],
      [3524, ".wf_file:"],
      [3199, "    call activate_drive_for_handle"],
      [2503, "    call fat_alloc_cluster"],
      [3680, "    call wf_get_cluster"],
      [3711, "    mov ax, SEC_BUF"],
      [3610, "    call read_sector"],
      [3729, "    call write_sector"],
      [3734, "    mov byte [cs:rf_cache_valid], 0"],
      [3660, "    call fat_alloc_cluster"],
      [3680, "    call wf_get_cluster"],
      [3685, "    call cluster_lba"],
      [3726, "    mov dx, SEC_BUF"],
      [3610, "    call read_sector"],
      [3711, "    mov ax, SEC_BUF"],
      [3729, "    call write_sector"],
      [3734, "    mov byte [cs:rf_cache_valid], 0"],
      [3825, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2641, ".create_file:"],
      [2581, "    call parse_root_path"],
      [2587, "    call find_in_dir"],
      [2672, "    call find_dir_free"],
      [2685, "    call entry_has_open_handle"],
      [2702, "    mov si, [cs:cf_first_cluster]"],
      [2703, "    call fat_free_chain"],
      [2619, "    call flush_fat"],
      [2609, "    call load_dir_slot"],
      [947, "    mov si, name_buf"],
      [2615, "    call flush_dir_slot"],
      [3891, ".delete_file:"],
      [3904, "    call parse_root_path"],
      [3908, "    call find_in_dir"],
      [2612, "    mov byte [es:di], 0xE5"],
      [3921, "    call flush_dir_slot"],
      [3924, "    call fat_free_chain"],
      [3925, "    call flush_fat"],
      [5115, ".rename_file:"],
      [5131, "    call parse_root_path"],
      [5137, "    call find_in_dir"],
      [5143, "    call entry_has_open_handle"],
      [5159, "    cmp ax, [cs:rn_dir_cluster]"],
      [5173, "    mov si, name_buf"],
      [5178, "    call flush_dir_slot"],
      [5244, ".commit_file:"],
      [5226, "    call flush_handle_dir_entry"],
      [5276, "    call flush_fat"],
    ],
