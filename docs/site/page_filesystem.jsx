...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1554, "    mov ax, si"],
      [3320, "    call cluster_lba"],
      [3321, "    cmp byte [cs:rf_cache_valid], 1"],
      [3328, "    mov byte [cs:rf_cache_valid], 0"],
      [3367, "    mov dx, READ_CACHE_BUF"],
      [3647, "    call read_sector"],
      [3341, "    mov byte [cs:rf_cache_valid], 1"],
      [3367, "    mov dx, READ_CACHE_BUF"],
      [3561, ".wf_file:"],
      [3236, "    call activate_drive_for_handle"],
      [2540, "    call fat_alloc_cluster"],
      [3717, "    call wf_get_cluster"],
      [3748, "    mov ax, SEC_BUF"],
      [3647, "    call read_sector"],
      [3766, "    call write_sector"],
      [3771, "    mov byte [cs:rf_cache_valid], 0"],
      [3697, "    call fat_alloc_cluster"],
      [3717, "    call wf_get_cluster"],
      [3722, "    call cluster_lba"],
      [3763, "    mov dx, SEC_BUF"],
      [3647, "    call read_sector"],
      [3748, "    mov ax, SEC_BUF"],
      [3766, "    call write_sector"],
      [3771, "    mov byte [cs:rf_cache_valid], 0"],
      [3862, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2678, ".create_file:"],
      [2618, "    call parse_root_path"],
      [2624, "    call find_in_dir"],
      [2709, "    call find_dir_free"],
      [2722, "    call entry_has_open_handle"],
      [2739, "    mov si, [cs:cf_first_cluster]"],
      [2740, "    call fat_free_chain"],
      [2656, "    call flush_fat"],
      [2646, "    call load_dir_slot"],
      [944, "    mov si, name_buf"],
      [2652, "    call flush_dir_slot"],
      [3928, ".delete_file:"],
      [3941, "    call parse_root_path"],
      [3945, "    call find_in_dir"],
      [2649, "    mov byte [es:di], 0xE5"],
      [3958, "    call flush_dir_slot"],
      [3961, "    call fat_free_chain"],
      [3962, "    call flush_fat"],
      [5152, ".rename_file:"],
      [5168, "    call parse_root_path"],
      [5174, "    call find_in_dir"],
      [5180, "    call entry_has_open_handle"],
      [5196, "    cmp ax, [cs:rn_dir_cluster]"],
      [5210, "    mov si, name_buf"],
      [5215, "    call flush_dir_slot"],
      [5281, ".commit_file:"],
      [5263, "    call flush_handle_dir_entry"],
      [5313, "    call flush_fat"],
    ],
