...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [600, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [545, "    test al, al"],
      [549, "    test al, ah"],
      [551, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [553, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [597, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [583, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [586, "    mov [cs:kfat_start], ax"],
      [596, "    mov [cs:krsta], ax"],
      [616, "    mov [cs:krsc], ax"],
      [619, "    mov [cs:kdsta], ax"],
      [634, "    sub ax, [cs:kdsta]"],
      [640, "    div cx"],
      [644, "    mov [cs:kmax_cluster], ax"],
      [646, "    mov byte [cs:kfat_bits], 12"],
      [650, "    cmp ax, 4087"],
      [652, "    mov byte [cs:kfat_bits], 16"],
    ],
    hi: [596, 644, 650, 596, 616, 634],
  ...
  },
  {
    ...
    code: [
      [1709, "    mov ax, si"],
      [3643, "    call cluster_lba"],
      [3174, "    call read_sectors"],
      [3193, "    cmp byte [cs:rf_cache_valid], 1"],
      [3205, "    cmp cl, [cs:rf_cache_count]"],
      [3235, "    mov byte [cs:rf_cache_count], READ_CACHE_SECTORS"],
      [3237, "    mov cl, [cs:kspc]"],
      [3273, "    call wf_fill_read_cache_from_write"],
      [3283, "    mov dx, READ_CACHE_BUF"],
      [3287, "    call read_sectors"],
      [3319, "    mov dx, [cs:rf_cache_seg]"],
      [3494, ".write_file: PERF_INC perf_write_calls"],
      [3532, "    call activate_drive_for_handle"],
      [2309, "    call fat_alloc_cluster"],
      [3556, "    call wf_flush_sector_cache"],
      [3607, "    call wf_flush_sector_cache"],
      [3565, "    call fat_alloc_cluster"],
      [3632, "    cmp ax, [cs:wf_cluster_index]"],
      [3607, "    call wf_flush_sector_cache"],
      [3638, "    call wf_get_cluster"],
      [3643, "    call cluster_lba"],
      [3646, "    call wf_prepare_sector_cache"],
      [3651, "    mov dx, WRITE_CACHE_BUF"],
      [3662, "    call read_sector"],
      [3680, "    mov ax, WRITE_CACHE_BUF"],
      [3689, "    call wf_mark_sector_cache"],
      [3692, "    call wf_flush_sector_cache"],
      [3796, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3174, 3174, 3205, 3283, 3287, 3532, 3565, 3607, 3607, 3607, 3638, 3662],
  ...
  },
  {
    ...
    code: [
      [2447, ".create_file:"],
      [2653, "    call parse_root_path"],
      [2657, "    call find_in_dir"],
      [2480, "    call find_dir_free"],
      [2493, "    call entry_has_open_handle"],
      [2510, "    mov si, [cs:cf_first_cluster]"],
      [2511, "    call fat_free_chain"],
      [2512, "    call flush_fat"],
      [2518, "    call load_dir_slot"],
      [995, "    mov si, name_buf"],
      [2545, "    call flush_dir_slot"],
      [3862, ".delete_file:"],
      [3875, "    call parse_root_path"],
      [3879, "    call find_in_dir"],
      [3889, "    mov byte [es:di], 0xE5"],
      [3892, "    call flush_dir_slot"],
      [3895, "    call fat_free_chain"],
      [3896, "    call flush_fat"],
      [5093, ".rename_file:"],
      [5109, "    call parse_root_path"],
      [5115, "    call find_in_dir"],
      [5121, "    call entry_has_open_handle"],
      [5137, "    cmp ax, [cs:rn_dir_cluster]"],
      [5151, "    mov si, name_buf"],
      [5156, "    call flush_dir_slot"],
      [5223, ".commit_file:"],
      [5205, "    call wf_flush_handle_dir_entry"],
      [5255, "    call flush_fat"],
    ],
    hi: [2447, 2545, 3875, 3879, 5093, 5205],
