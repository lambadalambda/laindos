...
const FS_SECTIONS = [
  {
    ...
    code: [
      ...
      [520, "    test al, al"],
      [524, "    test al, ah"],
      [526, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [528, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [572, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [564, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [561, "    mov [cs:kfat_start], ax"],
      [571, "    mov [cs:krsta], ax"],
      [591, "    mov [cs:krsc], ax"],
      [594, "    mov [cs:kdsta], ax"],
      [609, "    sub ax, [cs:kdsta]"],
      [615, "    div cx"],
      [619, "    mov [cs:kmax_cluster], ax"],
      [621, "    mov byte [cs:kfat_bits], 12"],
      [625, "    cmp ax, 4087"],
      [627, "    mov byte [cs:kfat_bits], 16"],
    ],
  ...
  },
  {
    ...
    code: [
      [1672, "    mov ax, si"],
      [3448, "    call cluster_lba"],
      [3131, "    cmp byte [cs:rf_cache_valid], 1"],
      [3488, "    mov byte [cs:rf_cache_valid], 0"],
      [3177, "    mov dx, READ_CACHE_BUF"],
      [3549, "    call read_sector"],
      [3151, "    mov byte [cs:rf_cache_valid], 1"],
      [3177, "    mov dx, READ_CACHE_BUF"],
      [3371, ".wf_file:"],
      [3390, "    call activate_drive_for_handle"],
      [2350, "    call fat_alloc_cluster"],
      [3527, "    call wf_get_cluster"],
      [3567, "    mov ax, SEC_BUF"],
      [3549, "    call read_sector"],
      [3585, "    call write_sector"],
      [3590, "    mov byte [cs:rf_cache_valid], 0"],
      [3507, "    call fat_alloc_cluster"],
      [3527, "    call wf_get_cluster"],
      [3532, "    call cluster_lba"],
      [3582, "    mov dx, SEC_BUF"],
      [3549, "    call read_sector"],
      [3567, "    mov ax, SEC_BUF"],
      [3585, "    call write_sector"],
      [3590, "    mov byte [cs:rf_cache_valid], 0"],
      [3681, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2488, ".create_file:"],
      [2683, "    call parse_root_path"],
      [2687, "    call find_in_dir"],
      [2519, "    call find_dir_free"],
      [2532, "    call entry_has_open_handle"],
      [2549, "    mov si, [cs:cf_first_cluster]"],
      [2550, "    call fat_free_chain"],
      [2551, "    call flush_fat"],
      [2557, "    call load_dir_slot"],
      [954, "    mov si, name_buf"],
      [2584, "    call flush_dir_slot"],
      [3747, ".delete_file:"],
      [3760, "    call parse_root_path"],
      [3764, "    call find_in_dir"],
      [2459, "    mov byte [es:di], 0xE5"],
      [4152, "    call flush_dir_slot"],
      [3780, "    call fat_free_chain"],
      [3781, "    call flush_fat"],
      [4976, ".rename_file:"],
      [5015, "    call parse_root_path"],
      [5024, "    call find_in_dir"],
      [5004, "    call entry_has_open_handle"],
      [5020, "    cmp ax, [cs:rn_dir_cluster]"],
      [5034, "    mov si, name_buf"],
      [5039, "    call flush_dir_slot"],
      [5105, ".commit_file:"],
      [5135, "    call flush_handle_dir_entry"],
      [5137, "    call flush_fat"],
    ],
