...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1726, "    mov cx, 11"],
      [1739, "    call ascii_upper"],
      [1742, "    cmp di, name_buf + 8"],
      [1751, ".pl_dot:"],
      [1753, "    mov di, name_buf + 8"],
      [1761, "    mov byte [es:di], '?'"],
      [1798, "parse_root_path:"],
      [1802, "    call activate_drive_for_path"],
      [1806, "    mov ax, [cs:cur_dir_cluster]"],
      [1820, "    mov [cs:pr_last_sep], bx"],
      [1851, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1863, "    call resolve_path"],
      [1876, "    call parse_83name"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [1206, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .rid_notfound_pop"],
      [1209, "    cmp byte [es:di], 0"],
      [1243, "    call fat_next"],
      [1254, "    mov [cs:ff_entry_lba], ax"],
      [1268, "    mov ax, [es:di+26]"],
      [1359, "find_dir_free:"],
      [1381, "    call cluster_lba"],
      [1386, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .sd_full"],
      [1389, "    cmp byte [es:di], 0"],
      [1405, "    call fat_next"],
      [1416, "    call fat_alloc_cluster"],
      [1420, "    call fat_set"],
      [1452, "    call write_sector"],
      [1462, "    call flush_fat"],
      [1474, ".sd_rollback:"],
      [1477, "    call fat_set"],
      [1481, "    call flush_fat"],
