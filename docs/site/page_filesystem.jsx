...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3483, "    call write_sector"],
      [3488, "    mov byte [cs:rf_cache_valid], 0"],
      [3579, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3086, 3106, 3132, 3425, 3483, 3488],
  ...
  },
  {
    ...
    code: [
      ...
      [3645, ".delete_file:"],
      [3658, "    call parse_root_path"],
      [3662, "    call find_in_dir"],
      [2421, "    mov byte [es:di], 0xE5"],
      [4050, "    call flush_dir_slot"],
      [3678, "    call fat_free_chain"],
      [3679, "    call flush_fat"],
      [4873, ".rename_file:"],
      [4912, "    call parse_root_path"],
      [4921, "    call find_in_dir"],
      [4901, "    call entry_has_open_handle"],
      [4917, "    cmp ax, [cs:rn_dir_cluster]"],
      [4931, "    mov si, name_buf"],
      [4936, "    call flush_dir_slot"],
      [5002, ".commit_file:"],
      [5032, "    call flush_handle_dir_entry"],
      [5034, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3645, 3679, 4873, 5002],
