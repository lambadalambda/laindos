...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3034, ".wf_file:"],
      [2780, "    call activate_drive_for_handle"],
      [2154, "    call fat_alloc_cluster"],
      [3106, "    call wf_get_cluster"],
      [3113, "    mov ax, SEC_BUF"],
      [3161, "    call read_sector"],
      [3147, "    call write_sector"],
  ...
  },
  {
    ...
    code: [
      [2290, ".create_file:"],
      [2135, "    call parse_root_path"],
      [2141, "    call find_in_dir"],
      [2144, "    call find_dir_free"],
      [2327, "    call entry_has_open_handle"],
      [2344, "    mov si, [cs:cf_first_cluster]"],
      [2198, "    call fat_free_chain"],
      [2159, "    call flush_fat"],
      [2164, "    call load_dir_slot"],
      [762, "    mov si, name_buf"],
      [2192, "    call flush_dir_slot"],
      [3327, ".delete_file:"],
      [3379, "    call parse_root_path"],
      [3383, "    call find_in_dir"],
      [2261, "    mov byte [es:di], 0xE5"],
      ...
      [4394, "    cmp ax, [cs:rn_dir_cluster]"],
      [4492, "    mov si, name_buf"],
      [4497, "    call flush_dir_slot"],
      [4479, ".commit_file:"],
      [4461, "    call flush_handle_dir_entry"],
      [4599, "    call flush_fat"],
    ],
