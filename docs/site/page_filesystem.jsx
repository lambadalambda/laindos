...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [584, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [529, "    test al, al"],
      [533, "    test al, ah"],
      [535, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [537, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [581, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [567, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [570, "    mov [cs:kfat_start], ax"],
      [580, "    mov [cs:krsta], ax"],
      [600, "    mov [cs:krsc], ax"],
      [603, "    mov [cs:kdsta], ax"],
      [618, "    sub ax, [cs:kdsta]"],
      [624, "    div cx"],
      [628, "    mov [cs:kmax_cluster], ax"],
      [630, "    mov byte [cs:kfat_bits], 12"],
      [634, "    cmp ax, 4087"],
      [636, "    mov byte [cs:kfat_bits], 16"],
    ],
    hi: [584, 630, 636, 580, 603, 628],
  ...
  },
  {
    ...
    code: [
      ...
      [89, "setup_sector_io:"],
      [94, "    mov ax, [cs:kpart_lba]"],
      [102, "setup_bios_chs:"],
      [109, "    cmp dx, [cs:kbio_spt]"],
      [111, "    div word [cs:kbio_spt]"],
      [116, "    cmp ax, 1024"],
      [135, "finish_sector_io:"],
      [138, "    mov ax, es"],
      [139, "    add ax, 0x1000"],
    ],
    hi: [1, 5, 13, 31, 94, 116, 139],
  ...
  },
  {
    ...
    code: [
      [936, "resolve_path:"],
      [938, "    call activate_drive_for_path"],
      [947, "    cmp byte [ds:si], '\\'"],
      [960, "    mov ax, [cs:cur_dir_cluster]"],
      [957, "    mov ax, ROOT_CLUSTER"],
      [960, "    mov ax, [cs:cur_dir_cluster]"],
      [995, ".rp_parse_name:"],
      [1004, "    mov di, name_buf"],
      [1061, "    call ascii_upper"],
      [1077, "    mov di, name_buf + 8"],
      [1102, "    call find_in_dir"],
      [1104, "    test byte [es:di+11], ATTR_DIR"],
      [1116, "    call find_in_dir"],
      [1737, "parse_83name:"],
      [1750, "    mov di, name_buf"],
      [1747, "    mov cx, 11"],
      [1760, "    call ascii_upper"],
      [1780, "    cmp di, name_buf + 8"],
      [1772, ".pl_dot:"],
      [1793, "    mov di, name_buf + 8"],
      [1803, "    mov byte [es:di], '?'"],
      [1819, "parse_root_path:"],
      [1823, "    call activate_drive_for_path"],
      [1827, "    mov ax, [cs:cur_dir_cluster]"],
      [1841, "    mov [cs:pr_last_sep], bx"],
      [1872, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
  ...
  },
  {
    ...
    code: [
      [1146, "find_in_dir:"],
      [1164, "    mov ax, [cs:fid_cluster]"],
      [1167, "    mov ax, ROOT_SEG"],
      [1170, "    cmp cx, [cs:kroot_entries]"],
      [1351, "    add ax, [cs:krsta]"],
      [1181, "    cmp byte [es:di], 0"],
      [1183, "    cmp byte [es:di], 0xE5"],
      [1194, "    call name_matches"],
      [1219, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .rid_notfound_pop"],
      [1222, "    cmp byte [es:di], 0"],
      [1253, "    call fat_next_checked"],
      [1259, "    mov [cs:ff_entry_lba], ax"],
      [1273, "    mov ax, [es:di+26]"],
      [1364, "find_dir_free:"],
      [1387, "    call cluster_lba"],
      [1392, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .sd_full"],
      [1395, "    cmp byte [es:di], 0"],
      [1408, "    call fat_next_checked"],
  ...
  },
  {
    ...
    code: [
      [1710, "    mov ax, si"],
      [3473, "    call cluster_lba"],
      [3086, "    cmp byte [cs:rf_cache_valid], 1"],
      [3531, "    mov byte [cs:rf_cache_valid], 0"],
      [3132, "    mov dx, READ_CACHE_BUF"],
      [3490, "    call read_sector"],
      [3106, "    mov byte [cs:rf_cache_valid], 1"],
      [3132, "    mov dx, READ_CACHE_BUF"],
      [3326, ".wf_file:"],
      [3345, "    call activate_drive_for_handle"],
      [2312, "    call fat_alloc_cluster"],
      [3468, "    call wf_get_cluster"],
      [3508, "    mov ax, SEC_BUF"],
      [3490, "    call read_sector"],
      [3526, "    call write_sector"],
      [3531, "    mov byte [cs:rf_cache_valid], 0"],
      [3455, "    call fat_alloc_cluster"],
      [3468, "    call wf_get_cluster"],
      [3473, "    call cluster_lba"],
      [3523, "    mov dx, SEC_BUF"],
      [3490, "    call read_sector"],
      ...
      [3526, "    call write_sector"],
      [3531, "    mov byte [cs:rf_cache_valid], 0"],
      [3622, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3086, 3106, 3132, 3468, 3526, 3531],
  ...
  },
  {
    ...
    code: [
      ...
      [3688, ".delete_file:"],
      [3701, "    call parse_root_path"],
      [3705, "    call find_in_dir"],
      [2421, "    mov byte [es:di], 0xE5"],
      [4093, "    call flush_dir_slot"],
      [3721, "    call fat_free_chain"],
      [3722, "    call flush_fat"],
      [4893, ".rename_file:"],
      [4932, "    call parse_root_path"],
      [4941, "    call find_in_dir"],
      [4921, "    call entry_has_open_handle"],
      [4937, "    cmp ax, [cs:rn_dir_cluster]"],
      [4951, "    mov si, name_buf"],
      [4956, "    call flush_dir_slot"],
      [5022, ".commit_file:"],
      [5052, "    call flush_handle_dir_entry"],
      [5054, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3688, 3722, 4893, 5022],
