...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1545, "    mov ax, si"],
      [3207, "    call cluster_lba"],
      [3208, "    cmp byte [cs:rf_cache_valid], 1"],
      [3215, "    mov byte [cs:rf_cache_valid], 0"],
      [3254, "    mov dx, READ_CACHE_BUF"],
      [3534, "    call read_sector"],
      [3228, "    mov byte [cs:rf_cache_valid], 1"],
      [3254, "    mov dx, READ_CACHE_BUF"],
      [3448, ".wf_file:"],
      [3123, "    call activate_drive_for_handle"],
      [2427, "    call fat_alloc_cluster"],
      [3604, "    call wf_get_cluster"],
      [3635, "    mov ax, SEC_BUF"],
      [3534, "    call read_sector"],
      [3653, "    call write_sector"],
      [3658, "    mov byte [cs:rf_cache_valid], 0"],
      [3584, "    call fat_alloc_cluster"],
      [3604, "    call wf_get_cluster"],
      [3609, "    call cluster_lba"],
      [3650, "    mov dx, SEC_BUF"],
      [3534, "    call read_sector"],
      [3635, "    mov ax, SEC_BUF"],
      [3653, "    call write_sector"],
  ...
  },
  {
    ...
    code: [
      [2565, ".create_file:"],
      [2505, "    call parse_root_path"],
      [2511, "    call find_in_dir"],
      [2596, "    call find_dir_free"],
      [2609, "    call entry_has_open_handle"],
      [2626, "    mov si, [cs:cf_first_cluster]"],
      [2627, "    call fat_free_chain"],
      [2543, "    call flush_fat"],
      [2533, "    call load_dir_slot"],
      [947, "    mov si, name_buf"],
      [2539, "    call flush_dir_slot"],
      [3815, ".delete_file:"],
      [3828, "    call parse_root_path"],
      [3832, "    call find_in_dir"],
      [2536, "    mov byte [es:di], 0xE5"],
      [3845, "    call flush_dir_slot"],
      [3848, "    call fat_free_chain"],
      [3849, "    call flush_fat"],
      [5039, ".rename_file:"],
      [5055, "    call parse_root_path"],
      [5061, "    call find_in_dir"],
      [5067, "    call entry_has_open_handle"],
      [5083, "    cmp ax, [cs:rn_dir_cluster]"],
      [5097, "    mov si, name_buf"],
      [5102, "    call flush_dir_slot"],
      [5168, ".commit_file:"],
      [5150, "    call flush_handle_dir_entry"],
      [5200, "    call flush_fat"],
    ],
