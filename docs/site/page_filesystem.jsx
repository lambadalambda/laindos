...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3842, "    call flush_fat"],
      [4984, ".rename_file:"],
      [5000, "    call parse_root_path"],
      [5006, "    call find_in_dir"],
      [5012, "    call entry_has_open_handle"],
      [5028, "    cmp ax, [cs:rn_dir_cluster]"],
      [5042, "    mov si, name_buf"],
      [5047, "    call flush_dir_slot"],
      [5113, ".commit_file:"],
