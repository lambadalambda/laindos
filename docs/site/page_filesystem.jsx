...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1714, "    mov ax, si"],
      [3650, "    call cluster_lba"],
      [3181, "    call read_sectors"],
      [3200, "    cmp byte [cs:rf_cache_valid], 1"],
      [3212, "    cmp cl, [cs:rf_cache_count]"],
      [3242, "    mov byte [cs:rf_cache_count], READ_CACHE_SECTORS"],
      [3244, "    mov cl, [cs:kspc]"],
      [3280, "    call wf_fill_read_cache_from_write"],
      [3290, "    mov dx, READ_CACHE_BUF"],
      [3294, "    call read_sectors"],
      [3326, "    mov dx, [cs:rf_cache_seg]"],
      [3501, ".write_file: PERF_INC perf_write_calls"],
      [3539, "    call activate_drive_for_handle"],
      [2316, "    call fat_alloc_cluster"],
      [3563, "    call wf_flush_sector_cache"],
      [3614, "    call wf_flush_sector_cache"],
      [3572, "    call fat_alloc_cluster"],
      [3639, "    cmp ax, [cs:wf_cluster_index]"],
      [3614, "    call wf_flush_sector_cache"],
      [3645, "    call wf_get_cluster"],
      [3650, "    call cluster_lba"],
      [3653, "    call wf_prepare_sector_cache"],
      [3658, "    mov dx, WRITE_CACHE_BUF"],
      [3669, "    call read_sector"],
      [3687, "    mov ax, WRITE_CACHE_BUF"],
      [3696, "    call wf_mark_sector_cache"],
      [3699, "    call wf_flush_sector_cache"],
      [3803, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3181, 3181, 3212, 3280, 3294, 3539, 3572, 3614, 3614, 3614, 3639, 3669],
  ...
  },
  {
    ...
    code: [
      [2454, ".create_file:"],
      [2660, "    call parse_root_path"],
      [2664, "    call find_in_dir"],
      [2487, "    call find_dir_free"],
      [2500, "    call entry_has_open_handle"],
      [2517, "    mov si, [cs:cf_first_cluster]"],
      [2518, "    call fat_free_chain"],
      [2519, "    call flush_fat"],
      [2525, "    call load_dir_slot"],
      [1000, "    mov si, name_buf"],
      [2552, "    call flush_dir_slot"],
      [3869, ".delete_file:"],
      [3882, "    call parse_root_path"],
      [3886, "    call find_in_dir"],
      [3896, "    mov byte [es:di], 0xE5"],
      [3899, "    call flush_dir_slot"],
      [3902, "    call fat_free_chain"],
      [3903, "    call flush_fat"],
      [5100, ".rename_file:"],
      [5116, "    call parse_root_path"],
      [5122, "    call find_in_dir"],
      [5128, "    call entry_has_open_handle"],
      [5144, "    cmp ax, [cs:rn_dir_cluster]"],
      [5158, "    mov si, name_buf"],
      [5163, "    call flush_dir_slot"],
      [5230, ".commit_file:"],
      [5212, "    call wf_flush_handle_dir_entry"],
      [5262, "    call flush_fat"],
    ],
    hi: [2454, 2552, 3869, 3882, 5100, 5212],
