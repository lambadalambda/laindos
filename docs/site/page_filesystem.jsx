...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [149, "fat16_window_flush:"],
      [152, "    cmp byte [cs:fat16_cache_dirty], 1"],
      [175, "    call write_sector"],
      [191, "fat_set:"],
      [243, "fat16_set:"],
      [256, "    call fat16_window_load          ; ax = FAT-relative sector"],
      [263, "    mov [es:bx], ax"],
      [264, "    mov byte [cs:fat16_cache_dirty], 1"],
      [276, "fat_alloc_cluster: PERF_INC perf_fat_allocs"],
      [324, "fat_free_chain:"],
      [354, "flush_fat: PERF_INC perf_fat_flushes"],
      [357, "    cmp byte [cs:kfat_bits], 16"],
      [405, "    call write_sector"],
    ],
    hi: [75, 87, 110, 149, 243, 264, 354],
