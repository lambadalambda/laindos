...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1374, "    mov ax, si"],
      [2889, "    call cluster_lba"],
      [2890, "    cmp byte [cs:rf_cache_valid], 1"],
      [2897, "    mov byte [cs:rf_cache_valid], 0"],
      [2904, "    mov dx, READ_CACHE_BUF"],
      [2906, "    call read_sector"],
      [2910, "    mov byte [cs:rf_cache_valid], 1"],
      [2904, "    mov dx, READ_CACHE_BUF"],
      [3070, ".wf_file:"],
      [2816, "    call activate_drive_for_handle"],
      [2190, "    call fat_alloc_cluster"],
      [3142, "    call wf_get_cluster"],
      [3149, "    mov ax, SEC_BUF"],
      [3155, "    call read_sector"],
      [3183, "    call write_sector"],
      [3186, "    mov byte [cs:rf_cache_valid], 0"],
      [3201, "    call fat_alloc_cluster"],
      [3221, "    call wf_get_cluster"],
      [3226, "    call cluster_lba"],
      [3232, "    mov dx, SEC_BUF"],
      [3235, "    call read_sector"],
      [3252, "    mov ax, SEC_BUF"],
      [3270, "    call write_sector"],
      [3275, "    mov byte [cs:rf_cache_valid], 0"],
      [3297, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2326, ".create_file:"],
      [2171, "    call parse_root_path"],
      [2177, "    call find_in_dir"],
      [2180, "    call find_dir_free"],
      [2363, "    call entry_has_open_handle"],
      [2380, "    mov si, [cs:cf_first_cluster]"],
      [2234, "    call fat_free_chain"],
      [2195, "    call flush_fat"],
      [2200, "    call load_dir_slot"],
      [778, "    mov si, name_buf"],
      [2228, "    call flush_dir_slot"],
      [3363, ".delete_file:"],
      [3371, "    call parse_root_path"],
      [3375, "    call find_in_dir"],
      [2297, "    mov byte [es:di], 0xE5"],
      [3388, "    call flush_dir_slot"],
      [3391, "    call fat_free_chain"],
      [3392, "    call flush_fat"],
      [4393, ".rename_file:"],
      [4404, "    call parse_root_path"],
      [4410, "    call find_in_dir"],
      [4416, "    call entry_has_open_handle"],
      [4430, "    cmp ax, [cs:rn_dir_cluster]"],
      [4444, "    mov si, name_buf"],
      [4449, "    call flush_dir_slot"],
      [4515, ".commit_file:"],
      [4497, "    call flush_handle_dir_entry"],
      [4547, "    call flush_fat"],
    ],
