...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1064, "    call ascii_upper"],
      [1080, "    mov di, name_buf + 8"],
      [1093, "    call find_in_dir"],
      [1095, "    test byte [es:di+11], ATTR_DIR"],
      [1111, "    call find_in_dir"],
      [1714, "parse_83name:"],
      [1723, "    mov di, name_buf"],
      [1724, "    mov cx, 11"],
      [1737, "    call ascii_upper"],
      [1740, "    cmp di, name_buf + 8"],
      [1749, ".pl_dot:"],
      [1751, "    mov di, name_buf + 8"],
      [1759, "    mov byte [es:di], '?'"],
      [1796, "parse_root_path:"],
      [1800, "    call activate_drive_for_path"],
      [1804, "    mov ax, [cs:cur_dir_cluster]"],
      [1818, "    mov [cs:pr_last_sep], bx"],
      [1849, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1861, "    call resolve_path"],
      [1874, "    call parse_83name"],
    ],
  ...
  },
  {
    ...
    code: [
      [1124, "find_in_dir:"],
      [1142, "    mov ax, [cs:fid_cluster]"],
      [1145, "    mov ax, ROOT_SEG"],
      [1148, "    cmp cx, [cs:kroot_entries]"],
      [1159, "    add ax, [cs:krsta]"],
      [1167, "    cmp byte [es:di], 0"],
      [1169, "    cmp byte [es:di], 0xE5"],
      [1180, "    call name_matches"],
      [1204, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .rid_notfound_pop"],
      [1207, "    cmp byte [es:di], 0"],
      [1241, "    call fat_next"],
      [1252, "    mov [cs:ff_entry_lba], ax"],
      [1266, "    mov ax, [es:di+26]"],
      [1357, "find_dir_free:"],
      [1379, "    call cluster_lba"],
      [1384, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .sd_full"],
      [1387, "    cmp byte [es:di], 0"],
      [1403, "    call fat_next"],
      [1414, "    call fat_alloc_cluster"],
      [1418, "    call fat_set"],
      [1450, "    call write_sector"],
      [1460, "    call flush_fat"],
      [1472, ".sd_rollback:"],
      [1475, "    call fat_set"],
      [1479, "    call flush_fat"],
