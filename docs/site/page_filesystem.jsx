...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2875, "    mov ax, si"],
      [2877, "    call cluster_lba"],
      [2878, "    cmp byte [cs:rf_cache_valid], 1"],
      [2885, "    mov byte [cs:rf_cache_valid], 0"],
      [2892, "    mov dx, READ_CACHE_BUF"],
      [2894, "    call read_sector"],
      [2898, "    mov byte [cs:rf_cache_valid], 1"],
      [2924, "    mov dx, READ_CACHE_BUF"],
      [3059, ".wf_file:"],
      [3078, "    call activate_drive_for_handle"],
      [3112, "    call fat_alloc_cluster"],
      [3131, "    call wf_get_cluster"],
      [3138, "    mov ax, SEC_BUF"],
      [3144, "    call read_sector"],
      [3172, "    call write_sector"],
      [3175, "    mov byte [cs:rf_cache_valid], 0"],
      [3190, "    call fat_alloc_cluster"],
      [3210, "    call wf_get_cluster"],
      [3215, "    call cluster_lba"],
      [3221, "    mov dx, SEC_BUF"],
      [3224, "    call read_sector"],
      [3241, "    mov ax, SEC_BUF"],
      [3259, "    call write_sector"],
      [3264, "    mov byte [cs:rf_cache_valid], 0"],
      [3286, "    mov ax, [cs:wf_written]"],
    ],
    hi: [2878, 2892, 3112, 3175, 3190, 3264],
  ...
  },
  {
    ...
    code: [
      ...
      [3354, ".delete_file:"],
      [3362, "    call parse_root_path"],
      [3366, "    call find_in_dir"],
      [3376, "    mov byte [es:di], 0xE5"],
      [3379, "    call flush_dir_slot"],
      [3382, "    call fat_free_chain"],
      [3383, "    call flush_fat"],
      [4424, ".rename_file:"],
      [4435, "    call parse_root_path"],
      [4441, "    call find_in_dir"],
      [4447, "    call entry_has_open_handle"],
      [4461, "    cmp ax, [cs:rn_dir_cluster]"],
      [4475, "    mov si, name_buf"],
      [4480, "    call flush_dir_slot"],
      [4550, ".commit_file:"],
      [4580, "    call flush_handle_dir_entry"],
      [4582, "    call flush_fat"],
    ],
    hi: [2295, 2350, 3354, 3376, 4424, 4550],
