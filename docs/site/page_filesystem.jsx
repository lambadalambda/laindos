...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3367, "    call wf_get_cluster"],
      [3398, "    mov ax, SEC_BUF"],
      [3297, "    call read_sector"],
      [3416, "    call write_sector"],
      [3421, "    mov byte [cs:rf_cache_valid], 0"],
      [3347, "    call fat_alloc_cluster"],
      [3367, "    call wf_get_cluster"],
      [3372, "    call cluster_lba"],
      [3413, "    mov dx, SEC_BUF"],
      [3297, "    call read_sector"],
      [3398, "    mov ax, SEC_BUF"],
      [3416, "    call write_sector"],
      [3421, "    mov byte [cs:rf_cache_valid], 0"],
      [3512, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [3578, ".delete_file:"],
      [3591, "    call parse_root_path"],
      [3595, "    call find_in_dir"],
      [2359, "    mov byte [es:di], 0xE5"],
      [3608, "    call flush_dir_slot"],
      [3611, "    call fat_free_chain"],
      [3612, "    call flush_fat"],
      [4754, ".rename_file:"],
      [4770, "    call parse_root_path"],
      [4776, "    call find_in_dir"],
      [4782, "    call entry_has_open_handle"],
      [4798, "    cmp ax, [cs:rn_dir_cluster]"],
      [4812, "    mov si, name_buf"],
      [4817, "    call flush_dir_slot"],
      [4883, ".commit_file:"],
      [4913, "    call flush_handle_dir_entry"],
      [4915, "    call flush_fat"],
    ],
