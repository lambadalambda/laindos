...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3971, "    call flush_fat"],
      [5161, ".rename_file:"],
      [5177, "    call parse_root_path"],
      [5183, "    call find_in_dir"],
      [5189, "    call entry_has_open_handle"],
      [5205, "    cmp ax, [cs:rn_dir_cluster]"],
      [5219, "    mov si, name_buf"],
      [5224, "    call flush_dir_slot"],
      [5290, ".commit_file:"],
      [5272, "    call flush_handle_dir_entry"],
      [5322, "    call flush_fat"],
    ],
