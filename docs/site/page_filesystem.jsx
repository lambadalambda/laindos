...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [473, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [474, "    test al, al"],
      [478, "    test al, ah"],
      [480, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [482, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [486, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [512, "    mov byte [cs:kfat_bits], 12"],
      [516, "    cmp byte [bx+BPB_FS_TYPE+4], '6'"],
      [518, "    mov byte [cs:kfat_bits], 16"],
      [523, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [526, "    mov [cs:kfat_start], ax"],
      [536, "    mov [cs:krsta], ax"],
      [556, "    mov [cs:krsc], ax"],
      [559, "    mov [cs:kdsta], ax"],
      [574, "    sub ax, [cs:kdsta]"],
      [580, "    div cx"],
      [584, "    mov [cs:kmax_cluster], ax"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [1756, "    mov byte [es:di], '?'"],
      [1793, "parse_root_path:"],
      [1797, "    call activate_drive_for_path"],
  ...
  },
  {
    ...
    code: [
      [1370, "    mov ax, si"],
      [2885, "    call cluster_lba"],
      [2886, "    cmp byte [cs:rf_cache_valid], 1"],
      [2893, "    mov byte [cs:rf_cache_valid], 0"],
      [2900, "    mov dx, READ_CACHE_BUF"],
      [2902, "    call read_sector"],
      [2906, "    mov byte [cs:rf_cache_valid], 1"],
      [2900, "    mov dx, READ_CACHE_BUF"],
      [3066, ".wf_file:"],
      [2812, "    call activate_drive_for_handle"],
      [2186, "    call fat_alloc_cluster"],
      [3138, "    call wf_get_cluster"],
      [3145, "    mov ax, SEC_BUF"],
      [3151, "    call read_sector"],
      [3179, "    call write_sector"],
      [3182, "    mov byte [cs:rf_cache_valid], 0"],
      [3197, "    call fat_alloc_cluster"],
      [3217, "    call wf_get_cluster"],
      [3222, "    call cluster_lba"],
      [3228, "    mov dx, SEC_BUF"],
      [3231, "    call read_sector"],
      [3248, "    mov ax, SEC_BUF"],
      [3266, "    call write_sector"],
      [3271, "    mov byte [cs:rf_cache_valid], 0"],
      [3293, "    mov ax, [cs:wf_written]"],
    ],
    hi: [2899, 2913, 3133, 3196, 3211, 3285],
  ...
  },
  {
    ...
    code: [
      [2322, ".create_file:"],
      [2167, "    call parse_root_path"],
      [2173, "    call find_in_dir"],
      [2176, "    call find_dir_free"],
      [2359, "    call entry_has_open_handle"],
      [2376, "    mov si, [cs:cf_first_cluster]"],
      [2230, "    call fat_free_chain"],
      [2191, "    call flush_fat"],
      [2196, "    call load_dir_slot"],
      [774, "    mov si, name_buf"],
      [2224, "    call flush_dir_slot"],
      [3359, ".delete_file:"],
      [3367, "    call parse_root_path"],
      [3371, "    call find_in_dir"],
      [2293, "    mov byte [es:di], 0xE5"],
      [3384, "    call flush_dir_slot"],
      [3387, "    call fat_free_chain"],
      [3388, "    call flush_fat"],
      [4389, ".rename_file:"],
      [4400, "    call parse_root_path"],
      [4406, "    call find_in_dir"],
      [4412, "    call entry_has_open_handle"],
      [4426, "    cmp ax, [cs:rn_dir_cluster]"],
      [4440, "    mov si, name_buf"],
      [4445, "    call flush_dir_slot"],
      [4511, ".commit_file:"],
      [4493, "    call flush_handle_dir_entry"],
      [4543, "    call flush_fat"],
    ],
    hi: [2299, 2354, 3375, 3397, 4445, 4571],
