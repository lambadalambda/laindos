...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1366, "    mov ax, si"],
      [2881, "    call cluster_lba"],
      [2882, "    cmp byte [cs:rf_cache_valid], 1"],
      [2889, "    mov byte [cs:rf_cache_valid], 0"],
      [2896, "    mov dx, READ_CACHE_BUF"],
      [2898, "    call read_sector"],
      [2902, "    mov byte [cs:rf_cache_valid], 1"],
      [2896, "    mov dx, READ_CACHE_BUF"],
      [3062, ".wf_file:"],
      [2808, "    call activate_drive_for_handle"],
      [2182, "    call fat_alloc_cluster"],
      [3134, "    call wf_get_cluster"],
      [3141, "    mov ax, SEC_BUF"],
      [3147, "    call read_sector"],
      [3175, "    call write_sector"],
      [3178, "    mov byte [cs:rf_cache_valid], 0"],
      [3193, "    call fat_alloc_cluster"],
      [3213, "    call wf_get_cluster"],
      [3218, "    call cluster_lba"],
      [3224, "    mov dx, SEC_BUF"],
      [3227, "    call read_sector"],
      [3244, "    mov ax, SEC_BUF"],
      [3262, "    call write_sector"],
      [3267, "    mov byte [cs:rf_cache_valid], 0"],
      [3289, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2318, ".create_file:"],
      [2163, "    call parse_root_path"],
      [2169, "    call find_in_dir"],
      [2172, "    call find_dir_free"],
      [2355, "    call entry_has_open_handle"],
      [2372, "    mov si, [cs:cf_first_cluster]"],
      [2226, "    call fat_free_chain"],
      [2187, "    call flush_fat"],
      [2192, "    call load_dir_slot"],
      [770, "    mov si, name_buf"],
      [2220, "    call flush_dir_slot"],
      [3355, ".delete_file:"],
      [3363, "    call parse_root_path"],
      [3367, "    call find_in_dir"],
      [2289, "    mov byte [es:di], 0xE5"],
      [3380, "    call flush_dir_slot"],
      [3383, "    call fat_free_chain"],
      [3384, "    call flush_fat"],
      [4385, ".rename_file:"],
      [4396, "    call parse_root_path"],
      [4402, "    call find_in_dir"],
      [4408, "    call entry_has_open_handle"],
      [4422, "    cmp ax, [cs:rn_dir_cluster]"],
      [4436, "    mov si, name_buf"],
      [4441, "    call flush_dir_slot"],
      [4507, ".commit_file:"],
      [4489, "    call flush_handle_dir_entry"],
      [4539, "    call flush_fat"],
    ],
