...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1541, "    mov ax, si"],
      [3203, "    call cluster_lba"],
      [3204, "    cmp byte [cs:rf_cache_valid], 1"],
      [3211, "    mov byte [cs:rf_cache_valid], 0"],
      [3250, "    mov dx, READ_CACHE_BUF"],
      [3527, "    call read_sector"],
      [3224, "    mov byte [cs:rf_cache_valid], 1"],
      [3250, "    mov dx, READ_CACHE_BUF"],
      [3441, ".wf_file:"],
      [3119, "    call activate_drive_for_handle"],
      [2423, "    call fat_alloc_cluster"],
      [3597, "    call wf_get_cluster"],
      [3628, "    mov ax, SEC_BUF"],
      [3527, "    call read_sector"],
      [3646, "    call write_sector"],
      [3651, "    mov byte [cs:rf_cache_valid], 0"],
      [3577, "    call fat_alloc_cluster"],
      [3597, "    call wf_get_cluster"],
      [3602, "    call cluster_lba"],
      [3643, "    mov dx, SEC_BUF"],
      [3527, "    call read_sector"],
      [3628, "    mov ax, SEC_BUF"],
      [3646, "    call write_sector"],
      [3651, "    mov byte [cs:rf_cache_valid], 0"],
      [3742, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2561, ".create_file:"],
      [2501, "    call parse_root_path"],
      [2507, "    call find_in_dir"],
      [2592, "    call find_dir_free"],
      [2605, "    call entry_has_open_handle"],
      [2622, "    mov si, [cs:cf_first_cluster]"],
      [2623, "    call fat_free_chain"],
      [2539, "    call flush_fat"],
      [2529, "    call load_dir_slot"],
      [945, "    mov si, name_buf"],
      [2535, "    call flush_dir_slot"],
      [3808, ".delete_file:"],
      [3821, "    call parse_root_path"],
      [3825, "    call find_in_dir"],
      [2532, "    mov byte [es:di], 0xE5"],
      [3838, "    call flush_dir_slot"],
      [3841, "    call fat_free_chain"],
      [3842, "    call flush_fat"],
      [5032, ".rename_file:"],
      [5048, "    call parse_root_path"],
      [5054, "    call find_in_dir"],
      [5060, "    call entry_has_open_handle"],
      [5076, "    cmp ax, [cs:rn_dir_cluster]"],
      [5090, "    mov si, name_buf"],
      [5095, "    call flush_dir_slot"],
      [5161, ".commit_file:"],
      [5143, "    call flush_handle_dir_entry"],
      [5193, "    call flush_fat"],
    ],
