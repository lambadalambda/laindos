...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1710, "    mov ax, si"],
      [3436, "    call cluster_lba"],
      [3086, "    cmp byte [cs:rf_cache_valid], 1"],
      [3482, "    call wf_mark_sector_cache"],
      [3138, "    mov dx, READ_CACHE_BUF"],
      [3455, "    call read_sector"],
      [3112, "    mov byte [cs:rf_cache_valid], 1"],
      [3138, "    mov dx, READ_CACHE_BUF"],
      [3332, ".wf_file:"],
      [3351, "    call activate_drive_for_handle"],
      [2312, "    call fat_alloc_cluster"],
      [3431, "    call wf_get_cluster"],
      [3439, "    call wf_prepare_sector_cache"],
      [3473, "    mov ax, WRITE_CACHE_BUF"],
      [3455, "    call read_sector"],
      [3482, "    call wf_mark_sector_cache"],
      [3418, "    call fat_alloc_cluster"],
      [3431, "    call wf_get_cluster"],
      [3436, "    call cluster_lba"],
      [3444, "    mov dx, WRITE_CACHE_BUF"],
      [3455, "    call read_sector"],
      [3473, "    mov ax, WRITE_CACHE_BUF"],
      [3485, "    call wf_flush_sector_cache"],
      [3482, "    call wf_mark_sector_cache"],
      [3580, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3086, 3112, 3138, 3431, 3439, 3482],
  ...
  },
  {
    ...
    code: [
      ...
      [3646, ".delete_file:"],
      [3659, "    call parse_root_path"],
      [3663, "    call find_in_dir"],
      [2421, "    mov byte [es:di], 0xE5"],
      [4051, "    call flush_dir_slot"],
      [3679, "    call fat_free_chain"],
      [3680, "    call flush_fat"],
      [4874, ".rename_file:"],
      [4913, "    call parse_root_path"],
      [4922, "    call find_in_dir"],
      [4902, "    call entry_has_open_handle"],
      [4918, "    cmp ax, [cs:rn_dir_cluster]"],
      [4932, "    mov si, name_buf"],
      [4937, "    call flush_dir_slot"],
      [5003, ".commit_file:"],
      [5033, "    call wf_flush_handle_dir_entry"],
      [5035, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3646, 3680, 4874, 5003],
