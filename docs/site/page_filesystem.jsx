...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [590, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [591, "    test al, al"],
      [595, "    test al, ah"],
      [597, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [599, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [603, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [629, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [632, "    mov [cs:kfat_start], ax"],
      [642, "    mov [cs:krsta], ax"],
      [662, "    mov [cs:krsc], ax"],
      [665, "    mov [cs:kdsta], ax"],
      [680, "    sub ax, [cs:kdsta]"],
      [686, "    div cx"],
      [690, "    mov [cs:kmax_cluster], ax"],
      [692, "    mov byte [cs:kfat_bits], 12"],
      [696, "    cmp ax, 4087"],
      [698, "    mov byte [cs:kfat_bits], 16"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [1000, ".rp_parse_name:"],
      [1009, "    mov di, name_buf"],
      [1066, "    call ascii_upper"],
      [1082, "    mov di, name_buf + 8"],
      [1107, "    call find_in_dir"],
      [1109, "    test byte [es:di+11], ATTR_DIR"],
      [1121, "    call find_in_dir"],
      [1765, "parse_83name:"],
      [1774, "    mov di, name_buf"],
      [1775, "    mov cx, 11"],
      [1788, "    call ascii_upper"],
      [1791, "    cmp di, name_buf + 8"],
      [1800, ".pl_dot:"],
      [1802, "    mov di, name_buf + 8"],
      [1810, "    mov byte [es:di], '?'"],
      [1847, "parse_root_path:"],
      [1851, "    call activate_drive_for_path"],
      [1855, "    mov ax, [cs:cur_dir_cluster]"],
      [1869, "    mov [cs:pr_last_sep], bx"],
      [1900, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1912, "    call resolve_path"],
      [1925, "    call parse_83name"],
    ],
  ...
  },
  {
    ...
    code: [
      [1151, "find_in_dir:"],
      [1169, "    mov ax, [cs:fid_cluster]"],
      [1172, "    mov ax, ROOT_SEG"],
      [1175, "    cmp cx, [cs:kroot_entries]"],
      [1186, "    add ax, [cs:krsta]"],
      [1194, "    cmp byte [es:di], 0"],
      [1196, "    cmp byte [es:di], 0xE5"],
      [1207, "    call name_matches"],
      [1232, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .rid_notfound_pop"],
      [1235, "    cmp byte [es:di], 0"],
      [1269, "    call fat_next_checked"],
      [1275, "    mov [cs:ff_entry_lba], ax"],
      [1289, "    mov ax, [es:di+26]"],
      [1380, "find_dir_free:"],
      [1403, "    call cluster_lba"],
      [1408, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .sd_full"],
      [1411, "    cmp byte [es:di], 0"],
      [1427, "    call fat_next_checked"],
      [1437, "    call fat_alloc_cluster"],
      [1441, "    call fat_set"],
      [1473, "    call write_sector"],
      [1483, "    call flush_fat"],
      [1495, ".sd_rollback:"],
      [1498, "    call fat_set"],
      [1483, "    call flush_fat"],
  ...
  },
  {
    ...
    code: [
      [1564, "    mov ax, si"],
      [3331, "    call cluster_lba"],
      [3332, "    cmp byte [cs:rf_cache_valid], 1"],
      [3339, "    mov byte [cs:rf_cache_valid], 0"],
      [3378, "    mov dx, READ_CACHE_BUF"],
      [3658, "    call read_sector"],
      [3352, "    mov byte [cs:rf_cache_valid], 1"],
      [3378, "    mov dx, READ_CACHE_BUF"],
      [3572, ".wf_file:"],
      [3247, "    call activate_drive_for_handle"],
      [2551, "    call fat_alloc_cluster"],
      [3728, "    call wf_get_cluster"],
      [3768, "    mov ax, SEC_BUF"],
      [3658, "    call read_sector"],
      [3786, "    call write_sector"],
      [3791, "    mov byte [cs:rf_cache_valid], 0"],
      [3708, "    call fat_alloc_cluster"],
      [3728, "    call wf_get_cluster"],
      [3733, "    call cluster_lba"],
      [3783, "    mov dx, SEC_BUF"],
      [3658, "    call read_sector"],
      [3768, "    mov ax, SEC_BUF"],
      [3786, "    call write_sector"],
      [3791, "    mov byte [cs:rf_cache_valid], 0"],
      [3882, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2689, ".create_file:"],
      [2629, "    call parse_root_path"],
      [2635, "    call find_in_dir"],
      [2720, "    call find_dir_free"],
      [2733, "    call entry_has_open_handle"],
      [2750, "    mov si, [cs:cf_first_cluster]"],
      [2751, "    call fat_free_chain"],
      [2667, "    call flush_fat"],
      [2657, "    call load_dir_slot"],
      [954, "    mov si, name_buf"],
      [2663, "    call flush_dir_slot"],
      [3948, ".delete_file:"],
      [3961, "    call parse_root_path"],
      [3965, "    call find_in_dir"],
      [2660, "    mov byte [es:di], 0xE5"],
      [3978, "    call flush_dir_slot"],
      [3981, "    call fat_free_chain"],
      [3982, "    call flush_fat"],
      [5177, ".rename_file:"],
      [5193, "    call parse_root_path"],
      [5199, "    call find_in_dir"],
      [5205, "    call entry_has_open_handle"],
      [5221, "    cmp ax, [cs:rn_dir_cluster]"],
      [5235, "    mov si, name_buf"],
      [5240, "    call flush_dir_slot"],
      [5306, ".commit_file:"],
      [5288, "    call flush_handle_dir_entry"],
      [5338, "    call flush_fat"],
    ],
