...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3331, "    call wf_get_cluster"],
      [3362, "    mov ax, SEC_BUF"],
      [3265, "    call read_sector"],
      [3380, "    call write_sector"],
      [3385, "    mov byte [cs:rf_cache_valid], 0"],
      [3311, "    call fat_alloc_cluster"],
      [3331, "    call wf_get_cluster"],
      [3336, "    call cluster_lba"],
      [3377, "    mov dx, SEC_BUF"],
      [3265, "    call read_sector"],
      [3362, "    mov ax, SEC_BUF"],
      [3380, "    call write_sector"],
  ...
  },
  {
    ...
    code: [
      [2384, ".create_file:"],
      [2324, "    call parse_root_path"],
      [2330, "    call find_in_dir"],
      [2413, "    call find_dir_free"],
      [2426, "    call entry_has_open_handle"],
      [2443, "    mov si, [cs:cf_first_cluster]"],
      [2444, "    call fat_free_chain"],
      [2362, "    call flush_fat"],
      [2352, "    call load_dir_slot"],
      [794, "    mov si, name_buf"],
      [2358, "    call flush_dir_slot"],
      [3473, ".delete_file:"],
      ...
      [3502, "    call flush_fat"],
      [4590, ".rename_file:"],
      [4624, "    call parse_root_path"],
      [4631, "    call find_in_dir"],
      [4613, "    call entry_has_open_handle"],
      [4627, "    cmp ax, [cs:rn_dir_cluster]"],
      [4641, "    mov si, name_buf"],
      [4646, "    call flush_dir_slot"],
      [4712, ".commit_file:"],
      [4742, "    call flush_handle_dir_entry"],
      [4744, "    call flush_fat"],
    ],
