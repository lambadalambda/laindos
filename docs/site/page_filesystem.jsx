...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1555, "    mov ax, si"],
      [3322, "    call cluster_lba"],
      [3323, "    cmp byte [cs:rf_cache_valid], 1"],
      [3330, "    mov byte [cs:rf_cache_valid], 0"],
      [3369, "    mov dx, READ_CACHE_BUF"],
      [3649, "    call read_sector"],
      [3343, "    mov byte [cs:rf_cache_valid], 1"],
      [3369, "    mov dx, READ_CACHE_BUF"],
      [3563, ".wf_file:"],
      [3238, "    call activate_drive_for_handle"],
      [2542, "    call fat_alloc_cluster"],
      [3719, "    call wf_get_cluster"],
      [3759, "    mov ax, SEC_BUF"],
      [3649, "    call read_sector"],
      [3777, "    call write_sector"],
      [3782, "    mov byte [cs:rf_cache_valid], 0"],
      [3699, "    call fat_alloc_cluster"],
      [3719, "    call wf_get_cluster"],
      [3724, "    call cluster_lba"],
      [3774, "    mov dx, SEC_BUF"],
      [3649, "    call read_sector"],
      [3759, "    mov ax, SEC_BUF"],
      [3777, "    call write_sector"],
      [3782, "    mov byte [cs:rf_cache_valid], 0"],
      [3873, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2680, ".create_file:"],
      [2620, "    call parse_root_path"],
      [2626, "    call find_in_dir"],
      [2711, "    call find_dir_free"],
      [2724, "    call entry_has_open_handle"],
      [2741, "    mov si, [cs:cf_first_cluster]"],
      [2742, "    call fat_free_chain"],
      [2658, "    call flush_fat"],
      [2648, "    call load_dir_slot"],
      [945, "    mov si, name_buf"],
      [2654, "    call flush_dir_slot"],
      [3939, ".delete_file:"],
      [3952, "    call parse_root_path"],
      [3956, "    call find_in_dir"],
      [2651, "    mov byte [es:di], 0xE5"],
      [3969, "    call flush_dir_slot"],
      [3972, "    call fat_free_chain"],
      [3973, "    call flush_fat"],
      [5168, ".rename_file:"],
      [5184, "    call parse_root_path"],
      [5190, "    call find_in_dir"],
      [5196, "    call entry_has_open_handle"],
      [5212, "    cmp ax, [cs:rn_dir_cluster]"],
      [5226, "    mov si, name_buf"],
      [5231, "    call flush_dir_slot"],
      [5297, ".commit_file:"],
      [5279, "    call flush_handle_dir_entry"],
      [5329, "    call flush_fat"],
    ],
