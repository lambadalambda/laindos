...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [292, "    call fat_set"],
      [306, "flush_fat:"],
      [309, "    cmp byte [cs:kfat_bits], 16"],
      [336, "    mov ax, [cs:kfat_start]"],
      [353, "    call write_sector"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [1095, "    call find_in_dir"],
      [1097, "    test byte [es:di+11], ATTR_DIR"],
      [1113, "    call find_in_dir"],
      [1740, "parse_83name:"],
      [1753, "    mov di, name_buf"],
      [1750, "    mov cx, 11"],
      [1763, "    call ascii_upper"],
      [1766, "    cmp di, name_buf + 8"],
      [1775, ".pl_dot:"],
      [1777, "    mov di, name_buf + 8"],
      [1785, "    mov byte [es:di], '?'"],
      [1822, "parse_root_path:"],
      [1826, "    call activate_drive_for_path"],
      [1830, "    mov ax, [cs:cur_dir_cluster]"],
      [1844, "    mov [cs:pr_last_sep], bx"],
      [1875, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1887, "    call resolve_path"],
      [1900, "    call parse_83name"],
    ],
  ...
  },
  {
    ...
    code: [
      [1126, "find_in_dir:"],
      [1144, "    mov ax, [cs:fid_cluster]"],
      [1147, "    mov ax, ROOT_SEG"],
      [1150, "    cmp cx, [cs:kroot_entries]"],
      [1161, "    add ax, [cs:krsta]"],
      [1169, "    cmp byte [es:di], 0"],
      [1171, "    cmp byte [es:di], 0xE5"],
      [1182, "    call name_matches"],
      [1207, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .rid_notfound_pop"],
      [1210, "    cmp byte [es:di], 0"],
      [2225, "    call fat_next"],
      [1250, "    mov [cs:ff_entry_lba], ax"],
      [1264, "    mov ax, [es:di+26]"],
      [1355, "find_dir_free:"],
      [1378, "    call cluster_lba"],
      [1383, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .sd_full"],
      [1386, "    cmp byte [es:di], 0"],
      [2225, "    call fat_next"],
      [1412, "    call fat_alloc_cluster"],
      [1416, "    call fat_set"],
      [1448, "    call write_sector"],
      [1458, "    call flush_fat"],
      [1470, ".sd_rollback:"],
      [1473, "    call fat_set"],
      [1477, "    call flush_fat"],
  ...
  },
  {
    ...
    code: [
      [1390, "    mov ax, si"],
      [3030, "    call cluster_lba"],
      [3031, "    cmp byte [cs:rf_cache_valid], 1"],
      [3038, "    mov byte [cs:rf_cache_valid], 0"],
      [3077, "    mov dx, READ_CACHE_BUF"],
      [3297, "    call read_sector"],
      [3051, "    mov byte [cs:rf_cache_valid], 1"],
      [3077, "    mov dx, READ_CACHE_BUF"],
      [3211, ".wf_file:"],
      [2946, "    call activate_drive_for_handle"],
      [2250, "    call fat_alloc_cluster"],
      [3363, "    call wf_get_cluster"],
      [3394, "    mov ax, SEC_BUF"],
      [3297, "    call read_sector"],
      [3412, "    call write_sector"],
      [3417, "    mov byte [cs:rf_cache_valid], 0"],
      [3343, "    call fat_alloc_cluster"],
      [3363, "    call wf_get_cluster"],
      [3368, "    call cluster_lba"],
      [3409, "    mov dx, SEC_BUF"],
      [3297, "    call read_sector"],
      [3394, "    mov ax, SEC_BUF"],
      [3412, "    call write_sector"],
      [3417, "    mov byte [cs:rf_cache_valid], 0"],
      [3439, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2388, ".create_file:"],
      [2328, "    call parse_root_path"],
      [2334, "    call find_in_dir"],
      [2419, "    call find_dir_free"],
      [2432, "    call entry_has_open_handle"],
      [2449, "    mov si, [cs:cf_first_cluster]"],
      [2450, "    call fat_free_chain"],
      [2366, "    call flush_fat"],
      [2356, "    call load_dir_slot"],
      [794, "    mov si, name_buf"],
      [2362, "    call flush_dir_slot"],
      [3505, ".delete_file:"],
      [3518, "    call parse_root_path"],
      [3522, "    call find_in_dir"],
      [2359, "    mov byte [es:di], 0xE5"],
      [3535, "    call flush_dir_slot"],
      [3538, "    call fat_free_chain"],
      [3539, "    call flush_fat"],
      [4681, ".rename_file:"],
      [4697, "    call parse_root_path"],
      [4703, "    call find_in_dir"],
      [4709, "    call entry_has_open_handle"],
      [4725, "    cmp ax, [cs:rn_dir_cluster]"],
      [4739, "    mov si, name_buf"],
      [4744, "    call flush_dir_slot"],
      [4810, ".commit_file:"],
      [4840, "    call flush_handle_dir_entry"],
      [4842, "    call flush_fat"],
    ],
