...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [576, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [521, "    test al, al"],
      [525, "    test al, ah"],
      [527, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [529, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [573, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [565, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [562, "    mov [cs:kfat_start], ax"],
      [572, "    mov [cs:krsta], ax"],
      [592, "    mov [cs:krsc], ax"],
      [595, "    mov [cs:kdsta], ax"],
      [610, "    sub ax, [cs:kdsta]"],
      [616, "    div cx"],
      [620, "    mov [cs:kmax_cluster], ax"],
      [622, "    mov byte [cs:kfat_bits], 12"],
      [626, "    cmp ax, 4087"],
  ...
  },
  {
    ...
    code: [
      [1714, "    mov ax, si"],
      [3477, "    call cluster_lba"],
      [3090, "    cmp byte [cs:rf_cache_valid], 1"],
      [3535, "    mov byte [cs:rf_cache_valid], 0"],
      [3136, "    mov dx, READ_CACHE_BUF"],
      [3494, "    call read_sector"],
      [3110, "    mov byte [cs:rf_cache_valid], 1"],
      [3136, "    mov dx, READ_CACHE_BUF"],
      [3330, ".wf_file:"],
      [3349, "    call activate_drive_for_handle"],
      [2316, "    call fat_alloc_cluster"],
      [3472, "    call wf_get_cluster"],
      [3512, "    mov ax, SEC_BUF"],
      [3494, "    call read_sector"],
      [3530, "    call write_sector"],
      [3535, "    mov byte [cs:rf_cache_valid], 0"],
      [3459, "    call fat_alloc_cluster"],
      [3472, "    call wf_get_cluster"],
      [3477, "    call cluster_lba"],
      [3527, "    mov dx, SEC_BUF"],
      [3494, "    call read_sector"],
  ...
  },
  {
    ...
    code: [
      [2454, ".create_file:"],
      [2649, "    call parse_root_path"],
      [2653, "    call find_in_dir"],
      [2485, "    call find_dir_free"],
      [2498, "    call entry_has_open_handle"],
      [2515, "    mov si, [cs:cf_first_cluster]"],
      [2516, "    call fat_free_chain"],
      [2517, "    call flush_fat"],
      [2523, "    call load_dir_slot"],
      [996, "    mov si, name_buf"],
      [2550, "    call flush_dir_slot"],
      [3692, ".delete_file:"],
      [3705, "    call parse_root_path"],
      [3709, "    call find_in_dir"],
      [2425, "    mov byte [es:di], 0xE5"],
      [4097, "    call flush_dir_slot"],
      [3725, "    call fat_free_chain"],
      [3726, "    call flush_fat"],
      [4897, ".rename_file:"],
      [4936, "    call parse_root_path"],
      [4945, "    call find_in_dir"],
