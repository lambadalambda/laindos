...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1390, "    mov ax, si"],
      [3019, "    call cluster_lba"],
      [3020, "    cmp byte [cs:rf_cache_valid], 1"],
      [3027, "    mov byte [cs:rf_cache_valid], 0"],
      [3066, "    mov dx, READ_CACHE_BUF"],
      [3286, "    call read_sector"],
      [3040, "    mov byte [cs:rf_cache_valid], 1"],
      [3066, "    mov dx, READ_CACHE_BUF"],
      [3200, ".wf_file:"],
      [2940, "    call activate_drive_for_handle"],
      [2248, "    call fat_alloc_cluster"],
      [3352, "    call wf_get_cluster"],
      [3383, "    mov ax, SEC_BUF"],
      [3286, "    call read_sector"],
      [3401, "    call write_sector"],
      [3406, "    mov byte [cs:rf_cache_valid], 0"],
      [3332, "    call fat_alloc_cluster"],
      [3352, "    call wf_get_cluster"],
      [3357, "    call cluster_lba"],
      [3398, "    mov dx, SEC_BUF"],
      [3286, "    call read_sector"],
      [3383, "    mov ax, SEC_BUF"],
      [3401, "    call write_sector"],
      [3406, "    mov byte [cs:rf_cache_valid], 0"],
      [3428, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [3494, ".delete_file:"],
      [3502, "    call parse_root_path"],
      [3506, "    call find_in_dir"],
      [2355, "    mov byte [es:di], 0xE5"],
      [3519, "    call flush_dir_slot"],
      [3522, "    call fat_free_chain"],
      [3523, "    call flush_fat"],
      [4661, ".rename_file:"],
      [4672, "    call parse_root_path"],
      [4678, "    call find_in_dir"],
      [4684, "    call entry_has_open_handle"],
      [4698, "    cmp ax, [cs:rn_dir_cluster]"],
      [4712, "    mov si, name_buf"],
      [4717, "    call flush_dir_slot"],
      [4783, ".commit_file:"],
      [4813, "    call flush_handle_dir_entry"],
      [4815, "    call flush_fat"],
    ],
