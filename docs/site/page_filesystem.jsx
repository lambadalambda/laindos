...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [453, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [454, "    test al, al"],
      [458, "    test al, ah"],
      [460, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [462, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [466, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [492, "    mov byte [cs:kfat_bits], 12"],
      [496, "    cmp byte [bx+BPB_FS_TYPE+4], '6'"],
      [498, "    mov byte [cs:kfat_bits], 16"],
      [503, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [506, "    mov [cs:kfat_start], ax"],
      [516, "    mov [cs:krsta], ax"],
      [536, "    mov [cs:krsc], ax"],
      [539, "    mov [cs:kdsta], ax"],
      [554, "    sub ax, [cs:kdsta]"],
      [560, "    div cx"],
      [564, "    mov [cs:kmax_cluster], ax"],
    ],
  ...
  },
  {
    ...
    code: [
      [939, "resolve_path:"],
      [941, "    call activate_drive_for_path"],
      [945, "    cmp byte [ds:si], '\\'"],
      [955, "    mov ax, [cs:cur_dir_cluster]"],
      [960, "    mov ax, ROOT_CLUSTER"],
      [963, "    mov ax, [cs:cur_dir_cluster]"],
      [998, ".rp_parse_name:"],
      [1007, "    mov di, name_buf"],
      [1063, "    call ascii_upper"],
      [1071, "    mov di, name_buf + 8"],
      [1090, "    call find_in_dir"],
      [1092, "    test byte [es:di+11], ATTR_DIR"],
      [1108, "    call find_in_dir"],
      [1711, "parse_83name:"],
      [1720, "    mov di, name_buf"],
      [1721, "    mov cx, 11"],
      [1734, "    call ascii_upper"],
      [1737, "    cmp di, name_buf + 8"],
      [1746, ".pl_dot:"],
      [1748, "    mov di, name_buf + 8"],
      [1756, "    mov byte [es:di], '?'"],
      [1785, "parse_root_path:"],
      [1789, "    call activate_drive_for_path"],
      [1793, "    mov ax, [cs:cur_dir_cluster]"],
      [1807, "    mov [cs:pr_last_sep], bx"],
      [1838, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1856, "    call resolve_path"],
      [1869, "    call parse_83name"],
    ],
    hi: [939, 960, 1063, 1711, 1756, 1785, 1856],
  ...
  },
  {
    ...
    code: [
      [1121, "find_in_dir:"],
      [1139, "    mov ax, [cs:fid_cluster]"],
      [1142, "    mov ax, ROOT_SEG"],
      [1145, "    cmp cx, [cs:kroot_entries]"],
      [1156, "    add ax, [cs:krsta]"],
      [1164, "    cmp byte [es:di], 0"],
      [1166, "    cmp byte [es:di], 0xE5"],
      [1177, "    call name_matches"],
      [1201, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .rid_notfound_pop"],
      [1204, "    cmp byte [es:di], 0"],
      [1238, "    call fat_next"],
      [1249, "    mov [cs:ff_entry_lba], ax"],
      [1263, "    mov ax, [es:di+26]"],
      [1354, "find_dir_free:"],
      [1376, "    call cluster_lba"],
      [1381, "    LOAD_SUBDIR_SECTOR rid_lba, rid_lba_hi, .sd_full"],
      [1384, "    cmp byte [es:di], 0"],
      [1400, "    call fat_next"],
      [1411, "    call fat_alloc_cluster"],
      [1415, "    call fat_set"],
      [1447, "    call write_sector"],
      [1457, "    call flush_fat"],
      [1469, ".sd_rollback:"],
      [1475, "    call fat_set"],
      [1476, "    call flush_fat"],
  ...
  },
  {
    ...
    code: [
      [1366, "    mov ax, si"],
      [2861, "    call cluster_lba"],
      [2862, "    cmp byte [cs:rf_cache_valid], 1"],
      [2869, "    mov byte [cs:rf_cache_valid], 0"],
      [2876, "    mov dx, READ_CACHE_BUF"],
      [2878, "    call read_sector"],
      [2882, "    mov byte [cs:rf_cache_valid], 1"],
      [2908, "    mov dx, READ_CACHE_BUF"],
      [3042, ".wf_file:"],
      [2788, "    call activate_drive_for_handle"],
      [2162, "    call fat_alloc_cluster"],
      [3114, "    call wf_get_cluster"],
      [3121, "    mov ax, SEC_BUF"],
      [3127, "    call read_sector"],
      [3155, "    call write_sector"],
      [3158, "    mov byte [cs:rf_cache_valid], 0"],
      [3173, "    call fat_alloc_cluster"],
      [3193, "    call wf_get_cluster"],
      [3198, "    call cluster_lba"],
      [3204, "    mov dx, SEC_BUF"],
      [3207, "    call read_sector"],
      [3224, "    mov ax, SEC_BUF"],
      [3242, "    call write_sector"],
      [3247, "    mov byte [cs:rf_cache_valid], 0"],
      [3269, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2298, ".create_file:"],
      [2143, "    call parse_root_path"],
      [2149, "    call find_in_dir"],
      [2152, "    call find_dir_free"],
      [2335, "    call entry_has_open_handle"],
      [2352, "    mov si, [cs:cf_first_cluster]"],
      [2206, "    call fat_free_chain"],
      [2167, "    call flush_fat"],
      [2172, "    call load_dir_slot"],
      [770, "    mov si, name_buf"],
      [2200, "    call flush_dir_slot"],
      [3335, ".delete_file:"],
      [3343, "    call parse_root_path"],
      [3347, "    call find_in_dir"],
      [2269, "    mov byte [es:di], 0xE5"],
      [3360, "    call flush_dir_slot"],
      [3363, "    call fat_free_chain"],
      [3364, "    call flush_fat"],
      [4365, ".rename_file:"],
      [4399, "    call parse_root_path"],
      [4406, "    call find_in_dir"],
      [4388, "    call entry_has_open_handle"],
      [4402, "    cmp ax, [cs:rn_dir_cluster]"],
      [4416, "    mov si, name_buf"],
      [4421, "    call flush_dir_slot"],
      [4487, ".commit_file:"],
      [4469, "    call flush_handle_dir_entry"],
      [4519, "    call flush_fat"],
    ],
