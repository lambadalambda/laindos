...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3757, "    mov ax, SEC_BUF"],
      [3647, "    call read_sector"],
      [3775, "    call write_sector"],
      [3780, "    mov byte [cs:rf_cache_valid], 0"],
  ...
  },
  {
    ...
    code: [
      ...
      [3937, ".delete_file:"],
      [3950, "    call parse_root_path"],
      [3954, "    call find_in_dir"],
      [2649, "    mov byte [es:di], 0xE5"],
      [3967, "    call flush_dir_slot"],
      [3970, "    call fat_free_chain"],
      [3971, "    call flush_fat"],
      [5166, ".rename_file:"],
      [5182, "    call parse_root_path"],
      [5188, "    call find_in_dir"],
      [5194, "    call entry_has_open_handle"],
      [5210, "    cmp ax, [cs:rn_dir_cluster]"],
      [5224, "    mov si, name_buf"],
      [5229, "    call flush_dir_slot"],
      [5295, ".commit_file:"],
      [5277, "    call flush_handle_dir_entry"],
      [5327, "    call flush_fat"],
    ],
