...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [430, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [431, "    test al, al"],
      [435, "    test al, ah"],
      [437, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [439, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [443, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [469, "    mov byte [cs:kfat_bits], 12"],
      [473, "    cmp byte [bx+BPB_FS_TYPE+4], '6'"],
      [475, "    mov byte [cs:kfat_bits], 16"],
      [480, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [483, "    mov [cs:kfat_start], ax"],
      [493, "    mov [cs:krsta], ax"],
      [513, "    mov [cs:krsc], ax"],
      [516, "    mov [cs:kdsta], ax"],
      [531, "    sub ax, [cs:kdsta]"],
      [537, "    div cx"],
      [541, "    mov [cs:kmax_cluster], ax"],
    ],
    hi: [430, 469, 475, 493, 516, 541],
  ...
  },
  {
    ...
    code: [
      ...
      [297, "    mov ax, [cs:kfat_start]"],
      [314, "    call write_sector"],
    ],
  ...
  },
  {
    ...
    code: [
      [925, "resolve_path:"],
      [927, "    call activate_drive_for_path"],
      [931, "    cmp byte [ds:si], '\\'"],
      [941, "    cmp byte [ds:si+1], ':'"],
      [949, "    mov ax, [cs:cur_dir_cluster]"],
      [954, "    mov ax, ROOT_CLUSTER"],
      [957, "    mov ax, [cs:cur_dir_cluster]"],
      [992, ".rp_parse_name:"],
      [1001, "    mov di, name_buf"],
      [1057, "    call ascii_upper"],
      [1063, "    mov di, name_buf + 8"],
      [1076, "    call find_in_dir"],
      [1078, "    test byte [es:di+11], ATTR_DIR"],
      [1094, "    call find_in_dir"],
      [1729, "parse_83name:"],
      [1738, "    mov di, name_buf"],
      [1739, "    mov cx, 11"],
      [1752, "    call ascii_upper"],
      [1755, "    cmp di, name_buf + 8"],
      [1764, ".pl_dot:"],
      [1766, "    mov di, name_buf + 8"],
      [1774, "    mov byte [es:di], '?'"],
      [1803, "parse_root_path:"],
      [1807, "    call activate_drive_for_path"],
      [1811, "    mov ax, [cs:cur_dir_cluster]"],
      [1833, "    mov [cs:pr_last_sep], bx"],
      [1880, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1905, "    call resolve_path"],
      [1918, "    call parse_83name"],
    ],
    hi: [925, 954, 1057, 1729, 1774, 1803, 1905],
  ...
  },
  {
    ...
    code: [
      [1107, "find_in_dir:"],
      [1125, "    mov ax, [cs:fid_cluster]"],
      [1128, "    mov ax, ROOT_SEG"],
      [1131, "    cmp cx, [cs:kroot_entries]"],
      [1142, "    add ax, [cs:krsta]"],
      [1150, "    cmp byte [es:di], 0"],
      [1152, "    cmp byte [es:di], 0xE5"],
      [1163, "    call name_matches"],
      [1188, "    mov dx, SEC_BUF"],
      [1194, "    call read_sector"],
      [1202, "    cmp byte [es:di], 0"],
      [1236, "    call fat_next"],
      [1247, "    mov [cs:ff_entry_lba], ax"],
      [1261, "    mov ax, [es:di+26]"],
      [1352, "find_dir_free:"],
      [1374, "    call cluster_lba"],
      [1379, "    mov dx, SEC_BUF"],
      [1392, "    cmp byte [es:di], 0"],
      [1408, "    call fat_next"],
      [1419, "    call fat_alloc_cluster"],
      [1423, "    call fat_set"],
      [1455, "    call write_sector"],
      [1465, "    call flush_fat"],
      [1477, ".sd_rollback:"],
      [1480, "    call fat_set"],
      [1484, "    call flush_fat"],
    ],
    hi: [1107, 1128, 1188, 1352, 1419, 1477],
  ...
  },
  {
    ...
    code: [
      [2851, "    mov ax, si"],
      [2853, "    call cluster_lba"],
      [2854, "    cmp byte [cs:rf_cache_valid], 1"],
      [2861, "    mov byte [cs:rf_cache_valid], 0"],
      [2868, "    mov dx, READ_CACHE_BUF"],
      [2870, "    call read_sector"],
      [2874, "    mov byte [cs:rf_cache_valid], 1"],
      [2900, "    mov dx, READ_CACHE_BUF"],
      [3035, ".wf_file:"],
      [3054, "    call activate_drive_for_handle"],
      [3088, "    call fat_alloc_cluster"],
      [3107, "    call wf_get_cluster"],
      [3114, "    mov ax, SEC_BUF"],
      [3120, "    call read_sector"],
      [3148, "    call write_sector"],
      [3151, "    mov byte [cs:rf_cache_valid], 0"],
      [3166, "    call fat_alloc_cluster"],
      [3186, "    call wf_get_cluster"],
      [3191, "    call cluster_lba"],
      [3197, "    mov dx, SEC_BUF"],
      [3200, "    call read_sector"],
      [3217, "    mov ax, SEC_BUF"],
      [3235, "    call write_sector"],
      [3240, "    mov byte [cs:rf_cache_valid], 0"],
      [3262, "    mov ax, [cs:wf_written]"],
    ],
    hi: [2854, 2868, 3088, 3151, 3166, 3240],
  ...
  },
  {
    ...
    code: [
      [2271, ".create_file:"],
      [2288, "    call parse_root_path"],
      [2292, "    call find_in_dir"],
      [2295, "    call find_dir_free"],
      [2308, "    call entry_has_open_handle"],
      [2325, "    mov si, [cs:cf_first_cluster]"],
      [2326, "    call fat_free_chain"],
      [2327, "    call flush_fat"],
      [2333, "    call load_dir_slot"],
      [2346, "    mov si, name_buf"],
      [2360, "    call flush_dir_slot"],
      [3330, ".delete_file:"],
      [3338, "    call parse_root_path"],
      [3342, "    call find_in_dir"],
      [3352, "    mov byte [es:di], 0xE5"],
      [3355, "    call flush_dir_slot"],
      [3358, "    call fat_free_chain"],
      [3359, "    call flush_fat"],
      [4400, ".rename_file:"],
      [4411, "    call parse_root_path"],
      [4417, "    call find_in_dir"],
      [4423, "    call entry_has_open_handle"],
      [4437, "    cmp ax, [cs:rn_dir_cluster]"],
      [4451, "    mov si, name_buf"],
      [4456, "    call flush_dir_slot"],
      [4526, ".commit_file:"],
      [4556, "    call flush_handle_dir_entry"],
      [4558, "    call flush_fat"],
    ],
    hi: [2271, 2326, 3330, 3352, 4400, 4526],
