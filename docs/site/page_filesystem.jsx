...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1390, "    mov ax, si"],
      [3026, "    call cluster_lba"],
      [3027, "    cmp byte [cs:rf_cache_valid], 1"],
      [3034, "    mov byte [cs:rf_cache_valid], 0"],
      [3073, "    mov dx, READ_CACHE_BUF"],
      [3293, "    call read_sector"],
      [3047, "    mov byte [cs:rf_cache_valid], 1"],
      [3073, "    mov dx, READ_CACHE_BUF"],
      [3207, ".wf_file:"],
      [2942, "    call activate_drive_for_handle"],
      [2248, "    call fat_alloc_cluster"],
      [3359, "    call wf_get_cluster"],
      [3390, "    mov ax, SEC_BUF"],
      [3293, "    call read_sector"],
      [3408, "    call write_sector"],
      [3413, "    mov byte [cs:rf_cache_valid], 0"],
      [3339, "    call fat_alloc_cluster"],
      [3359, "    call wf_get_cluster"],
      [3364, "    call cluster_lba"],
      [3405, "    mov dx, SEC_BUF"],
      [3293, "    call read_sector"],
      [3390, "    mov ax, SEC_BUF"],
      [3408, "    call write_sector"],
      [3413, "    mov byte [cs:rf_cache_valid], 0"],
      [3435, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [2415, "    call find_dir_free"],
      [2428, "    call entry_has_open_handle"],
      [2445, "    mov si, [cs:cf_first_cluster]"],
      [2446, "    call fat_free_chain"],
      [2362, "    call flush_fat"],
      [2352, "    call load_dir_slot"],
      [794, "    mov si, name_buf"],
      [2358, "    call flush_dir_slot"],
      [3501, ".delete_file:"],
      [3509, "    call parse_root_path"],
      [3513, "    call find_in_dir"],
      [2355, "    mov byte [es:di], 0xE5"],
      [3526, "    call flush_dir_slot"],
      [3529, "    call fat_free_chain"],
      [3530, "    call flush_fat"],
      [4672, ".rename_file:"],
      [4683, "    call parse_root_path"],
      [4689, "    call find_in_dir"],
      [4695, "    call entry_has_open_handle"],
      [4711, "    cmp ax, [cs:rn_dir_cluster]"],
      [4725, "    mov si, name_buf"],
      [4730, "    call flush_dir_slot"],
      [4796, ".commit_file:"],
      [4826, "    call flush_handle_dir_entry"],
      [4828, "    call flush_fat"],
    ],
