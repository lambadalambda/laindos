...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [577, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [578, "    test al, al"],
      [582, "    test al, ah"],
      [584, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [586, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [590, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [616, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [619, "    mov [cs:kfat_start], ax"],
      [629, "    mov [cs:krsta], ax"],
      [649, "    mov [cs:krsc], ax"],
      [652, "    mov [cs:kdsta], ax"],
      [667, "    sub ax, [cs:kdsta]"],
      [673, "    div cx"],
      [677, "    mov [cs:kmax_cluster], ax"],
      [679, "    mov byte [cs:kfat_bits], 12"],
      [683, "    cmp ax, 4087"],
      [685, "    mov byte [cs:kfat_bits], 16"],
    ],
  ...
  },
  {
    ...
    code: [
      [1554, "    mov ax, si"],
      [3321, "    call cluster_lba"],
      [3322, "    cmp byte [cs:rf_cache_valid], 1"],
      [3329, "    mov byte [cs:rf_cache_valid], 0"],
      [3368, "    mov dx, READ_CACHE_BUF"],
      [3648, "    call read_sector"],
      [3342, "    mov byte [cs:rf_cache_valid], 1"],
      [3368, "    mov dx, READ_CACHE_BUF"],
      [3562, ".wf_file:"],
      [3237, "    call activate_drive_for_handle"],
      [2541, "    call fat_alloc_cluster"],
      [3718, "    call wf_get_cluster"],
      [3758, "    mov ax, SEC_BUF"],
      [3648, "    call read_sector"],
      [3776, "    call write_sector"],
      [3781, "    mov byte [cs:rf_cache_valid], 0"],
      [3698, "    call fat_alloc_cluster"],
      [3718, "    call wf_get_cluster"],
      [3723, "    call cluster_lba"],
      [3773, "    mov dx, SEC_BUF"],
      [3648, "    call read_sector"],
      [3758, "    mov ax, SEC_BUF"],
      [3776, "    call write_sector"],
      [3781, "    mov byte [cs:rf_cache_valid], 0"],
      [3872, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2679, ".create_file:"],
      [2619, "    call parse_root_path"],
      [2625, "    call find_in_dir"],
      [2710, "    call find_dir_free"],
      [2723, "    call entry_has_open_handle"],
      [2740, "    mov si, [cs:cf_first_cluster]"],
      [2741, "    call fat_free_chain"],
      [2657, "    call flush_fat"],
      [2647, "    call load_dir_slot"],
      [944, "    mov si, name_buf"],
      [2653, "    call flush_dir_slot"],
      [3938, ".delete_file:"],
      [3951, "    call parse_root_path"],
      [3955, "    call find_in_dir"],
      [2650, "    mov byte [es:di], 0xE5"],
      [3968, "    call flush_dir_slot"],
      [3971, "    call fat_free_chain"],
      [3972, "    call flush_fat"],
      [5167, ".rename_file:"],
      [5183, "    call parse_root_path"],
      [5189, "    call find_in_dir"],
      [5195, "    call entry_has_open_handle"],
      [5211, "    cmp ax, [cs:rn_dir_cluster]"],
      [5225, "    mov si, name_buf"],
      [5230, "    call flush_dir_slot"],
      [5296, ".commit_file:"],
      [5278, "    call flush_handle_dir_entry"],
      [5328, "    call flush_fat"],
    ],
