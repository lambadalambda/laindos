...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1559, "    mov ax, si"],
      [3297, "    call cluster_lba"],
      [3298, "    cmp byte [cs:rf_cache_valid], 1"],
      [3305, "    mov byte [cs:rf_cache_valid], 0"],
      [3344, "    mov dx, READ_CACHE_BUF"],
      [3624, "    call read_sector"],
      [3318, "    mov byte [cs:rf_cache_valid], 1"],
      [3344, "    mov dx, READ_CACHE_BUF"],
      [3538, ".wf_file:"],
      [3213, "    call activate_drive_for_handle"],
      [2517, "    call fat_alloc_cluster"],
      [3694, "    call wf_get_cluster"],
      [3725, "    mov ax, SEC_BUF"],
      [3624, "    call read_sector"],
      [3743, "    call write_sector"],
      [3748, "    mov byte [cs:rf_cache_valid], 0"],
      [3674, "    call fat_alloc_cluster"],
      [3694, "    call wf_get_cluster"],
      [3699, "    call cluster_lba"],
      [3740, "    mov dx, SEC_BUF"],
      [3624, "    call read_sector"],
      [3725, "    mov ax, SEC_BUF"],
      [3743, "    call write_sector"],
      [3748, "    mov byte [cs:rf_cache_valid], 0"],
      [3839, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      [2655, ".create_file:"],
      [2595, "    call parse_root_path"],
      [2601, "    call find_in_dir"],
      [2686, "    call find_dir_free"],
      [2699, "    call entry_has_open_handle"],
      [2716, "    mov si, [cs:cf_first_cluster]"],
      [2717, "    call fat_free_chain"],
      [2633, "    call flush_fat"],
      [2623, "    call load_dir_slot"],
      [949, "    mov si, name_buf"],
      [2629, "    call flush_dir_slot"],
      [3905, ".delete_file:"],
      [3918, "    call parse_root_path"],
      [3922, "    call find_in_dir"],
      [2626, "    mov byte [es:di], 0xE5"],
      [3935, "    call flush_dir_slot"],
      [3938, "    call fat_free_chain"],
      [3939, "    call flush_fat"],
      [5129, ".rename_file:"],
      [5145, "    call parse_root_path"],
      [5151, "    call find_in_dir"],
      [5157, "    call entry_has_open_handle"],
      [5173, "    cmp ax, [cs:rn_dir_cluster]"],
      [5187, "    mov si, name_buf"],
      [5192, "    call flush_dir_slot"],
      [5258, ".commit_file:"],
      [5240, "    call flush_handle_dir_entry"],
      [5290, "    call flush_fat"],
    ],
