...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1065, "    mov di, name_buf + 8"],
      [1084, "    call find_in_dir"],
      [1086, "    test byte [es:di+11], ATTR_DIR"],
      [1102, "    call find_in_dir"],
      [1737, "parse_83name:"],
      [1746, "    mov di, name_buf"],
      [1747, "    mov cx, 11"],
      [1760, "    call ascii_upper"],
      [1763, "    cmp di, name_buf + 8"],
      [1772, ".pl_dot:"],
      [1774, "    mov di, name_buf + 8"],
      [1782, "    mov byte [es:di], '?'"],
      [1811, "parse_root_path:"],
      [1815, "    call activate_drive_for_path"],
      [1819, "    mov ax, [cs:cur_dir_cluster]"],
      [1841, "    mov [cs:pr_last_sep], bx"],
      [1888, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1913, "    call resolve_path"],
      [1926, "    call parse_83name"],
    ],
    hi: [925, 954, 1057, 1737, 1782, 1811, 1913],
  ...
  },
  {
    ...
    code: [
      [1115, "find_in_dir:"],
      [1133, "    mov ax, [cs:fid_cluster]"],
      [1136, "    mov ax, ROOT_SEG"],
      [1139, "    cmp cx, [cs:kroot_entries]"],
      [1150, "    add ax, [cs:krsta]"],
      [1158, "    cmp byte [es:di], 0"],
      [1160, "    cmp byte [es:di], 0xE5"],
      [1171, "    call name_matches"],
      [1196, "    mov dx, SEC_BUF"],
      [1202, "    call read_sector"],
      [1210, "    cmp byte [es:di], 0"],
      [1244, "    call fat_next"],
      [1255, "    mov [cs:ff_entry_lba], ax"],
      [1269, "    mov ax, [es:di+26]"],
      [1360, "find_dir_free:"],
      [1382, "    call cluster_lba"],
      [1387, "    mov dx, SEC_BUF"],
      [1400, "    cmp byte [es:di], 0"],
      [1416, "    call fat_next"],
      [1427, "    call fat_alloc_cluster"],
      [1431, "    call fat_set"],
      [1463, "    call write_sector"],
      [1473, "    call flush_fat"],
      [1485, ".sd_rollback:"],
      [1488, "    call fat_set"],
      [1492, "    call flush_fat"],
    ],
    hi: [1115, 1136, 1196, 1360, 1427, 1485],
