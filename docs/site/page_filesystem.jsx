...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [4938, "    call find_in_dir"],
      [4944, "    call entry_has_open_handle"],
      [4960, "    cmp ax, [cs:rn_dir_cluster]"],
      [4974, "    mov si, name_buf"],
      [4979, "    call flush_dir_slot"],
      [5045, ".commit_file:"],
      [5075, "    call flush_handle_dir_entry"],
      [5077, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3688, 3722, 4916, 5045],
