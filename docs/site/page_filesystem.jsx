...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [565, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [566, "    test al, al"],
      [570, "    test al, ah"],
      [572, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [574, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [578, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [604, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [607, "    mov [cs:kfat_start], ax"],
      [617, "    mov [cs:krsta], ax"],
      [637, "    mov [cs:krsc], ax"],
      [640, "    mov [cs:kdsta], ax"],
      [655, "    sub ax, [cs:kdsta]"],
      [661, "    div cx"],
      [665, "    mov [cs:kmax_cluster], ax"],
      [667, "    mov byte [cs:kfat_bits], 12"],
      [671, "    cmp ax, 4087"],
      [673, "    mov byte [cs:kfat_bits], 16"],
    ],
  ...
  },
  {
    ...
    code: [
      [1390, "    mov ax, si"],
      [3008, "    call cluster_lba"],
      [3009, "    cmp byte [cs:rf_cache_valid], 1"],
      [3016, "    mov byte [cs:rf_cache_valid], 0"],
      [3055, "    mov dx, READ_CACHE_BUF"],
      [3275, "    call read_sector"],
      [3029, "    mov byte [cs:rf_cache_valid], 1"],
      [3055, "    mov dx, READ_CACHE_BUF"],
      [3189, ".wf_file:"],
      [2929, "    call activate_drive_for_handle"],
      [2248, "    call fat_alloc_cluster"],
      [3341, "    call wf_get_cluster"],
      [3372, "    mov ax, SEC_BUF"],
      [3275, "    call read_sector"],
      [3390, "    call write_sector"],
      [3395, "    mov byte [cs:rf_cache_valid], 0"],
      [3321, "    call fat_alloc_cluster"],
      [3341, "    call wf_get_cluster"],
      [3346, "    call cluster_lba"],
      [3387, "    mov dx, SEC_BUF"],
      [3275, "    call read_sector"],
      [3372, "    mov ax, SEC_BUF"],
      [3390, "    call write_sector"],
      [3395, "    mov byte [cs:rf_cache_valid], 0"],
      [3417, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [3483, ".delete_file:"],
      [3491, "    call parse_root_path"],
      [3495, "    call find_in_dir"],
      [2355, "    mov byte [es:di], 0xE5"],
      [3508, "    call flush_dir_slot"],
      [3511, "    call fat_free_chain"],
      [3512, "    call flush_fat"],
      [4631, ".rename_file:"],
      [4642, "    call parse_root_path"],
      [4648, "    call find_in_dir"],
      [4654, "    call entry_has_open_handle"],
      [4668, "    cmp ax, [cs:rn_dir_cluster]"],
      [4682, "    mov si, name_buf"],
      [4687, "    call flush_dir_slot"],
      [4753, ".commit_file:"],
      [4783, "    call flush_handle_dir_entry"],
      [4785, "    call flush_fat"],
    ],
