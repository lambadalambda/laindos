...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1710, "    mov ax, si"],
      [3598, "    call cluster_lba"],
      [3146, "    call read_sectors"],
      [3165, "    cmp byte [cs:rf_cache_valid], 1"],
      [3177, "    cmp cl, [cs:rf_cache_count]"],
      [3207, "    mov byte [cs:rf_cache_count], READ_CACHE_SECTORS"],
      [3209, "    mov cl, [cs:kspc]"],
      [3245, "    call wf_fill_read_cache_from_write"],
      [3255, "    mov dx, READ_CACHE_BUF"],
      [3259, "    call read_sectors"],
      [3291, "    mov dx, [cs:rf_cache_seg]"],
      [3466, ".write_file: PERF_INC perf_write_calls"],
      [3504, "    call activate_drive_for_handle"],
      [2312, "    call fat_alloc_cluster"],
      [3593, "    call wf_get_cluster"],
      [3601, "    call wf_prepare_sector_cache"],
      [3635, "    mov ax, WRITE_CACHE_BUF"],
      [3617, "    call read_sector"],
      [3644, "    call wf_mark_sector_cache"],
      [3576, "    call fat_alloc_cluster"],
      [3593, "    call wf_get_cluster"],
      [3598, "    call cluster_lba"],
      [3606, "    mov dx, WRITE_CACHE_BUF"],
      [3617, "    call read_sector"],
      [3635, "    mov ax, WRITE_CACHE_BUF"],
      [3647, "    call wf_flush_sector_cache"],
      [3644, "    call wf_mark_sector_cache"],
      [3751, "    mov ax, [cs:wf_written]"],
    ],
    hi: [3146, 3165, 3207, 3259, 3291, 3593, 3601, 3644],
  ...
  },
  {
    ...
    code: [
      ...
      [3817, ".delete_file:"],
      [3830, "    call parse_root_path"],
      [3834, "    call find_in_dir"],
      [3844, "    mov byte [es:di], 0xE5"],
      [3847, "    call flush_dir_slot"],
      [3850, "    call fat_free_chain"],
      [3851, "    call flush_fat"],
      [5048, ".rename_file:"],
      [5064, "    call parse_root_path"],
      [5070, "    call find_in_dir"],
      [5076, "    call entry_has_open_handle"],
      [5092, "    cmp ax, [cs:rn_dir_cluster]"],
      [5106, "    mov si, name_buf"],
      [5111, "    call flush_dir_slot"],
      [5178, ".commit_file:"],
      [5208, "    call wf_flush_handle_dir_entry"],
      [5210, "    call flush_fat"],
    ],
    hi: [2450, 2546, 3817, 3851, 5048, 5178],
