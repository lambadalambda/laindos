...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [558, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [559, "    test al, al"],
      [563, "    test al, ah"],
      [565, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [567, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [571, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [597, "    mov byte [cs:kfat_bits], 12"],
      [601, "    cmp byte [bx+BPB_FS_TYPE+4], '6'"],
      [603, "    mov byte [cs:kfat_bits], 16"],
      [608, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [611, "    mov [cs:kfat_start], ax"],
      [621, "    mov [cs:krsta], ax"],
      [641, "    mov [cs:krsc], ax"],
      [644, "    mov [cs:kdsta], ax"],
      [659, "    sub ax, [cs:kdsta]"],
      [665, "    div cx"],
      [669, "    mov [cs:kmax_cluster], ax"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [3502, "    call flush_fat"],
      [4621, ".rename_file:"],
      [4632, "    call parse_root_path"],
      [4638, "    call find_in_dir"],
      [4644, "    call entry_has_open_handle"],
      [4658, "    cmp ax, [cs:rn_dir_cluster]"],
      [4672, "    mov si, name_buf"],
      [4677, "    call flush_dir_slot"],
      [4743, ".commit_file:"],
      [4773, "    call flush_handle_dir_entry"],
      [4775, "    call flush_fat"],
    ],
