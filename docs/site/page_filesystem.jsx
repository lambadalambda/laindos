...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1712, "parse_83name:"],
      [1725, "    mov di, name_buf"],
      [1722, "    mov cx, 11"],
      [1735, "    call ascii_upper"],
      [1738, "    cmp di, name_buf + 8"],
      [1747, ".pl_dot:"],
      [1749, "    mov di, name_buf + 8"],
      [1757, "    mov byte [es:di], '?'"],
      [1794, "parse_root_path:"],
      [1798, "    call activate_drive_for_path"],
      [1802, "    mov ax, [cs:cur_dir_cluster]"],
      [1816, "    mov [cs:pr_last_sep], bx"],
      [1847, "    mov word [cs:pr_dir_cluster], ROOT_CLUSTER"],
      [1859, "    call resolve_path"],
      [1872, "    call parse_83name"],
    ],
  ...
  },
  {
    ...
    code: [
      [1390, "    mov ax, si"],
      [3024, "    call cluster_lba"],
      [3025, "    cmp byte [cs:rf_cache_valid], 1"],
      [3032, "    mov byte [cs:rf_cache_valid], 0"],
      [3071, "    mov dx, READ_CACHE_BUF"],
      [3291, "    call read_sector"],
      [3045, "    mov byte [cs:rf_cache_valid], 1"],
      [3071, "    mov dx, READ_CACHE_BUF"],
      [3205, ".wf_file:"],
      [2940, "    call activate_drive_for_handle"],
      [2248, "    call fat_alloc_cluster"],
      [3357, "    call wf_get_cluster"],
      [3388, "    mov ax, SEC_BUF"],
      [3291, "    call read_sector"],
      [3406, "    call write_sector"],
      [3411, "    mov byte [cs:rf_cache_valid], 0"],
      [3337, "    call fat_alloc_cluster"],
      [3357, "    call wf_get_cluster"],
      [3362, "    call cluster_lba"],
      [3403, "    mov dx, SEC_BUF"],
      [3291, "    call read_sector"],
      [3388, "    mov ax, SEC_BUF"],
      [3406, "    call write_sector"],
      [3411, "    mov byte [cs:rf_cache_valid], 0"],
      [3433, "    mov ax, [cs:wf_written]"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [3499, ".delete_file:"],
      [3507, "    call parse_root_path"],
      [3511, "    call find_in_dir"],
      [2355, "    mov byte [es:di], 0xE5"],
      [3524, "    call flush_dir_slot"],
      [3527, "    call fat_free_chain"],
      [3528, "    call flush_fat"],
      [4670, ".rename_file:"],
      [4681, "    call parse_root_path"],
      [4687, "    call find_in_dir"],
      [4693, "    call entry_has_open_handle"],
      [4707, "    cmp ax, [cs:rn_dir_cluster]"],
      [4721, "    mov si, name_buf"],
      [4726, "    call flush_dir_slot"],
      [4792, ".commit_file:"],
      [4822, "    call flush_handle_dir_entry"],
      [4824, "    call flush_fat"],
    ],
