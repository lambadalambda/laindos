...
const FS_SECTIONS = [
  {
    ...
    code: [
      ...
      [592, "    test al, al"],
      [596, "    test al, ah"],
      [598, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [600, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [604, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [630, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [633, "    mov [cs:kfat_start], ax"],
      [643, "    mov [cs:krsta], ax"],
      [663, "    mov [cs:krsc], ax"],
      [666, "    mov [cs:kdsta], ax"],
      [681, "    sub ax, [cs:kdsta]"],
      [687, "    div cx"],
      [691, "    mov [cs:kmax_cluster], ax"],
      [693, "    mov byte [cs:kfat_bits], 12"],
      [697, "    cmp ax, 4087"],
      [699, "    mov byte [cs:kfat_bits], 16"],
    ],
