...
const FS_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [3452, "    call flush_fat"],
      [4453, ".rename_file:"],
      [4464, "    call parse_root_path"],
      [4470, "    call find_in_dir"],
      [4476, "    call entry_has_open_handle"],
      [4490, "    cmp ax, [cs:rn_dir_cluster]"],
      [4395, "    mov si, name_buf"],
      [4509, "    call flush_dir_slot"],
      [4575, ".commit_file:"],
      [4557, "    call flush_handle_dir_entry"],
      [4607, "    call flush_fat"],
    ],
