...
const FS_SECTIONS = [
  {
    ...
    file: "src/kernel.asm",
    code: [
      [478, "    mov al, [bx+BPB_SECS_PER_CLUS]"],
      [479, "    test al, al"],
      [483, "    test al, ah"],
      [485, "    cmp word [bx+BPB_RSV_SEC_COUNT], 0"],
      [487, "    cmp byte [bx+BPB_NUM_FATS], 0"],
      [491, "    mov ax, [bx+BPB_ROOT_ENT_COUNT]"],
      [517, "    mov byte [cs:kfat_bits], 12"],
      [521, "    cmp byte [bx+BPB_FS_TYPE+4], '6'"],
      [523, "    mov byte [cs:kfat_bits], 16"],
      [528, "    mov ax, [bx+BPB_SECS_PER_FAT]"],
      [531, "    mov [cs:kfat_start], ax"],
      [541, "    mov [cs:krsta], ax"],
      [561, "    mov [cs:krsc], ax"],
      [564, "    mov [cs:kdsta], ax"],
      [579, "    sub ax, [cs:kdsta]"],
      [585, "    div cx"],
      [589, "    mov [cs:kmax_cluster], ax"],
    ],
