...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1696, "init_environment:"],
      [1705, "    call alloc_exec_environment"],
      [1713, "    call write_environment_vars"],
      [1714, "    mov ax, 1"],
      [1715, "    stosw"],
      [1722, "    mov si, fname_exe"],
      ["", "; ..."],
      [1756, "write_environment_vars:"],
      [1762, "    mov si, env_comspec_name"],
      [1767, "    mov si, env_path_name"],
      [1775, "    mov si, env_blaster"],
      [1777, "    mov si, env_prompt"],
      [1779, "    xor al, al"],
      [1802, "env_copy_drive_root:"],
      [1716, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3403, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3404, "env_path_name: db \"PATH=\", 0"],
      [3405, "env_shell_name: db \"SHELL.COM\", 0"],
      [3406, "env_bin_dir: db \"BIN\", 0"],
      [3407, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3408, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1696, 1705, 1705, 1756, 1756, 1762, 1762, 1696, 3403, 3403],
