...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1487, "init_environment:"],
      [1496, "    call alloc_exec_environment"],
      [1504, "    call write_environment_vars"],
      [1505, "    mov ax, 1"],
      [1506, "    stosw"],
      [1513, "    mov si, fname_exe"],
      ["", "; ..."],
      [1547, "write_environment_vars:"],
      [1553, "    mov si, env_comspec_name"],
      [1558, "    mov si, env_path_name"],
      [1566, "    mov si, env_blaster"],
      [1568, "    mov si, env_prompt"],
      [1570, "    xor al, al"],
      [1593, "env_copy_drive_root:"],
      [1594, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3121, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3122, "env_path_name: db \"PATH=\", 0"],
      [3123, "env_shell_name: db \"SHELL.COM\", 0"],
      [3124, "env_bin_dir: db \"BIN\", 0"],
      [3125, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3126, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
