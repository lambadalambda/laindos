...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [233, "do_dir:"],
      [234, "    call parse_dir_args"],
      [244, "    call print_dir_header"],
      [248, "    mov dx, dir_pattern"],
      [249, "    mov cx, ATTR_DIR"],
      [250, "    mov ah, 0x4E"],
      [256, "    call print_dir_entry"],
      [259, "    call print_dir_wide_entry"],
      [265, "    call finish_dir_wide_row"],
      [266, "    call print_dir_summary"],
      [1056, "do_copy:"],
      [1057, "    call parse_copy_args"],
      [1079, "    mov ah, 0x4E"],
      [1105, "copy_one_file:"],
      [1110, "    mov ah, 0x3D"],
      [1118, "    mov ah, 0x3C"],
      ...
      ["", "; ..."],
      [1456, "do_del:"],
      [1460, "    call del_path_has_wildcard"],
      [1465, "    mov ah, 0x41"],
      [1524, "confirm_del_prompt:"],
      [1533, "    mov ah, 0x08"],
      [1549, "del_path_has_wildcard:"],
      [1558, "    cmp al, '*'"],
      ["", "; ..."],
      [1570, "do_ren:"],
      [1575, "    call ren_paths_have_wildcard"],
      [1577, "    call ren_dst_has_path"],
      [1583, "    mov ah, 0x56"],
      [1645, "ren_dst_has_path:"],
      [1651, "    cmp al, ':'"],
      ["", "; ..."],
      [1739, "do_goto:"],
      [1743, "    call batch_seek_label"],
      [1747, "do_if:"],
      [1749, "    mov di, exist_arg"],
      [1778, "    mov ax, 0x4300"],
      [1782, "    call if_tail_is_bare_label"],
      [1791, "    call execute_line"],
      [1794, "    call batch_seek_label"],
      [1831, "batch_seek_label:"],
      [1851, "    call batch_read_line"],
      [1859, "    call batch_label_match"],
      ["", "; ..."],
      [1948, "do_pause:"],
      [1952, "    mov dx, pause_msg"],
      [1954, "    call wait_key"],
      [1961, "do_mode:"],
      [1965, "    mov ax, 0x0003"],
      [1975, "do_more:"],
      [1981, "    call more_display_file"],
      [2069, "parse_more_args:"],
      [2089, "    cmp al, '<'"],
      [2102, "    mov di, nul_arg"],
      ["", "; ..."],
      [2350, "change_drive_command:"],
      [2354, "    mov al, [si]"],
      [2378, "    mov dl, al"],
      [2380, "    mov ah, 0x0E"],
      [2399, "print_prompt:"],
      [2403, "    mov ah, 0x47"],
      [2411, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3187, "command_table:"],
      [3190, "    dw dir_cmd, do_dir"],
      [3191, "    dw cd_cmd, do_cd"],
      [3198, "    dw copy_cmd, do_copy"],
      [3199, "    dw del_cmd, do_del"],
      [3201, "    dw ren_cmd, do_ren"],
      [3207, "    dw if_cmd, do_if"],
      [3208, "    dw goto_cmd, do_goto"],
      [3209, "    dw pause_cmd, do_pause"],
      [3211, "    dw mode_cmd, do_mode"],
      [3212, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2487, "prepare_command:"],
      [2490, "    mov byte [command_has_ext], 0"],
      [2493, "    mov byte [tail_has_args], 0"],
      [2503, "    cmp al, '.'"],
      [2517, "    mov byte [command_has_path], 1"],
      [2530, "    mov al, '.'"],
      [2533, "    mov al, 'C'"],
      [2535, "    mov al, 'O'"],
      [2537, "    mov al, 'M'"],
      [2542, "    call build_cmd_tail"],
      ["", "; ..."],
      [2574, "run_command:"],
      [2577, "    call run_current_command"],
      [2585, "    call run_current_command"],
      [2593, "    call run_batch"],
      [2599, "    call run_path_exec"],
      [2599, "    call run_path_exec"],
      [2611, "    call run_path_batch"],
      [2615, "    call command_ext_is_bat"],
      [2634, "    mov ah, 0x4D"],
      [2635, "    int 0x21"],
      [2646, "command_ext_is_bat:"],
      [2651, "    and al, 0xDF"],
      [2651, "    and al, 0xDF"],
      [2674, "run_current_command:"],
      [2689, "    mov ax, 0x4B00"],
      [2690, "    int 0x21"],
      [2699, "run_autoexec:"],
      [2702, "    mov dx, autoexec_name"],
      [2703, "    call run_batch_named"],
      [2714, "run_batch_named:"],
      [2717, "    call batch_sync_position"],
      [2720, "    inc byte [batch_active]"],
      [2721, "    push word [batch_handle]"],
      [2723, "    mov ah, 0x3D"],
      [2727, "    mov word [batch_buf_pos], 0"],
      [2732, "    call batch_read_line"],
      [2736, "    call execute_line"],
      [2744, "    pop word [batch_handle]"],
      [2747, "    dec byte [batch_active]"],
      ["", "; ..."],
      [2961, "batch_read_line:"],
      [2965, "    call batch_read_char"],
      [2976, "    cmp cx, 127"],
      [2981, "    call batch_read_char"],
      [2989, "    xor al, al"],
      [3001, "batch_read_char:"],
      [3005, "    mov bx, [batch_buf_pos]"],
      [3011, "    mov ah, 0x3F"],
      [3012, "    int 0x21"],
      [3019, ".have_char:"],
      [3034, "batch_sync_position:"],
      [3046, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2761, "run_path_exec:"],
      [2765, "run_path_batch:"],
      [2768, "run_path_command:"],
      [2769, "    cmp byte [command_has_path], 0"],
      [2771, "    call find_path_value"],
      [2774, "    call build_path_candidate"],
      [2778, "    call run_candidate_exec"],
      [2781, "    call run_batch_path"],
      ["", "; ..."],
      [2799, "find_path_value:"],
      [2812, "    mov ah, 0x62"],
      [2816, "    mov ax, [es:0x2C]"],
      [2826, "    mov si, path_env_name"],
      [2844, ".found:"],
      [2846, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [2863, "build_path_candidate:"],
      [2888, "    cmp al, ';'"],
      [2923, "    mov al, '\\'"],
      [2927, "    mov si, command_name"],
      [2941, "    clc"],
    ],
