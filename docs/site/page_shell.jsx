...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1642, "init_environment:"],
      [1651, "    call alloc_exec_environment"],
      [1659, "    call write_environment_vars"],
      [1660, "    mov ax, 1"],
      [1661, "    stosw"],
      [1668, "    mov si, fname_exe"],
      ["", "; ..."],
      [1702, "write_environment_vars:"],
      [1708, "    mov si, env_comspec_name"],
      [1713, "    mov si, env_path_name"],
      [1721, "    mov si, env_blaster"],
      [1723, "    mov si, env_prompt"],
      [1725, "    xor al, al"],
      [1748, "env_copy_drive_root:"],
      [1662, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3247, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3248, "env_path_name: db \"PATH=\", 0"],
      [3249, "env_shell_name: db \"SHELL.COM\", 0"],
      [3250, "env_bin_dir: db \"BIN\", 0"],
      [3251, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3252, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1642, 1651, 1659, 1702, 1708, 1713, 1721, 1642, 3247, 3248],
