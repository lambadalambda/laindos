...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1473, "init_environment:"],
      [1480, "    call alloc_exec_environment"],
      [1487, "    call write_environment_vars"],
      [1488, "    mov ax, 1"],
      [1489, "    stosw"],
      [1496, "    mov si, fname_exe"],
      ["", "; ..."],
      [1530, "write_environment_vars:"],
      [1536, "    mov si, env_comspec_name"],
      [1541, "    mov si, env_path_name"],
      [1549, "    mov si, env_blaster"],
      [1551, "    mov si, env_prompt"],
      [1553, "    xor al, al"],
      [1576, "env_copy_drive_root:"],
      [1577, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [2995, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2996, "env_path_name: db \"PATH=\", 0"],
      [2997, "env_shell_name: db \"SHELL.COM\", 0"],
      [2998, "env_bin_dir: db \"BIN\", 0"],
      [2999, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3000, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
