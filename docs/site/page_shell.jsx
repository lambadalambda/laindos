...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1301, "init_environment:"],
      [1308, "    call alloc_exec_environment"],
      [1315, "    call write_environment_vars"],
      [1316, "    mov ax, 1"],
      [1317, "    stosw"],
      [1324, "    mov si, fname_exe"],
      ["", "; ..."],
      [1358, "write_environment_vars:"],
      [1364, "    mov si, env_comspec_name"],
      [1369, "    mov si, env_path_name"],
      [1377, "    mov si, env_blaster"],
      [1379, "    mov si, env_prompt"],
      [1381, "    xor al, al"],
      [1404, "env_copy_drive_root:"],
      [1405, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [2752, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2753, "env_path_name: db \"PATH=\", 0"],
      [2754, "env_shell_name: db \"SHELL.COM\", 0"],
      [2755, "env_bin_dir: db \"BIN\", 0"],
      [2756, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [2757, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1301, 1308, 1315, 1358, 1364, 1369, 1377, 1379, 2752, 2753],
