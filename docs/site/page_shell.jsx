...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1654, "init_environment:"],
      [1663, "    call alloc_exec_environment"],
      [1671, "    call write_environment_vars"],
      [1672, "    mov ax, 1"],
      [1673, "    stosw"],
      [1680, "    mov si, fname_exe"],
      ["", "; ..."],
      [1714, "write_environment_vars:"],
      [1720, "    mov si, env_comspec_name"],
      [1725, "    mov si, env_path_name"],
      [1733, "    mov si, env_blaster"],
      [1735, "    mov si, env_prompt"],
      [1737, "    xor al, al"],
      [1760, "env_copy_drive_root:"],
      [1674, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3261, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3262, "env_path_name: db \"PATH=\", 0"],
      [3263, "env_shell_name: db \"SHELL.COM\", 0"],
      [3264, "env_bin_dir: db \"BIN\", 0"],
      [3265, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3266, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1654, 1663, 1663, 1714, 1720, 1725, 1725, 1654, 3261, 3262],
