...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1345, "init_environment:"],
      [1352, "    call alloc_exec_environment"],
      [1359, "    call write_environment_vars"],
      [1360, "    mov ax, 1"],
      [1361, "    stosw"],
      [1368, "    mov si, fname_exe"],
      ["", "; ..."],
      [1402, "write_environment_vars:"],
      [1408, "    mov si, env_comspec_name"],
      [1413, "    mov si, env_path_name"],
      [1421, "    mov si, env_blaster"],
      [1423, "    mov si, env_prompt"],
      [1425, "    xor al, al"],
      [1448, "env_copy_drive_root:"],
      [1449, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [2796, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2797, "env_path_name: db \"PATH=\", 0"],
      [2798, "env_shell_name: db \"SHELL.COM\", 0"],
      [2799, "env_bin_dir: db \"BIN\", 0"],
      [2800, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [2801, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
