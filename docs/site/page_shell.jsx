...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1650, "init_environment:"],
      [1659, "    call alloc_exec_environment"],
      [1667, "    call write_environment_vars"],
      [1668, "    mov ax, 1"],
      [1669, "    stosw"],
      [1676, "    mov si, fname_exe"],
      ["", "; ..."],
      [1710, "write_environment_vars:"],
      [1716, "    mov si, env_comspec_name"],
      [1721, "    mov si, env_path_name"],
      [1729, "    mov si, env_blaster"],
      [1731, "    mov si, env_prompt"],
      [1733, "    xor al, al"],
      [1756, "env_copy_drive_root:"],
      [1670, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3257, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3258, "env_path_name: db \"PATH=\", 0"],
      [3259, "env_shell_name: db \"SHELL.COM\", 0"],
      [3260, "env_bin_dir: db \"BIN\", 0"],
      [3261, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3262, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1650, 1659, 1659, 1710, 1716, 1721, 1721, 1650, 3257, 3258],
