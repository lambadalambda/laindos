...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1784, "do_if:"],
      [1800, "    mov di, exist_arg"],
      [1835, "    mov ax, 0x4300"],
      [1945, "    call if_tail_is_bare_label"],
      [1954, "    call execute_line"],
      [1957, "    call batch_seek_label"],
      [1998, "batch_seek_label:"],
      [2018, "    call batch_read_line"],
      [2026, "    call batch_label_match"],
      ["", "; ..."],
      [2115, "do_pause:"],
      [2119, "    mov dx, pause_msg"],
      [2121, "    call wait_key"],
      [2128, "do_mode:"],
      [2132, "    mov ax, 0x0003"],
      [2142, "do_more:"],
      [2148, "    call more_display_file"],
      [2236, "parse_more_args:"],
      [2256, "    cmp al, '<'"],
      [2269, "    mov di, nul_arg"],
      ["", "; ..."],
      [2517, "change_drive_command:"],
      [2521, "    mov al, [si]"],
      [2545, "    mov dl, al"],
      [2547, "    mov ah, 0x0E"],
      [2566, "print_prompt:"],
      [2570, "    mov ah, 0x47"],
      [2578, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3495, "command_table:"],
      [3498, "    dw dir_cmd, do_dir"],
      [3499, "    dw cd_cmd, do_cd"],
      [3506, "    dw copy_cmd, do_copy"],
      [3507, "    dw del_cmd, do_del"],
      [3509, "    dw ren_cmd, do_ren"],
      [3515, "    dw if_cmd, do_if"],
      [3516, "    dw goto_cmd, do_goto"],
      [3517, "    dw pause_cmd, do_pause"],
      [3519, "    dw mode_cmd, do_mode"],
      [3520, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2654, "prepare_command:"],
      [2657, "    mov byte [command_has_ext], 0"],
      [2661, "    mov byte [tail_has_args], 0"],
      [2673, "    cmp al, '.'"],
      [2687, "    mov byte [command_has_path], 1"],
      [2708, "    mov al, '.'"],
      [2711, "    mov al, 'C'"],
      [2713, "    mov al, 'O'"],
      [2715, "    mov al, 'M'"],
      [2720, "    call build_cmd_tail"],
      ["", "; ..."],
      [2752, "run_command:"],
      [2757, "    call run_current_command"],
      [2765, "    call run_current_command"],
      [2773, "    call run_batch"],
      [2779, "    call run_path_exec"],
      [2779, "    call run_path_exec"],
      [2791, "    call run_path_batch"],
      [2795, "    call command_ext_is_bat"],
      [2814, "    mov ah, 0x4D"],
      [2815, "    int 0x21"],
      [2827, "command_ext_is_bat:"],
      [2832, "    and al, 0xDF"],
      [2832, "    and al, 0xDF"],
      [2855, "run_current_command:"],
      [2870, "    mov ax, 0x4B00"],
      [2871, "    int 0x21"],
      [2880, "run_autoexec:"],
      [2884, "    mov dx, autoexec_name"],
      [2885, "    call run_batch_named"],
      [2896, "run_batch_named:"],
      [2899, "    call batch_sync_position"],
      [2903, "    inc byte [batch_active]"],
      [2904, "    push word [batch_handle]"],
      [2906, "    mov ah, 0x3D"],
      [2910, "    mov word [batch_buf_pos], 0"],
      [2915, "    call batch_read_line"],
      [2920, "    call execute_line"],
      [2928, "    pop word [batch_handle]"],
      [2931, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3269, "batch_read_line:"],
      [3273, "    call batch_read_char"],
      [3284, "    cmp cx, 127"],
      [3289, "    call batch_read_char"],
      [3297, "    xor al, al"],
      [3309, "batch_read_char:"],
      [3313, "    mov bx, [batch_buf_pos]"],
      [3319, "    mov ah, 0x3F"],
      [3320, "    int 0x21"],
      [3327, ".have_char:"],
      [3342, "batch_sync_position:"],
      [3354, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2945, "run_path_exec:"],
      [2949, "run_path_batch:"],
      [2952, "run_path_command:"],
      [2953, "    cmp byte [command_has_path], 0"],
      [2955, "    call find_path_value"],
      [2958, "    call build_path_candidate"],
      [2962, "    call run_candidate_exec"],
      [2965, "    call run_batch_path"],
      ["", "; ..."],
      [2983, "find_path_value:"],
      [2996, "    mov ah, 0x62"],
      [3000, "    mov ax, [es:0x2C]"],
      [3010, "    mov si, path_env_name"],
      [3028, ".found:"],
      [3030, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [3047, "build_path_candidate:"],
      [3072, "    cmp al, ';'"],
      [3107, "    mov al, '\\'"],
      [3111, "    mov si, command_name"],
      [3125, "    clc"],
    ],
