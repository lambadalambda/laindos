...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [2242, "    mov di, nul_arg"],
      ["", "; ..."],
      [2490, "change_drive_command:"],
      [2494, "    mov al, [si]"],
      [2518, "    mov dl, al"],
      [2520, "    mov ah, 0x0E"],
      [2539, "print_prompt:"],
      [2543, "    mov ah, 0x47"],
      [2551, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3479, "command_table:"],
      [3482, "    dw dir_cmd, do_dir"],
      [3483, "    dw cd_cmd, do_cd"],
      [3490, "    dw copy_cmd, do_copy"],
      [3491, "    dw del_cmd, do_del"],
      [3493, "    dw ren_cmd, do_ren"],
      [3499, "    dw if_cmd, do_if"],
      [3500, "    dw goto_cmd, do_goto"],
      [3501, "    dw pause_cmd, do_pause"],
      [3503, "    dw mode_cmd, do_mode"],
      [3504, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2627, "prepare_command:"],
      [2630, "    mov byte [command_has_ext], 0"],
      [2634, "    mov byte [tail_has_args], 0"],
      [2648, "    cmp al, '.'"],
      [2662, "    mov byte [command_has_path], 1"],
      [2685, "    mov al, '.'"],
      [2688, "    mov al, 'C'"],
      [2690, "    mov al, 'O'"],
      [2692, "    mov al, 'M'"],
      [2697, "    call build_cmd_tail"],
      ["", "; ..."],
      [2729, "run_command:"],
      [2734, "    call run_current_command"],
      [2742, "    call run_current_command"],
      [2750, "    call run_batch"],
      [2756, "    call run_path_exec"],
      [2756, "    call run_path_exec"],
      [2768, "    call run_path_batch"],
      [2772, "    call command_ext_is_bat"],
      [2791, "    mov ah, 0x4D"],
      [2792, "    int 0x21"],
      [2804, "command_ext_is_bat:"],
      [2809, "    and al, 0xDF"],
      [2809, "    and al, 0xDF"],
      [2832, "run_current_command:"],
      [2847, "    mov ax, 0x4B00"],
      [2848, "    int 0x21"],
      [2857, "run_autoexec:"],
      [2861, "    mov dx, autoexec_name"],
      [2862, "    call run_batch_named"],
      [2873, "run_batch_named:"],
      [2876, "    call batch_sync_position"],
      [2880, "    inc byte [batch_active]"],
      [2881, "    push word [batch_handle]"],
      [2883, "    mov ah, 0x3D"],
      [2887, "    mov word [batch_buf_pos], 0"],
      [2892, "    call batch_read_line"],
      [2897, "    call execute_line"],
      [2905, "    pop word [batch_handle]"],
      [2908, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3246, "batch_read_line:"],
      [3250, "    call batch_read_char"],
      [3261, "    cmp cx, 127"],
      [3266, "    call batch_read_char"],
      [3274, "    xor al, al"],
      [3286, "batch_read_char:"],
      [3290, "    mov bx, [batch_buf_pos]"],
      [3296, "    mov ah, 0x3F"],
      [3297, "    int 0x21"],
      [3304, ".have_char:"],
      [3319, "batch_sync_position:"],
      [3331, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2922, "run_path_exec:"],
      [2926, "run_path_batch:"],
      [2929, "run_path_command:"],
      [2930, "    cmp byte [command_has_path], 0"],
      [2932, "    call find_path_value"],
      [2935, "    call build_path_candidate"],
      [2939, "    call run_candidate_exec"],
      [2942, "    call run_batch_path"],
      ["", "; ..."],
      [2960, "find_path_value:"],
      [2973, "    mov ah, 0x62"],
      [2977, "    mov ax, [es:0x2C]"],
      [2987, "    mov si, path_env_name"],
      [3005, ".found:"],
      [3007, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [3024, "build_path_candidate:"],
      [3049, "    cmp al, ';'"],
      [3084, "    mov al, '\\'"],
      [3088, "    mov si, command_name"],
      [3102, "    clc"],
    ],
