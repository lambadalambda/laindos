...
const SHELL_UNSUPPORTED = [
  "No full COMMAND.COM compatibility: no SET command, prompt expansion, user-defined aliases, pipes, redirection, COPY, DEL, REN, or wildcard argument expansion.",
...
const SHELL_TESTS = [
  ["Interactive shell", "scripts/test_shell.py", "Drives VER, CLS, DIR path/pattern, DIR /P, DIR /W, TYPE, ECHO, REM, COM/EXE/BAT launch, directories, and error paths."],
...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [869, "    mov ah, 0x3B"],
      ["", "; ..."],
      [1020, "change_drive_command:"],
      [1042, "    mov dl, al"],
      [1044, "    mov ah, 0x0E"],
      [1064, "print_prompt:"],
      [1068, "    mov ah, 0x47"],
      [1076, "    mov dx, prompt_end"],
      ["", "; ..."],
      [1703, "command_table:"],
      [1704, "    dw exit_cmd, exit_shell"],
      [1706, "    dw dir_cmd, do_dir"],
      [1707, "    dw cd_cmd, do_cd"],
      [1708, "    dw cd_parent_cmd, do_cd_parent"],
      [1709, "    dw cd_root_cmd, do_cd_root"],
      [1710, "    dw chdir_cmd, do_cd"],
      [1711, "    dw md_cmd, do_md"],
      [1712, "    dw mkdir_cmd, do_md"],
      [1713, "    dw rd_cmd, do_rd"],
      [1714, "    dw rmdir_cmd, do_rd"],
      [1715, "    dw type_cmd, do_type"],
      [1717, "    dw echo_cmd, do_echo"],
      [1718, "    dw rem_cmd, do_rem"],
    ],
    hi: [78, 95, 101, 104, 110, 111, 1020, 1044, 1064, 1068, 1703, 1708, 1710, 1712, 1714],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [1125, "prepare_command:"],
      [1128, "    mov byte [command_has_ext], 0"],
      [1166, "    cmp byte [command_has_ext], 0"],
      [1168, "    mov al, '.'"],
      [1171, "    mov al, 'C'"],
      [1173, "    mov al, 'O'"],
      [1175, "    mov al, 'M'"],
      [1180, "    call build_cmd_tail"],
      ["", "; ..."],
      [1212, "run_command:"],
      [1215, "    call run_current_command"],
      [1223, "    call run_current_command"],
      [1231, "    call run_batch"],
      [1237, "    call run_path_exec"],
      [1249, "    call run_path_batch"],
      [1272, "    mov ah, 0x4D"],
      [1273, "    int 0x21"],
      [1304, "run_current_command:"],
      [1319, "    mov ax, 0x4B00"],
      [1320, "    int 0x21"],
    ],
    hi: [1125, 1180, 1212, 1215, 1231, 1237, 1249, 1272, 1319],
  ...
  },
  {
    ...
    code: [
      [1329, "run_autoexec:"],
      [1332, "    mov dx, autoexec_name"],
      [1333, "    call run_batch_named"],
      ["", "; ..."],
      [1344, "run_batch_named:"],
      [1345, "    cmp byte [batch_active], 0"],
      [1347, "    mov byte [batch_active], 1"],
      [1349, "    mov ah, 0x3D"],
      [1358, "    mov ah, 0x3F"],
      [1370, "    mov si, batch_buf"],
      [1372, "    call batch_read_line"],
      [1378, "    call execute_line"],
      [1384, "    mov byte [batch_active], 0"],
      ["", "; ..."],
      [1575, "batch_read_line:"],
      [1597, "    cmp cx, 63"],
      [1599, "    stosb"],
      [1607, ".eof:"],
      [1608, "    stc"],
    ],
    hi: [1329, 1333, 1344, 1345, 1372, 1378, 1575, 1597],
  ...
  },
  {
    ...
    code: [
      [1397, "run_path_exec:"],
      [1401, "run_path_batch:"],
      [1404, "run_path_command:"],
      [1405, "    cmp byte [command_has_path], 0"],
      [1407, "    call find_path_value"],
      [1410, "    call build_path_candidate"],
      [1414, "    call run_candidate_exec"],
      [1417, "    call run_batch_path"],
      ["", "; ..."],
      [1437, "find_path_value:"],
      [1444, "    mov ah, 0x62"],
      [1450, "    mov ax, [es:0x2C]"],
      [1458, "    mov si, path_env_name"],
      [1478, ".found:"],
      [1480, "    mov [path_env_seg], ax"],
      ["", "; ..."],
      [1500, "build_path_candidate:"],
      [1520, "    cmp al, ';'"],
      [1547, "    mov al, '\\'"],
      [1554, "    mov si, command_name"],
      [1562, "    clc"],
    ],
    hi: [1404, 1405, 1407, 1410, 1444, 1450, 1458, 1500, 1520, 1547],
