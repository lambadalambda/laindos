...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [1477, "do_del:"],
      [1481, "    call del_path_has_wildcard"],
      [1524, "    mov ah, 0x41"],
      [1576, "confirm_del_prompt:"],
      [1367, "    mov ah, 0x08"],
      ...
      [1620, "    mov ah, 0x56"],
      [1684, "ren_dst_has_path:"],
      [1690, "    cmp al, ':'"],
      ["", "; ..."],
      [1778, "do_goto:"],
      [1782, "    call batch_seek_label"],
      [1786, "do_if:"],
      [1802, "    mov di, exist_arg"],
      [1837, "    mov ax, 0x4300"],
      [1947, "    mov di, line_buf"],
      [1954, "    call execute_line"],
      [1782, "    call batch_seek_label"],
      [1963, "batch_seek_label:"],
      [1983, "    call batch_read_line"],
      [1991, "    call batch_label_match"],
      ["", "; ..."],
      [2092, "do_pause:"],
      [2096, "    mov dx, pause_msg"],
      [2098, "    call wait_key"],
      [2105, "do_mode:"],
      [2109, "    mov ax, 0x0003"],
      [2119, "do_more:"],
      [2125, "    call more_display_file"],
      [2219, "parse_more_args:"],
      [2239, "    cmp al, '<'"],
      [2142, "    mov di, nul_arg"],
      ["", "; ..."],
      [2502, "change_drive_command:"],
      [2506, "    mov al, [si]"],
      [2530, "    mov dl, al"],
      [2532, "    mov ah, 0x0E"],
      [2551, "print_prompt:"],
      [2555, "    mov ah, 0x47"],
      [2563, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3472, "command_table:"],
      [3475, "    dw dir_cmd, do_dir"],
      [3476, "    dw cd_cmd, do_cd"],
      [3483, "    dw copy_cmd, do_copy"],
      [3484, "    dw del_cmd, do_del"],
      [3486, "    dw ren_cmd, do_ren"],
      [3492, "    dw if_cmd, do_if"],
      [3493, "    dw goto_cmd, do_goto"],
      [3494, "    dw pause_cmd, do_pause"],
      [3496, "    dw mode_cmd, do_mode"],
      [3497, "    dw more_cmd, do_more"],
    ],
    hi: [238, 255, 261, 264, 270, 271, 1041, 1111, 1119, 1127, 1136, 1149, 1477, 1481, 1524, 1576, 1586, 1607, 1612, 1614, 1620, 1684, 1778, 1786, 1837, 1954, 1782, 2092, 2105, 2119, 2219, 2502, 2532, 2551, 2555, 3472, 3492, 3493, 3494, 3496, 3497],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2635, "prepare_command:"],
      [2638, "    mov byte [command_has_ext], 0"],
      [2642, "    mov byte [tail_has_args], 0"],
      [2656, "    cmp al, '.'"],
      [2670, "    mov byte [command_has_path], 1"],
      [2693, "    mov al, '.'"],
      [2696, "    mov al, 'C'"],
      [2698, "    mov al, 'O'"],
      [2700, "    mov al, 'M'"],
      [2705, "    call build_cmd_tail"],
      ["", "; ..."],
      [2737, "run_command:"],
      [2742, "    call run_current_command"],
      [2750, "    call run_current_command"],
      [2758, "    call run_batch"],
      [2764, "    call run_path_exec"],
      [2764, "    call run_path_exec"],
      [2776, "    call run_path_batch"],
      [2780, "    call command_ext_is_bat"],
      [2799, "    mov ah, 0x4D"],
      [2800, "    int 0x21"],
      [2812, "command_ext_is_bat:"],
      [2817, "    and al, 0xDF"],
      [2817, "    and al, 0xDF"],
      [2840, "run_current_command:"],
      [2855, "    mov ax, 0x4B00"],
      [2856, "    int 0x21"],
      [2865, "run_autoexec:"],
      [2869, "    mov dx, autoexec_name"],
      [2870, "    call run_batch_named"],
      [2881, "run_batch_named:"],
      [2884, "    call batch_sync_position"],
      [2888, "    inc byte [batch_active]"],
      [2889, "    push word [batch_handle]"],
      [2891, "    mov ah, 0x3D"],
      [2895, "    mov word [batch_buf_pos], 0"],
      [2900, "    call batch_read_line"],
      [2905, "    call execute_line"],
      [2913, "    pop word [batch_handle]"],
      [2916, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3254, "batch_read_line:"],
      [3258, "    call batch_read_char"],
      [3269, "    cmp cx, 127"],
      [3274, "    call batch_read_char"],
      [3282, "    xor al, al"],
      [3294, "batch_read_char:"],
      [3298, "    mov bx, [batch_buf_pos]"],
      [3304, "    mov ah, 0x3F"],
      [3305, "    int 0x21"],
      [3312, ".have_char:"],
      [3327, "batch_sync_position:"],
      [3339, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2930, "run_path_exec:"],
      [2934, "run_path_batch:"],
      [2937, "run_path_command:"],
      [2938, "    cmp byte [command_has_path], 0"],
      [2940, "    call find_path_value"],
      [2943, "    call build_path_candidate"],
      [2947, "    call run_candidate_exec"],
      [2950, "    call run_batch_path"],
      ["", "; ..."],
      [2968, "find_path_value:"],
      [2981, "    mov ah, 0x62"],
      [2985, "    mov ax, [es:0x2C]"],
      [2995, "    mov si, path_env_name"],
      [3013, ".found:"],
      [3015, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [3032, "build_path_candidate:"],
      [3057, "    cmp al, ';'"],
      [3092, "    mov al, '\\'"],
      [3096, "    mov si, command_name"],
      [3110, "    clc"],
    ],
    hi: [2635, 2693, 2705, 2737, 2758, 2776, 2780, 2799, 2812, 2881, 2884, 2888, 2889, 2900, 2905, 2913, 2916, 3254, 2750, 3294, 3327, 2930, 2934, 2937, 2947, 2950, 2968, 3032],
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1430, "init_environment:"],
      [1439, "    call alloc_exec_environment"],
      [1447, "    call write_environment_vars"],
      [1448, "    mov ax, 1"],
      [1449, "    stosw"],
      [1456, "    mov si, fname_exe"],
      ["", "; ..."],
      [1490, "write_environment_vars:"],
      [1496, "    mov si, env_comspec_name"],
      [1501, "    mov si, env_path_name"],
      [1509, "    mov si, env_blaster"],
      [1511, "    mov si, env_prompt"],
      [1513, "    xor al, al"],
      [1536, "env_copy_drive_root:"],
      [1537, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
    ...
    hi: [1430, 1439, 1447, 1490, 1496, 1501, 1509, 1511, 3035, 3036],
