...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1561, "init_environment:"],
      [1570, "    call alloc_exec_environment"],
      [1578, "    call write_environment_vars"],
      [1579, "    mov ax, 1"],
      [1580, "    stosw"],
      [1587, "    mov si, fname_exe"],
      ["", "; ..."],
      [1621, "write_environment_vars:"],
      [1627, "    mov si, env_comspec_name"],
      [1632, "    mov si, env_path_name"],
      [1640, "    mov si, env_blaster"],
      [1642, "    mov si, env_prompt"],
      [1644, "    xor al, al"],
      [1667, "env_copy_drive_root:"],
      [1581, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3166, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3167, "env_path_name: db \"PATH=\", 0"],
      [3168, "env_shell_name: db \"SHELL.COM\", 0"],
      [3169, "env_bin_dir: db \"BIN\", 0"],
      [3170, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3171, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1561, 1570, 1578, 1621, 1627, 1632, 1640, 1642, 3166, 3167],
