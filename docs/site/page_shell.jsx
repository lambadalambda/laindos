...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1485, "init_environment:"],
      [1494, "    call alloc_exec_environment"],
      [1502, "    call write_environment_vars"],
      [1503, "    mov ax, 1"],
      [1504, "    stosw"],
      [1511, "    mov si, fname_exe"],
      ["", "; ..."],
      [1545, "write_environment_vars:"],
      [1551, "    mov si, env_comspec_name"],
      [1556, "    mov si, env_path_name"],
      [1564, "    mov si, env_blaster"],
      [1566, "    mov si, env_prompt"],
      [1568, "    xor al, al"],
      [1591, "env_copy_drive_root:"],
      [1592, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
