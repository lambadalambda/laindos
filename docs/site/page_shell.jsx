...
const SHELL_UNSUPPORTED = [
  "No full COMMAND.COM compatibility: no SET command, prompt expansion, user-defined aliases, pipes, redirection, DEL, REN, or wildcard argument expansion.",
...
const SHELL_TESTS = [
  ["Interactive shell", "scripts/test_shell.py", "Drives VER, CLS, DIR path/pattern, DIR /P, DIR /W, COPY, TYPE, ECHO, REM, COM/EXE/BAT launch, directories, and error paths."],
...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1154, "    mov ah, 0x3B"],
      ["", "; ..."],
      [1305, "change_drive_command:"],
      [1327, "    mov dl, al"],
      [1329, "    mov ah, 0x0E"],
      [1349, "print_prompt:"],
      [1353, "    mov ah, 0x47"],
      [1361, "    mov dx, prompt_end"],
      ["", "; ..."],
      [1989, "command_table:"],
      [1990, "    dw exit_cmd, exit_shell"],
      [1992, "    dw dir_cmd, do_dir"],
      [1993, "    dw cd_cmd, do_cd"],
      [1994, "    dw cd_parent_cmd, do_cd_parent"],
      [1995, "    dw cd_root_cmd, do_cd_root"],
      [1996, "    dw chdir_cmd, do_cd"],
      [1997, "    dw md_cmd, do_md"],
      [1998, "    dw mkdir_cmd, do_md"],
      [1999, "    dw rd_cmd, do_rd"],
      [2000, "    dw rmdir_cmd, do_rd"],
      [2001, "    dw copy_cmd, do_copy"],
      [2002, "    dw type_cmd, do_type"],
      [2004, "    dw echo_cmd, do_echo"],
      [2005, "    dw rem_cmd, do_rem"],
    ],
    hi: [78, 95, 101, 104, 110, 111, 865, 873, 881, 889, 898, 911, 1305, 1329, 1349, 1353, 1989, 1994, 1996, 1998, 2000, 2001],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [1410, "prepare_command:"],
      [1413, "    mov byte [command_has_ext], 0"],
      [1451, "    cmp byte [command_has_ext], 0"],
      [1453, "    mov al, '.'"],
      [1456, "    mov al, 'C'"],
      [1458, "    mov al, 'O'"],
      [1460, "    mov al, 'M'"],
      [1465, "    call build_cmd_tail"],
      ["", "; ..."],
      [1497, "run_command:"],
      [1500, "    call run_current_command"],
      [1508, "    call run_current_command"],
      [1516, "    call run_batch"],
      [1522, "    call run_path_exec"],
      [1534, "    call run_path_batch"],
      [1557, "    mov ah, 0x4D"],
      [1558, "    int 0x21"],
      [1589, "run_current_command:"],
      [1604, "    mov ax, 0x4B00"],
      [1605, "    int 0x21"],
    ],
    hi: [1410, 1465, 1497, 1500, 1516, 1522, 1534, 1557, 1604],
  ...
  },
  {
    ...
    code: [
      [1614, "run_autoexec:"],
      [1617, "    mov dx, autoexec_name"],
      [1618, "    call run_batch_named"],
      ["", "; ..."],
      [1629, "run_batch_named:"],
      [1630, "    cmp byte [batch_active], 0"],
      [1632, "    mov byte [batch_active], 1"],
      [1634, "    mov ah, 0x3D"],
      [1643, "    mov ah, 0x3F"],
      [1655, "    mov si, batch_buf"],
      [1657, "    call batch_read_line"],
      [1663, "    call execute_line"],
      [1669, "    mov byte [batch_active], 0"],
      ["", "; ..."],
      [1860, "batch_read_line:"],
      [1882, "    cmp cx, 63"],
      [1884, "    stosb"],
      [1892, ".eof:"],
      [1893, "    stc"],
    ],
    hi: [1614, 1618, 1629, 1630, 1657, 1663, 1860, 1882],
  ...
  },
  {
    ...
    code: [
      [1682, "run_path_exec:"],
      [1686, "run_path_batch:"],
      [1689, "run_path_command:"],
      [1690, "    cmp byte [command_has_path], 0"],
      [1692, "    call find_path_value"],
      [1695, "    call build_path_candidate"],
      [1699, "    call run_candidate_exec"],
      [1702, "    call run_batch_path"],
      ["", "; ..."],
      [1722, "find_path_value:"],
      [1729, "    mov ah, 0x62"],
      [1735, "    mov ax, [es:0x2C]"],
      [1743, "    mov si, path_env_name"],
      [1763, ".found:"],
      [1765, "    mov [path_env_seg], ax"],
      ["", "; ..."],
      [1785, "build_path_candidate:"],
      [1805, "    cmp al, ';'"],
      [1832, "    mov al, '\\'"],
      [1839, "    mov si, command_name"],
      [1847, "    clc"],
    ],
    hi: [1689, 1690, 1692, 1695, 1729, 1735, 1743, 1785, 1805, 1832],
