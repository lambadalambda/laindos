...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      "The built-ins intentionally stay narrow. `DIR` lists the current directory with FindFirst/FindNext, formats entries like MS-DOS with fixed 8.3 columns, and supports `/P` pagination. `CD`, `MD`, `RD`, and their DOS aliases call the matching directory APIs. `TYPE` opens a file and copies it to handle 1.",
    ...
    code: [
      ...
      [537, "    mov ah, 0x3B"],
      ["", "; ..."],
      [688, "change_drive_command:"],
      [710, "    mov dl, al"],
      [712, "    mov ah, 0x0E"],
      [732, "print_prompt:"],
      [736, "    mov ah, 0x47"],
      [744, "    mov dx, prompt_end"],
      ["", "; ..."],
      [1371, "command_table:"],
      [1372, "    dw exit_cmd, exit_shell"],
      [1374, "    dw dir_cmd, do_dir"],
      [1375, "    dw cd_cmd, do_cd"],
      [1376, "    dw cd_parent_cmd, do_cd_parent"],
      [1377, "    dw cd_root_cmd, do_cd_root"],
      [1378, "    dw chdir_cmd, do_cd"],
      [1379, "    dw md_cmd, do_md"],
      [1380, "    dw mkdir_cmd, do_md"],
      [1381, "    dw rd_cmd, do_rd"],
      [1382, "    dw rmdir_cmd, do_rd"],
      [1383, "    dw type_cmd, do_type"],
      [1385, "    dw echo_cmd, do_echo"],
      [1386, "    dw rem_cmd, do_rem"],
    ],
    hi: [78, 94, 98, 103, 688, 712, 732, 736, 1371, 1376, 1378, 1380, 1382],
  ...
  },
  {
    ...
    code: [
      [793, "prepare_command:"],
      [796, "    mov byte [command_has_ext], 0"],
      [834, "    cmp byte [command_has_ext], 0"],
      [836, "    mov al, '.'"],
      [839, "    mov al, 'C'"],
      [841, "    mov al, 'O'"],
      [843, "    mov al, 'M'"],
      [848, "    call build_cmd_tail"],
      ["", "; ..."],
      [880, "run_command:"],
      [883, "    call run_current_command"],
      [891, "    call run_current_command"],
      [899, "    call run_batch"],
      [905, "    call run_path_exec"],
      [917, "    call run_path_batch"],
      [940, "    mov ah, 0x4D"],
      [941, "    int 0x21"],
      [972, "run_current_command:"],
      [987, "    mov ax, 0x4B00"],
      [988, "    int 0x21"],
    ],
    hi: [793, 848, 880, 883, 899, 905, 917, 940, 987],
  ...
  },
  {
    ...
    code: [
      [997, "run_autoexec:"],
      [1000, "    mov dx, autoexec_name"],
      [1001, "    call run_batch_named"],
      ["", "; ..."],
      [1012, "run_batch_named:"],
      [1013, "    cmp byte [batch_active], 0"],
      [1015, "    mov byte [batch_active], 1"],
      [1017, "    mov ah, 0x3D"],
      [1026, "    mov ah, 0x3F"],
      [1038, "    mov si, batch_buf"],
      [1040, "    call batch_read_line"],
      [1046, "    call execute_line"],
      [1052, "    mov byte [batch_active], 0"],
      ["", "; ..."],
      [1243, "batch_read_line:"],
      [1265, "    cmp cx, 63"],
      [1267, "    stosb"],
      [1275, ".eof:"],
      [1276, "    stc"],
    ],
    hi: [997, 1001, 1012, 1013, 1040, 1046, 1243, 1265],
  ...
  },
  {
    ...
    code: [
      [1065, "run_path_exec:"],
      [1069, "run_path_batch:"],
      [1072, "run_path_command:"],
      [1073, "    cmp byte [command_has_path], 0"],
      [1075, "    call find_path_value"],
      [1078, "    call build_path_candidate"],
      [1082, "    call run_candidate_exec"],
      [1085, "    call run_batch_path"],
      ["", "; ..."],
      [1105, "find_path_value:"],
      [1112, "    mov ah, 0x62"],
      [1118, "    mov ax, [es:0x2C]"],
      [1126, "    mov si, path_env_name"],
      [1146, ".found:"],
      [1148, "    mov [path_env_seg], ax"],
      ["", "; ..."],
      [1168, "build_path_candidate:"],
      [1188, "    cmp al, ';'"],
      [1215, "    mov al, '\\'"],
      [1222, "    mov si, command_name"],
      [1230, "    clc"],
    ],
    hi: [1072, 1073, 1075, 1078, 1112, 1118, 1126, 1168, 1188, 1215],
