...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [3072, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3073, "env_path_name: db \"PATH=\", 0"],
      [3074, "env_shell_name: db \"SHELL.COM\", 0"],
      [3075, "env_bin_dir: db \"BIN\", 0"],
      [3076, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3077, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
