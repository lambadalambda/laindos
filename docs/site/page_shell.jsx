...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1500, "init_environment:"],
      [1509, "    call alloc_exec_environment"],
      [1517, "    call write_environment_vars"],
      [1518, "    mov ax, 1"],
      [1519, "    stosw"],
      [1526, "    mov si, fname_exe"],
      ["", "; ..."],
      [1560, "write_environment_vars:"],
      [1566, "    mov si, env_comspec_name"],
      [1571, "    mov si, env_path_name"],
      [1579, "    mov si, env_blaster"],
      [1581, "    mov si, env_prompt"],
      [1583, "    xor al, al"],
      [1606, "env_copy_drive_root:"],
      [1607, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3138, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3139, "env_path_name: db \"PATH=\", 0"],
      [3140, "env_shell_name: db \"SHELL.COM\", 0"],
      [3141, "env_bin_dir: db \"BIN\", 0"],
      [3142, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3143, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
