...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [2837, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2838, "env_path_name: db \"PATH=\", 0"],
      [2839, "env_shell_name: db \"SHELL.COM\", 0"],
      [2840, "env_bin_dir: db \"BIN\", 0"],
      [2841, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [2842, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
