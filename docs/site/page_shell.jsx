...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1429, "init_environment:"],
      [1438, "    call alloc_exec_environment"],
      [1446, "    call write_environment_vars"],
      [1447, "    mov ax, 1"],
      [1448, "    stosw"],
      [1455, "    mov si, fname_exe"],
      ["", "; ..."],
      [1489, "write_environment_vars:"],
      [1495, "    mov si, env_comspec_name"],
      [1500, "    mov si, env_path_name"],
      [1508, "    mov si, env_blaster"],
      [1510, "    mov si, env_prompt"],
      [1512, "    xor al, al"],
      [1535, "env_copy_drive_root:"],
      [1536, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3034, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3035, "env_path_name: db \"PATH=\", 0"],
      [3036, "env_shell_name: db \"SHELL.COM\", 0"],
      [3037, "env_bin_dir: db \"BIN\", 0"],
      [3038, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3039, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
