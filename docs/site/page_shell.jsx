...
const SHELL_SECTIONS = [
  {
    ...
    code: [
      ...
      [31, "    call read_line"],
      [32, "    call execute_line"],
      [33, "    jmp prompt"],
      ["", "; ..."],
      [35, "execute_line:"],
      [38, "    mov si, line_buf"],
      [39, "    call skip_command_prefix"],
      [44, "    call change_drive_command"],
      [46, "    mov bx, command_table"],
      [52, "    call cmd_match"],
      [57, "    jmp word [bx+2]"],
      [58, ".external:"],
      [59, "    call prepare_command"],
      [60, "    call run_command"],
    ],
  ...
  },
  {
    ...
    code: [
      [81, "do_dir:"],
      [82, "    call parse_dir_args"],
      [92, "    call print_dir_header"],
      [96, "    mov dx, dir_pattern"],
      [97, "    mov cx, ATTR_DIR"],
      [98, "    mov ah, 0x4E"],
      [104, "    call print_dir_entry"],
      [107, "    call print_dir_wide_entry"],
      [113, "    call finish_dir_wide_row"],
      [114, "    call print_dir_summary"],
      [870, "do_copy:"],
      [871, "    call parse_copy_args"],
      [878, "    mov ah, 0x3D"],
      [886, "    mov ah, 0x3C"],
      [894, "    mov ah, 0x3F"],
      [903, "    mov ah, 0x40"],
      [916, "    mov dx, copy_success_msg"],
      [1159, "do_cd:"],
      [1162, "    mov dx, si"],
      [1163, "    mov ah, 0x3B"],
      [1171, "    mov ah, 0x47"],
      ["", "; ..."],
      [1231, "do_del:"],
      [1235, "    call del_path_has_wildcard"],
      [1240, "    mov ah, 0x41"],
      [1299, "confirm_del_prompt:"],
      [1308, "    mov ah, 0x08"],
      [1324, "del_path_has_wildcard:"],
      [1333, "    cmp al, '*'"],
      ["", "; ..."],
      [1345, "do_ren:"],
      [1350, "    call ren_paths_have_wildcard"],
      [1352, "    call ren_dst_has_path"],
      [1358, "    mov ah, 0x56"],
      [1420, "ren_dst_has_path:"],
      [1426, "    cmp al, ':'"],
      ["", "; ..."],
      [1519, "do_goto:"],
      [1523, "    call batch_seek_label"],
      [1527, "do_if:"],
      [1529, "    mov di, exist_arg"],
      [1558, "    mov ax, 0x4300"],
      [1562, "    call if_tail_is_bare_label"],
      [1571, "    call execute_line"],
      [1574, "    call batch_seek_label"],
      [1611, "batch_seek_label:"],
      [1631, "    call batch_read_line"],
      [1639, "    call batch_label_match"],
      ["", "; ..."],
      [1728, "do_pause:"],
      [1732, "    mov dx, pause_msg"],
      [1734, "    call wait_key"],
      [1741, "do_mode:"],
      [1745, "    mov ax, 0x0003"],
      [1755, "do_more:"],
      [1761, "    call more_display_file"],
      [1847, "parse_more_args:"],
      [1866, "    cmp al, '<'"],
      [1879, "    mov di, nul_arg"],
      ["", "; ..."],
      [2130, "change_drive_command:"],
      [2134, "    mov al, [si]"],
      [2158, "    mov dl, al"],
      [2160, "    mov ah, 0x0E"],
      [2180, "print_prompt:"],
      [2184, "    mov ah, 0x47"],
      [2192, "    mov dx, prompt_end"],
      ["", "; ..."],
      [2970, "command_table:"],
      [2973, "    dw dir_cmd, do_dir"],
      [2974, "    dw cd_cmd, do_cd"],
      [2981, "    dw copy_cmd, do_copy"],
      [2982, "    dw del_cmd, do_del"],
      [2984, "    dw ren_cmd, do_ren"],
      [2990, "    dw if_cmd, do_if"],
      [2991, "    dw goto_cmd, do_goto"],
      [2992, "    dw pause_cmd, do_pause"],
      [2994, "    dw mode_cmd, do_mode"],
      [2995, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2271, "prepare_command:"],
      [2274, "    mov byte [command_has_ext], 0"],
      [2277, "    mov byte [tail_has_args], 0"],
      [2287, "    cmp al, '.'"],
      [2301, "    mov byte [command_has_path], 1"],
      [2314, "    mov al, '.'"],
      [2317, "    mov al, 'C'"],
      [2319, "    mov al, 'O'"],
      [2321, "    mov al, 'M'"],
      [2326, "    call build_cmd_tail"],
      ["", "; ..."],
      [2358, "run_command:"],
      [2361, "    call run_current_command"],
      [2369, "    call run_current_command"],
      [2377, "    call run_batch"],
      [2383, "    call run_path_exec"],
      [2389, "    call run_path_exec"],
      [2395, "    call run_path_batch"],
      [2399, "    call command_ext_is_bat"],
      [2418, "    mov ah, 0x4D"],
      [2419, "    int 0x21"],
      [2431, "command_ext_is_bat:"],
      [2436, "    and al, 0xDF"],
      [2440, "    and al, 0xDF"],
      [2459, "run_current_command:"],
      [2474, "    mov ax, 0x4B00"],
      [2475, "    int 0x21"],
      [2484, "run_autoexec:"],
      [2487, "    mov dx, autoexec_name"],
      [2488, "    call run_batch_named"],
      [2499, "run_batch_named:"],
      [2502, "    call batch_sync_position"],
      [2505, "    inc byte [batch_active]"],
      [2506, "    push word [batch_handle]"],
      [2508, "    mov ah, 0x3D"],
      [2512, "    mov word [batch_buf_pos], 0"],
      [2517, "    call batch_read_line"],
      [2521, "    call execute_line"],
      [2529, "    pop word [batch_handle]"],
      [2532, "    dec byte [batch_active]"],
      ["", "; ..."],
      [2746, "batch_read_line:"],
      [2750, "    call batch_read_char"],
      [2761, "    cmp cx, 63"],
      [2766, "    call batch_read_char"],
      [2774, "    xor al, al"],
      [2786, "batch_read_char:"],
      [2790, "    mov bx, [batch_buf_pos]"],
      [2796, "    mov ah, 0x3F"],
      [2797, "    int 0x21"],
      [2804, ".have_char:"],
      [2819, "batch_sync_position:"],
      [2831, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2546, "run_path_exec:"],
      [2550, "run_path_batch:"],
      [2553, "run_path_command:"],
      [2554, "    cmp byte [command_has_path], 0"],
      [2556, "    call find_path_value"],
      [2559, "    call build_path_candidate"],
      [2563, "    call run_candidate_exec"],
      [2566, "    call run_batch_path"],
      ["", "; ..."],
      [2584, "find_path_value:"],
      [2597, "    mov ah, 0x62"],
      [2601, "    mov ax, [es:0x2C]"],
      [2611, "    mov si, path_env_name"],
      [2629, ".found:"],
      [2631, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [2648, "build_path_candidate:"],
      [2673, "    cmp al, ';'"],
      [2708, "    mov al, '\\'"],
      [2712, "    mov si, command_name"],
      [2726, "    clc"],
    ],
  ...
  },
  {
    ...
    code: [
      ...
      [1490, "    call alloc_exec_environment"],
      [1497, "    call write_environment_vars"],
      [1498, "    mov ax, 1"],
      [1499, "    stosw"],
      [1506, "    mov si, fname_exe"],
      ["", "; ..."],
      [1540, "write_environment_vars:"],
      [1546, "    mov si, env_comspec_name"],
      [1551, "    mov si, env_path_name"],
      [1559, "    mov si, env_blaster"],
      [1561, "    mov si, env_prompt"],
      [1563, "    xor al, al"],
      [1586, "env_copy_drive_root:"],
      [1587, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3044, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3045, "env_path_name: db \"PATH=\", 0"],
      [3046, "env_shell_name: db \"SHELL.COM\", 0"],
      [3047, "env_bin_dir: db \"BIN\", 0"],
      [3048, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3049, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
