...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1673, "init_environment:"],
      [1682, "    call alloc_exec_environment"],
      [1690, "    call write_environment_vars"],
      [1691, "    mov ax, 1"],
      [1692, "    stosw"],
      [1699, "    mov si, fname_exe"],
      ["", "; ..."],
      [1733, "write_environment_vars:"],
      [1739, "    mov si, env_comspec_name"],
      [1744, "    mov si, env_path_name"],
      [1752, "    mov si, env_blaster"],
      [1754, "    mov si, env_prompt"],
      [1756, "    xor al, al"],
      [1779, "env_copy_drive_root:"],
      [1693, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3280, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3281, "env_path_name: db \"PATH=\", 0"],
      [3282, "env_shell_name: db \"SHELL.COM\", 0"],
      [3283, "env_bin_dir: db \"BIN\", 0"],
      [3284, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3285, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1673, 1682, 1682, 1733, 1739, 1744, 1744, 1673, 3280, 3281],
