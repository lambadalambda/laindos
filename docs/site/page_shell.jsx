...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1379, "init_environment:"],
      [1386, "    call alloc_exec_environment"],
      [1393, "    call write_environment_vars"],
      [1394, "    mov ax, 1"],
      [1395, "    stosw"],
      [1402, "    mov si, fname_exe"],
      ["", "; ..."],
      [1436, "write_environment_vars:"],
      [1442, "    mov si, env_comspec_name"],
      [1447, "    mov si, env_path_name"],
      [1455, "    mov si, env_blaster"],
      [1457, "    mov si, env_prompt"],
      [1459, "    xor al, al"],
      [1482, "env_copy_drive_root:"],
      [1483, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [2831, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2832, "env_path_name: db \"PATH=\", 0"],
      [2833, "env_shell_name: db \"SHELL.COM\", 0"],
      [2834, "env_bin_dir: db \"BIN\", 0"],
      [2835, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [2836, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
