...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1684, "init_environment:"],
      [1693, "    call alloc_exec_environment"],
      [1701, "    call write_environment_vars"],
      [1702, "    mov ax, 1"],
      [1703, "    stosw"],
      [1710, "    mov si, fname_exe"],
      ["", "; ..."],
      [1744, "write_environment_vars:"],
      [1750, "    mov si, env_comspec_name"],
      [1755, "    mov si, env_path_name"],
      [1763, "    mov si, env_blaster"],
      [1765, "    mov si, env_prompt"],
      [1767, "    xor al, al"],
      [1790, "env_copy_drive_root:"],
      [1704, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3291, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3292, "env_path_name: db \"PATH=\", 0"],
      [3293, "env_shell_name: db \"SHELL.COM\", 0"],
      [3294, "env_bin_dir: db \"BIN\", 0"],
      [3295, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3296, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1684, 1693, 1693, 1744, 1750, 1755, 1755, 1684, 3291, 3292],
