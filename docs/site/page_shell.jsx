...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1462, "init_environment:"],
      [1469, "    call alloc_exec_environment"],
      [1476, "    call write_environment_vars"],
      [1477, "    mov ax, 1"],
      [1478, "    stosw"],
      [1485, "    mov si, fname_exe"],
      ["", "; ..."],
      [1519, "write_environment_vars:"],
      [1525, "    mov si, env_comspec_name"],
      [1530, "    mov si, env_path_name"],
      [1538, "    mov si, env_blaster"],
      [1540, "    mov si, env_prompt"],
      [1542, "    xor al, al"],
      [1565, "env_copy_drive_root:"],
      [1566, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [2980, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2981, "env_path_name: db \"PATH=\", 0"],
      [2982, "env_shell_name: db \"SHELL.COM\", 0"],
      [2983, "env_bin_dir: db \"BIN\", 0"],
      [2984, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [2985, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
