...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [3305, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3306, "env_path_name: db \"PATH=\", 0"],
      [3307, "env_shell_name: db \"SHELL.COM\", 0"],
      [3308, "env_bin_dir: db \"BIN\", 0"],
      [3309, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3310, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1693, 1702, 1702, 1753, 1759, 1764, 1764, 1693, 3305, 3306],
