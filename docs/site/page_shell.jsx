...
const SHELL_TESTS = [
  ["Interactive shell", "scripts/test_shell.py", "Drives VER, CLS, DIR path/pattern and human-readable summaries, DIR /P, DIR /W, COPY, DEL/ERASE, REN/RENAME, TYPE, ECHO, REM, COM/EXE/BAT launch, directories, and error paths."],
...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [1630, "do_del:"],
      [1634, "    call del_path_has_wildcard"],
      [1677, "    mov ah, 0x41"],
      [1729, "confirm_del_prompt:"],
      [1520, "    mov ah, 0x08"],
      [1739, "del_path_has_wildcard:"],
      [1748, "    cmp al, '*'"],
      ["", "; ..."],
      [1760, "do_ren:"],
      [1765, "    call ren_paths_have_wildcard"],
      [1767, "    call ren_dst_has_path"],
      [1773, "    mov ah, 0x56"],
      [1837, "ren_dst_has_path:"],
      [1843, "    cmp al, ':'"],
      ["", "; ..."],
      [1931, "do_goto:"],
      [1935, "    call batch_seek_label"],
      [1939, "do_if:"],
      [1955, "    mov di, exist_arg"],
      [1990, "    mov ax, 0x4300"],
      [2100, "    mov di, line_buf"],
      [2107, "    call execute_line"],
      [1935, "    call batch_seek_label"],
      [2116, "batch_seek_label:"],
      [2136, "    call batch_read_line"],
      [2144, "    call batch_label_match"],
      ["", "; ..."],
      [2245, "do_pause:"],
      [2249, "    mov dx, pause_msg"],
      [2251, "    call wait_key"],
      [2258, "do_mode:"],
      [2262, "    mov ax, 0x0003"],
      [2272, "do_more:"],
      [2278, "    call more_display_file"],
      [2372, "parse_more_args:"],
      [2392, "    cmp al, '<'"],
      [2295, "    mov di, nul_arg"],
      ["", "; ..."],
      [2655, "change_drive_command:"],
      [2659, "    mov al, [si]"],
      [2683, "    mov dl, al"],
      [2685, "    mov ah, 0x0E"],
      [2704, "print_prompt:"],
      [2708, "    mov ah, 0x47"],
      [2716, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3625, "command_table:"],
      [3628, "    dw dir_cmd, do_dir"],
      [3629, "    dw cd_cmd, do_cd"],
      [3636, "    dw copy_cmd, do_copy"],
      [3637, "    dw del_cmd, do_del"],
      [3639, "    dw ren_cmd, do_ren"],
      [3645, "    dw if_cmd, do_if"],
      [3646, "    dw goto_cmd, do_goto"],
      [3647, "    dw pause_cmd, do_pause"],
      [3649, "    dw mode_cmd, do_mode"],
      [3650, "    dw more_cmd, do_more"],
    ],
    hi: [242, 259, 265, 268, 274, 275, 1194, 1264, 1272, 1280, 1289, 1302, 1630, 1634, 1677, 1729, 1739, 1760, 1765, 1767, 1773, 1837, 1931, 1939, 1990, 2107, 1935, 2245, 2258, 2272, 2372, 2655, 2685, 2704, 2708, 3625, 3645, 3646, 3647, 3649, 3650],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2788, "prepare_command:"],
      [2791, "    mov byte [command_has_ext], 0"],
      [2795, "    mov byte [tail_has_args], 0"],
      [2809, "    cmp al, '.'"],
      [2823, "    mov byte [command_has_path], 1"],
      [2846, "    mov al, '.'"],
      [2849, "    mov al, 'C'"],
      [2851, "    mov al, 'O'"],
      [2853, "    mov al, 'M'"],
      [2858, "    call build_cmd_tail"],
      ["", "; ..."],
      [2890, "run_command:"],
      [2895, "    call run_current_command"],
      [2903, "    call run_current_command"],
      [2911, "    call run_batch"],
      [2917, "    call run_path_exec"],
      [2923, "    call run_path_exec"],
      [2929, "    call run_path_batch"],
      [2933, "    call command_ext_is_bat"],
      [2952, "    mov ah, 0x4D"],
      [2953, "    int 0x21"],
      [2965, "command_ext_is_bat:"],
      [2970, "    and al, 0xDF"],
      [2974, "    and al, 0xDF"],
      [2993, "run_current_command:"],
      [3008, "    mov ax, 0x4B00"],
      [3009, "    int 0x21"],
      [3018, "run_autoexec:"],
      [3022, "    mov dx, autoexec_name"],
      [3023, "    call run_batch_named"],
      [3034, "run_batch_named:"],
      [3037, "    call batch_sync_position"],
      [3041, "    inc byte [batch_active]"],
      [3042, "    push word [batch_handle]"],
      [3044, "    mov ah, 0x3D"],
      [3048, "    mov word [batch_buf_pos], 0"],
      [3053, "    call batch_read_line"],
      [3058, "    call execute_line"],
      [3066, "    pop word [batch_handle]"],
      [3069, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3407, "batch_read_line:"],
      [3411, "    call batch_read_char"],
      [3422, "    cmp cx, 127"],
      [3427, "    call batch_read_char"],
      [3435, "    xor al, al"],
      [3447, "batch_read_char:"],
      [3451, "    mov bx, [batch_buf_pos]"],
      [3457, "    mov ah, 0x3F"],
      [3458, "    int 0x21"],
      [3465, ".have_char:"],
      [3480, "batch_sync_position:"],
      [3492, "    mov ax, 0x4201"],
      ["", "; ..."],
      [3083, "run_path_exec:"],
      [3087, "run_path_batch:"],
      [3090, "run_path_command:"],
      [3091, "    cmp byte [command_has_path], 0"],
      [3093, "    call find_path_value"],
      [3096, "    call build_path_candidate"],
      [3100, "    call run_candidate_exec"],
      [3103, "    call run_batch_path"],
      ["", "; ..."],
      [3121, "find_path_value:"],
      [3134, "    mov ah, 0x62"],
      [3138, "    mov ax, [es:0x2C]"],
      [3148, "    mov si, path_env_name"],
      [3166, ".found:"],
      [3168, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [3185, "build_path_candidate:"],
      [3210, "    cmp al, ';'"],
      [3245, "    mov al, '\\'"],
      [3249, "    mov si, command_name"],
      [3263, "    clc"],
    ],
    hi: [2788, 2846, 2858, 2890, 2911, 2929, 2933, 2952, 2965, 3034, 3037, 3041, 3042, 3053, 3058, 3066, 3069, 3407, 2903, 3447, 3480, 3083, 3087, 3090, 3100, 3103, 3121, 3185],
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [3300, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3301, "env_path_name: db \"PATH=\", 0"],
      [3302, "env_shell_name: db \"SHELL.COM\", 0"],
      [3303, "env_bin_dir: db \"BIN\", 0"],
      [3304, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3305, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1693, 1702, 1702, 1753, 1759, 1764, 1764, 1693, 3300, 3301],
