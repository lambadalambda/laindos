...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [3255, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3256, "env_path_name: db \"PATH=\", 0"],
      [3257, "env_shell_name: db \"SHELL.COM\", 0"],
      [3258, "env_bin_dir: db \"BIN\", 0"],
      [3259, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3260, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1650, 1659, 1659, 1710, 1716, 1721, 1721, 1650, 3255, 3256],
