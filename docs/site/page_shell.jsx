...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "Startup-script conveniences are minimal: `PAUSE` prints `Press any key to continue . . .` and waits on INT 16h AH=0, `BREAK` is accepted as a no-op (LainDOS does not implement user-mode Ctrl-Break), `MODE CO80` issues INT 10h AH=00h AL=03h, and `MORE < file` reads the file in 4 KiB chunks, prints each line, and waits on the more prompt between screens. `PAUSE`, `MODE`, and `MORE` accept a trailing `> nul` (with or without space) and suppress the prompt; `MORE` accepts a leading `< file` (with space) to redirect input. Batch control includes labels, `GOTO`, `IF EXIST path command`, and `%1`-`%9`/`%%` parameter expansion for the vendor scripts that need them.",
    ...
    code: [
      ...
      ["", "; ..."],
      [1458, "do_del:"],
      [1462, "    call del_path_has_wildcard"],
      [1505, "    mov ah, 0x41"],
      [1556, "confirm_del_prompt:"],
      [1565, "    mov ah, 0x08"],
      [1581, "del_path_has_wildcard:"],
      [1590, "    cmp al, '*'"],
      ["", "; ..."],
      [1602, "do_ren:"],
      [1607, "    call ren_paths_have_wildcard"],
      [1609, "    call ren_dst_has_path"],
      [1615, "    mov ah, 0x56"],
      [1677, "ren_dst_has_path:"],
      [1683, "    cmp al, ':'"],
      ["", "; ..."],
      [1771, "do_goto:"],
      [1775, "    call batch_seek_label"],
      [1779, "do_if:"],
      [1781, "    mov di, exist_arg"],
      [1810, "    mov ax, 0x4300"],
      [1814, "    call if_tail_is_bare_label"],
      [1823, "    call execute_line"],
      [1826, "    call batch_seek_label"],
      [1863, "batch_seek_label:"],
      [1883, "    call batch_read_line"],
      [1891, "    call batch_label_match"],
      ["", "; ..."],
      [1980, "do_pause:"],
      [1984, "    mov dx, pause_msg"],
      [1986, "    call wait_key"],
      [1993, "do_mode:"],
      [1997, "    mov ax, 0x0003"],
      [2007, "do_more:"],
      [2013, "    call more_display_file"],
      [2101, "parse_more_args:"],
      [2121, "    cmp al, '<'"],
      [2134, "    mov di, nul_arg"],
      ["", "; ..."],
      [2382, "change_drive_command:"],
      [2386, "    mov al, [si]"],
      [2410, "    mov dl, al"],
      [2412, "    mov ah, 0x0E"],
      [2431, "print_prompt:"],
      [2435, "    mov ah, 0x47"],
      [2443, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3346, "command_table:"],
      [3349, "    dw dir_cmd, do_dir"],
      [3350, "    dw cd_cmd, do_cd"],
      [3357, "    dw copy_cmd, do_copy"],
      [3358, "    dw del_cmd, do_del"],
      [3360, "    dw ren_cmd, do_ren"],
      [3366, "    dw if_cmd, do_if"],
      [3367, "    dw goto_cmd, do_goto"],
      [3368, "    dw pause_cmd, do_pause"],
      [3370, "    dw mode_cmd, do_mode"],
      [3371, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2519, "prepare_command:"],
      [2522, "    mov byte [command_has_ext], 0"],
      [2525, "    mov byte [tail_has_args], 0"],
      [2535, "    cmp al, '.'"],
      [2549, "    mov byte [command_has_path], 1"],
      [2562, "    mov al, '.'"],
      [2565, "    mov al, 'C'"],
      [2567, "    mov al, 'O'"],
      [2569, "    mov al, 'M'"],
      [2574, "    call build_cmd_tail"],
      ["", "; ..."],
      [2606, "run_command:"],
      [2609, "    call run_current_command"],
      [2617, "    call run_current_command"],
      [2625, "    call run_batch"],
      [2631, "    call run_path_exec"],
      [2631, "    call run_path_exec"],
      [2643, "    call run_path_batch"],
      [2647, "    call command_ext_is_bat"],
      [2666, "    mov ah, 0x4D"],
      [2667, "    int 0x21"],
      [2678, "command_ext_is_bat:"],
      [2683, "    and al, 0xDF"],
      [2683, "    and al, 0xDF"],
      [2706, "run_current_command:"],
      [2721, "    mov ax, 0x4B00"],
      [2722, "    int 0x21"],
      [2731, "run_autoexec:"],
      [2735, "    mov dx, autoexec_name"],
      [2736, "    call run_batch_named"],
      [2747, "run_batch_named:"],
      [2750, "    call batch_sync_position"],
      [2754, "    inc byte [batch_active]"],
      [2755, "    push word [batch_handle]"],
      [2757, "    mov ah, 0x3D"],
      [2761, "    mov word [batch_buf_pos], 0"],
      [2766, "    call batch_read_line"],
      [2771, "    call execute_line"],
      [2779, "    pop word [batch_handle]"],
      [2782, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3120, "batch_read_line:"],
      [3124, "    call batch_read_char"],
      [3135, "    cmp cx, 127"],
      [3140, "    call batch_read_char"],
      [3148, "    xor al, al"],
      [3160, "batch_read_char:"],
      [3164, "    mov bx, [batch_buf_pos]"],
      [3170, "    mov ah, 0x3F"],
      [3171, "    int 0x21"],
      [3178, ".have_char:"],
      [3193, "batch_sync_position:"],
      [3205, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2796, "run_path_exec:"],
      [2800, "run_path_batch:"],
      [2803, "run_path_command:"],
      [2804, "    cmp byte [command_has_path], 0"],
      [2806, "    call find_path_value"],
      [2809, "    call build_path_candidate"],
      [2813, "    call run_candidate_exec"],
      [2816, "    call run_batch_path"],
      ["", "; ..."],
      [2834, "find_path_value:"],
      [2847, "    mov ah, 0x62"],
      [2851, "    mov ax, [es:0x2C]"],
      [2861, "    mov si, path_env_name"],
      [2879, ".found:"],
      [2881, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [2898, "build_path_candidate:"],
      [2923, "    cmp al, ';'"],
      [2958, "    mov al, '\\'"],
      [2962, "    mov si, command_name"],
      [2976, "    clc"],
    ],
