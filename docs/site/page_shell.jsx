...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [3119, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3120, "env_path_name: db \"PATH=\", 0"],
      [3121, "env_shell_name: db \"SHELL.COM\", 0"],
      [3122, "env_bin_dir: db \"BIN\", 0"],
      [3123, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3124, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
