...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1835, "    mov ax, 0x4300"],
      [1945, "    mov di, line_buf"],
      [1952, "    call execute_line"],
      [1780, "    call batch_seek_label"],
      [1961, "batch_seek_label:"],
      [1981, "    call batch_read_line"],
      [1989, "    call batch_label_match"],
      ["", "; ..."],
      [2082, "do_pause:"],
      [2086, "    mov dx, pause_msg"],
      [2088, "    call wait_key"],
      [2095, "do_mode:"],
      [2099, "    mov ax, 0x0003"],
      [2109, "do_more:"],
      [2115, "    call more_display_file"],
      [2203, "parse_more_args:"],
      [2223, "    cmp al, '<'"],
      [2236, "    mov di, nul_arg"],
      ["", "; ..."],
      [2484, "change_drive_command:"],
      [2488, "    mov al, [si]"],
      [2512, "    mov dl, al"],
      [2514, "    mov ah, 0x0E"],
      [2533, "print_prompt:"],
      [2537, "    mov ah, 0x47"],
      [2545, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3462, "command_table:"],
      [3465, "    dw dir_cmd, do_dir"],
      [3466, "    dw cd_cmd, do_cd"],
      [3473, "    dw copy_cmd, do_copy"],
      [3474, "    dw del_cmd, do_del"],
      [3476, "    dw ren_cmd, do_ren"],
      [3482, "    dw if_cmd, do_if"],
      [3483, "    dw goto_cmd, do_goto"],
      [3484, "    dw pause_cmd, do_pause"],
      [3486, "    dw mode_cmd, do_mode"],
      [3487, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2621, "prepare_command:"],
      [2624, "    mov byte [command_has_ext], 0"],
      [2628, "    mov byte [tail_has_args], 0"],
      [2640, "    cmp al, '.'"],
      [2654, "    mov byte [command_has_path], 1"],
      [2675, "    mov al, '.'"],
      [2678, "    mov al, 'C'"],
      [2680, "    mov al, 'O'"],
      [2682, "    mov al, 'M'"],
      [2687, "    call build_cmd_tail"],
      ["", "; ..."],
      [2719, "run_command:"],
      [2724, "    call run_current_command"],
      [2732, "    call run_current_command"],
      [2740, "    call run_batch"],
      [2746, "    call run_path_exec"],
      [2746, "    call run_path_exec"],
      [2758, "    call run_path_batch"],
      [2762, "    call command_ext_is_bat"],
      [2781, "    mov ah, 0x4D"],
      [2782, "    int 0x21"],
      [2794, "command_ext_is_bat:"],
      [2799, "    and al, 0xDF"],
      [2799, "    and al, 0xDF"],
      [2822, "run_current_command:"],
      [2837, "    mov ax, 0x4B00"],
      [2838, "    int 0x21"],
      [2847, "run_autoexec:"],
      [2851, "    mov dx, autoexec_name"],
      [2852, "    call run_batch_named"],
      [2863, "run_batch_named:"],
      [2866, "    call batch_sync_position"],
      [2870, "    inc byte [batch_active]"],
      [2871, "    push word [batch_handle]"],
      [2873, "    mov ah, 0x3D"],
      [2877, "    mov word [batch_buf_pos], 0"],
      [2882, "    call batch_read_line"],
      [2887, "    call execute_line"],
      [2895, "    pop word [batch_handle]"],
      [2898, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3236, "batch_read_line:"],
      [3240, "    call batch_read_char"],
      [3251, "    cmp cx, 127"],
      [3256, "    call batch_read_char"],
      [3264, "    xor al, al"],
      [3276, "batch_read_char:"],
      [3280, "    mov bx, [batch_buf_pos]"],
      [3286, "    mov ah, 0x3F"],
      [3287, "    int 0x21"],
      [3294, ".have_char:"],
      [3309, "batch_sync_position:"],
      [3321, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2912, "run_path_exec:"],
      [2916, "run_path_batch:"],
      [2919, "run_path_command:"],
      [2920, "    cmp byte [command_has_path], 0"],
      [2922, "    call find_path_value"],
      [2925, "    call build_path_candidate"],
      [2929, "    call run_candidate_exec"],
      [2932, "    call run_batch_path"],
      ["", "; ..."],
      [2950, "find_path_value:"],
      [2963, "    mov ah, 0x62"],
      [2967, "    mov ax, [es:0x2C]"],
      [2977, "    mov si, path_env_name"],
      [2995, ".found:"],
      [2997, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [3014, "build_path_candidate:"],
      [3039, "    cmp al, ';'"],
      [3074, "    mov al, '\\'"],
      [3078, "    mov si, command_name"],
      [3092, "    clc"],
    ],
