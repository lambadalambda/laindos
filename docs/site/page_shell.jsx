...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel.asm",
    code: [
      [1705, "init_environment:"],
      [1714, "    call alloc_exec_environment"],
      [1722, "    call write_environment_vars"],
      [1723, "    mov ax, 1"],
      [1724, "    stosw"],
      [1731, "    mov si, fname_exe"],
      ["", "; ..."],
      [1765, "write_environment_vars:"],
      [1771, "    mov si, env_comspec_name"],
      [1776, "    mov si, env_path_name"],
      [1784, "    mov si, env_blaster"],
      [1786, "    mov si, env_prompt"],
      [1788, "    xor al, al"],
      [1811, "env_copy_drive_root:"],
      [1725, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [3707, "env_comspec_name: db \"COMSPEC=\", 0"],
      [3708, "env_path_name: db \"PATH=\", 0"],
      [3709, "env_shell_name: db \"SHELL.COM\", 0"],
      [3710, "env_bin_dir: db \"BIN\", 0"],
      [3711, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [3712, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
    hi: [1705, 1714, 1714, 1765, 1765, 1771, 1771, 1705, 3707, 3707],
