...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [1481, "do_del:"],
      [1485, "    call del_path_has_wildcard"],
      [1528, "    mov ah, 0x41"],
      [1580, "confirm_del_prompt:"],
      [1371, "    mov ah, 0x08"],
      [1590, "del_path_has_wildcard:"],
      [1599, "    cmp al, '*'"],
      ["", "; ..."],
      [1611, "do_ren:"],
      [1616, "    call ren_paths_have_wildcard"],
      [1618, "    call ren_dst_has_path"],
      [1624, "    mov ah, 0x56"],
      ...
      ["", "; ..."],
      [2096, "do_pause:"],
      [2100, "    mov dx, pause_msg"],
      [2102, "    call wait_key"],
      [2109, "do_mode:"],
      [2113, "    mov ax, 0x0003"],
      [2123, "do_more:"],
      [2129, "    call more_display_file"],
      [2223, "parse_more_args:"],
      [2243, "    cmp al, '<'"],
      [2146, "    mov di, nul_arg"],
      ["", "; ..."],
      [2506, "change_drive_command:"],
      [2510, "    mov al, [si]"],
      [2534, "    mov dl, al"],
      [2536, "    mov ah, 0x0E"],
      [2555, "print_prompt:"],
      [2559, "    mov ah, 0x47"],
      [2567, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3476, "command_table:"],
      [3479, "    dw dir_cmd, do_dir"],
      [3480, "    dw cd_cmd, do_cd"],
      [3487, "    dw copy_cmd, do_copy"],
      [3488, "    dw del_cmd, do_del"],
      [3490, "    dw ren_cmd, do_ren"],
      [3496, "    dw if_cmd, do_if"],
      [3497, "    dw goto_cmd, do_goto"],
      [3498, "    dw pause_cmd, do_pause"],
      [3500, "    dw mode_cmd, do_mode"],
      [3501, "    dw more_cmd, do_more"],
    ],
    hi: [242, 259, 265, 268, 274, 275, 1045, 1115, 1123, 1131, 1140, 1153, 1481, 1485, 1528, 1580, 1590, 1611, 1616, 1618, 1624, 1688, 1782, 1790, 1841, 1958, 1786, 2096, 2109, 2123, 2223, 2506, 2536, 2555, 2559, 3476, 3496, 3497, 3498, 3500, 3501],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2639, "prepare_command:"],
      [2642, "    mov byte [command_has_ext], 0"],
      [2646, "    mov byte [tail_has_args], 0"],
      [2660, "    cmp al, '.'"],
      [2674, "    mov byte [command_has_path], 1"],
      [2697, "    mov al, '.'"],
      [2700, "    mov al, 'C'"],
      [2702, "    mov al, 'O'"],
      [2704, "    mov al, 'M'"],
      [2709, "    call build_cmd_tail"],
      ["", "; ..."],
      [2741, "run_command:"],
      [2746, "    call run_current_command"],
      [2754, "    call run_current_command"],
      [2762, "    call run_batch"],
      [2768, "    call run_path_exec"],
      [2768, "    call run_path_exec"],
      [2780, "    call run_path_batch"],
      [2784, "    call command_ext_is_bat"],
      [2803, "    mov ah, 0x4D"],
      [2804, "    int 0x21"],
      [2816, "command_ext_is_bat:"],
      [2821, "    and al, 0xDF"],
      [2821, "    and al, 0xDF"],
      [2844, "run_current_command:"],
      [2859, "    mov ax, 0x4B00"],
      [2860, "    int 0x21"],
      [2869, "run_autoexec:"],
      [2873, "    mov dx, autoexec_name"],
      [2874, "    call run_batch_named"],
      [2885, "run_batch_named:"],
      [2888, "    call batch_sync_position"],
      [2892, "    inc byte [batch_active]"],
      [2893, "    push word [batch_handle]"],
      [2895, "    mov ah, 0x3D"],
      [2899, "    mov word [batch_buf_pos], 0"],
      [2904, "    call batch_read_line"],
      [2909, "    call execute_line"],
      [2917, "    pop word [batch_handle]"],
      [2920, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3258, "batch_read_line:"],
      [3262, "    call batch_read_char"],
      [3273, "    cmp cx, 127"],
      [3278, "    call batch_read_char"],
      [3286, "    xor al, al"],
      [3298, "batch_read_char:"],
      [3302, "    mov bx, [batch_buf_pos]"],
      [3308, "    mov ah, 0x3F"],
      [3309, "    int 0x21"],
      [3316, ".have_char:"],
      [3331, "batch_sync_position:"],
      [3343, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2934, "run_path_exec:"],
      [2938, "run_path_batch:"],
      [2941, "run_path_command:"],
      [2942, "    cmp byte [command_has_path], 0"],
      [2944, "    call find_path_value"],
      [2947, "    call build_path_candidate"],
      [2951, "    call run_candidate_exec"],
      [2954, "    call run_batch_path"],
      ["", "; ..."],
      [2972, "find_path_value:"],
      [2985, "    mov ah, 0x62"],
      [2989, "    mov ax, [es:0x2C]"],
      [2999, "    mov si, path_env_name"],
      [3017, ".found:"],
      [3019, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [3036, "build_path_candidate:"],
      [3061, "    cmp al, ';'"],
      [3096, "    mov al, '\\'"],
      [3100, "    mov si, command_name"],
      [3114, "    clc"],
    ],
    hi: [2639, 2697, 2709, 2741, 2762, 2780, 2784, 2803, 2816, 2885, 2888, 2892, 2893, 2904, 2909, 2917, 2920, 3258, 2754, 3298, 3331, 2934, 2938, 2941, 2951, 2954, 2972, 3036],
