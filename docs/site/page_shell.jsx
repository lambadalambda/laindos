...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      ["", "; ..."],
      [1463, "do_del:"],
      [1467, "    call del_path_has_wildcard"],
      [1510, "    mov ah, 0x41"],
      [1561, "confirm_del_prompt:"],
      [1570, "    mov ah, 0x08"],
      [1586, "del_path_has_wildcard:"],
      [1595, "    cmp al, '*'"],
      ["", "; ..."],
      [1607, "do_ren:"],
      [1612, "    call ren_paths_have_wildcard"],
      [1614, "    call ren_dst_has_path"],
      [1620, "    mov ah, 0x56"],
      [1682, "ren_dst_has_path:"],
      [1688, "    cmp al, ':'"],
      ["", "; ..."],
      [1776, "do_goto:"],
      [1780, "    call batch_seek_label"],
      [1784, "do_if:"],
      [1786, "    mov di, exist_arg"],
      [1815, "    mov ax, 0x4300"],
      [1819, "    call if_tail_is_bare_label"],
      [1828, "    call execute_line"],
      [1831, "    call batch_seek_label"],
      [1868, "batch_seek_label:"],
      [1888, "    call batch_read_line"],
      [1896, "    call batch_label_match"],
      ["", "; ..."],
      [1985, "do_pause:"],
      [1989, "    mov dx, pause_msg"],
      [1991, "    call wait_key"],
      [1998, "do_mode:"],
      [2002, "    mov ax, 0x0003"],
      [2012, "do_more:"],
      [2018, "    call more_display_file"],
      [2106, "parse_more_args:"],
      [2126, "    cmp al, '<'"],
      [2139, "    mov di, nul_arg"],
      ["", "; ..."],
      [2387, "change_drive_command:"],
      [2391, "    mov al, [si]"],
      [2415, "    mov dl, al"],
      [2417, "    mov ah, 0x0E"],
      [2436, "print_prompt:"],
      [2440, "    mov ah, 0x47"],
      [2448, "    mov dx, prompt_end"],
      ["", "; ..."],
      [3351, "command_table:"],
      [3354, "    dw dir_cmd, do_dir"],
      [3355, "    dw cd_cmd, do_cd"],
      [3362, "    dw copy_cmd, do_copy"],
      [3363, "    dw del_cmd, do_del"],
      [3365, "    dw ren_cmd, do_ren"],
      [3371, "    dw if_cmd, do_if"],
      [3372, "    dw goto_cmd, do_goto"],
      [3373, "    dw pause_cmd, do_pause"],
      [3375, "    dw mode_cmd, do_mode"],
      [3376, "    dw more_cmd, do_more"],
    ],
  ...
  },
  {
    ...
    file: "programs/shell.asm",
    code: [
      [2524, "prepare_command:"],
      [2527, "    mov byte [command_has_ext], 0"],
      [2530, "    mov byte [tail_has_args], 0"],
      [2540, "    cmp al, '.'"],
      [2554, "    mov byte [command_has_path], 1"],
      [2567, "    mov al, '.'"],
      [2570, "    mov al, 'C'"],
      [2572, "    mov al, 'O'"],
      [2574, "    mov al, 'M'"],
      [2579, "    call build_cmd_tail"],
      ["", "; ..."],
      [2611, "run_command:"],
      [2614, "    call run_current_command"],
      [2622, "    call run_current_command"],
      [2630, "    call run_batch"],
      [2636, "    call run_path_exec"],
      [2636, "    call run_path_exec"],
      [2648, "    call run_path_batch"],
      [2652, "    call command_ext_is_bat"],
      [2671, "    mov ah, 0x4D"],
      [2672, "    int 0x21"],
      [2683, "command_ext_is_bat:"],
      [2688, "    and al, 0xDF"],
      [2688, "    and al, 0xDF"],
      [2711, "run_current_command:"],
      [2726, "    mov ax, 0x4B00"],
      [2727, "    int 0x21"],
      [2736, "run_autoexec:"],
      [2740, "    mov dx, autoexec_name"],
      [2741, "    call run_batch_named"],
      [2752, "run_batch_named:"],
      [2755, "    call batch_sync_position"],
      [2759, "    inc byte [batch_active]"],
      [2760, "    push word [batch_handle]"],
      [2762, "    mov ah, 0x3D"],
      [2766, "    mov word [batch_buf_pos], 0"],
      [2771, "    call batch_read_line"],
      [2776, "    call execute_line"],
      [2784, "    pop word [batch_handle]"],
      [2787, "    dec byte [batch_active]"],
      ["", "; ..."],
      [3125, "batch_read_line:"],
      [3129, "    call batch_read_char"],
      [3140, "    cmp cx, 127"],
      [3145, "    call batch_read_char"],
      [3153, "    xor al, al"],
      [3165, "batch_read_char:"],
      [3169, "    mov bx, [batch_buf_pos]"],
      [3175, "    mov ah, 0x3F"],
      [3176, "    int 0x21"],
      [3183, ".have_char:"],
      [3198, "batch_sync_position:"],
      [3210, "    mov ax, 0x4201"],
      ["", "; ..."],
      [2801, "run_path_exec:"],
      [2805, "run_path_batch:"],
      [2808, "run_path_command:"],
      [2809, "    cmp byte [command_has_path], 0"],
      [2811, "    call find_path_value"],
      [2814, "    call build_path_candidate"],
      [2818, "    call run_candidate_exec"],
      [2821, "    call run_batch_path"],
      ["", "; ..."],
      [2839, "find_path_value:"],
      [2852, "    mov ah, 0x62"],
      [2856, "    mov ax, [es:0x2C]"],
      [2866, "    mov si, path_env_name"],
      [2884, ".found:"],
      [2886, "    mov [path_env_seg], es"],
      ["", "; ..."],
      [2903, "build_path_candidate:"],
      [2928, "    cmp al, ';'"],
      [2963, "    mov al, '\\'"],
      [2967, "    mov si, command_name"],
      [2981, "    clc"],
    ],
