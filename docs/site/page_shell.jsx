...
const SHELL_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [1468, "    call alloc_exec_environment"],
      [1475, "    call write_environment_vars"],
      [1476, "    mov ax, 1"],
      [1477, "    stosw"],
      [1484, "    mov si, fname_exe"],
      ["", "; ..."],
      [1518, "write_environment_vars:"],
      [1524, "    mov si, env_comspec_name"],
      [1529, "    mov si, env_path_name"],
      [1537, "    mov si, env_blaster"],
      [1539, "    mov si, env_prompt"],
      [1541, "    xor al, al"],
      [1564, "env_copy_drive_root:"],
      [1565, "    mov al, [cs:dos_drive_letter]"],
      ["", "; ..."],
      [2979, "env_comspec_name: db \"COMSPEC=\", 0"],
      [2980, "env_path_name: db \"PATH=\", 0"],
      [2981, "env_shell_name: db \"SHELL.COM\", 0"],
      [2982, "env_bin_dir: db \"BIN\", 0"],
      [2983, "env_blaster: db \"BLASTER=A220 I5 D1 H5 P330 T6\", 0"],
      [2984, "env_prompt: db \"PROMPT=$P$G\", 0"],
    ],
