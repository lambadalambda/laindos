...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1986, ".exec:"],
      [1000, "    cmp al, 0"],
      [1988, "    je .exec_program"],
      [1989, "    cmp al, 3"],
      [1990, "    je .exec_overlay"],
      [2011, "    mov [cs:exec_param_off], bx"],
      [2012, "    mov [cs:exec_param_seg], es"],
      [2013, "    mov [cs:exec_path_off], dx"],
      [2014, "    mov [cs:exec_path_seg], ds"],
  ...
  },
  {
    ...
    code: [
      [1, "load_exec_program:"],
      [5, "    mov ds, [cs:exec_path_seg]"],
      [6, "    mov si, [cs:exec_path_off]"],
      [13, "    call resolve_path"],
      [44, "    call exec_read_first_sector"],
      [47, "    call update_exec_environment_path"],
      [53, "    mov ax, SEC_BUF"],
      [55, "    cmp word [0], 0x5A4D"],
      [56, "    jne .com_size"],
      [57, "    mov byte [cs:exec_is_exe], 1"],
      [174, ".alloc:"],
      [185, "    mov [cs:prog_seg], ax"],
      [198, "    call load_file_direct"]],
    hi: [6, 29, 148, 170],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [446, "    mov word [cs:exec_env_src_seg], 0"],
      [447, "    mov ax, [cs:exec_param_seg]"],
      [452, "    mov ax, [bx]"],
      [459, "    mov [cs:exec_env_src_seg], ax"],
      [461, ".inherit_parent_env:"],
      [470, "    mov ax, [0x2C]"],
      [477, "    mov [cs:exec_env_src_seg], ax"],
      [479, "    call alloc_exec_environment"],
      [490, ".copy_env:"],
      [505, "    call write_environment_vars"],
      [511, "    mov ax, 1"],
      [512, "    stosw"],
      [513, "    mov ds, [cs:exec_path_seg]"],
      [523, "    stosb"]],
    hi: [309, 320, 335, 342],
  ...
  },
  {
    ...
    code: [
      [1318, "build_psp:"],
      [1326, "    mov byte [es:0x00], 0xCD"],
      [1327, "    mov byte [es:0x01], 0x20"],
      [1340, "    mov ax, [0x22*4]"],
      [1356, "    mov word [es:0x32], MAX_HANDLES"],
      [1358, "    mov [es:0x36], ax"],
      [1359, "    mov bx, [cs:cur_psp]"],
      [1418, "    mov [es:0x16], bx"],
      [687, "    mov bx, [cs:exec_env_seg]"],
      [1420, "    mov [es:0x2C], bx"],
      [1424, "    call assign_exec_environment_owner"],
      [1425, "    call exec_copy_default_fcbs"]],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1512, "    mov ax, [cs:exe_reloc_count]"],
      [1515, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1534, "    mov ax, [cs:prog_seg]"],
      [1535, "    call build_psp"],
      [837, "    mov di, [bx]"],
      [838, "    mov ax, [bx+2]"],
      [847, "    mov ax, [es:di]"],
      [1563, "    add ax, [cs:exe_load_seg]"],
      [849, "    mov [es:di], ax"],
      [1596, "    call exec_exe_dyn"],
      [1639, "exec_com_dyn:"],
      [1669, "    mov ss, ax"],
      [1673, "    push word 0x0100"],
      [1674, "    retf"]],
  ...
  },
  {
    ...
    code: [
      [2037, ".exec_overlay:"],
      [2045, "    mov [cs:ov_param_off], bx"],
      [2050, "    mov ax, [es:bx]"],
      [2051, "    mov [cs:ov_load_seg], ax"],
      [2052, "    mov ax, [es:bx+2]"],
      [2053, "    mov [cs:ov_reloc_seg], ax"],
      [2189, "    call resolve_path"],
      [2089, "    call load_overlay_direct"],
      [630, "    xor ax, ax"],
      [407, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2408, "do_terminate:"],
      [2413, "    call restore_irq1_null_mask"],
      ...
      [2451, "    mov ax, [0x16]"],
      [2453, "    mov [cs:cur_psp], ax"],
      [2462, "    mov ax, [cs:saved_ss]"],
      [2465, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_com.back"]],
