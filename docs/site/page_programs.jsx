...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2773, "do_terminate:"],
      [2778, "    call restore_irq1_null_mask"],
      ...
      [2804, "    mov ax, [0x16]"],
      [2806, "    mov [cs:cur_psp], ax"],
      [2815, "    mov ax, [cs:saved_ss]"],
      [2818, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2773, 2787, 2788, 2790, 2796, 2799, 2806, {a: "do_terminate_return_to_parent"}],
