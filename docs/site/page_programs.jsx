...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1414, "build_psp:"],
      [1422, "    mov byte [es:0x00], 0xCD"],
      [1423, "    mov byte [es:0x01], 0x20"],
      [1436, "    mov ax, [0x22*4]"],
      [1452, "    mov word [es:0x32], MAX_HANDLES"],
      [1454, "    mov [es:0x36], ax"],
      [1455, "    mov bx, [cs:cur_psp]"],
      [1514, "    mov [es:0x16], bx"],
      [724, "    mov bx, [cs:exec_env_seg]"],
      [1516, "    mov [es:0x2C], bx"],
      [1520, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1609, "    mov ax, [cs:exe_reloc_count]"],
      [1612, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1631, "    mov ax, [cs:prog_seg]"],
      [1632, "    call build_psp"],
      [1649, "    mov di, [bx]"],
      [1650, "    mov ax, [bx+2]"],
      [1659, "    mov ax, [es:di]"],
      [1656, "    add ax, [cs:exe_load_seg]"],
      [1661, "    mov [es:di], ax"],
      [1695, "    call exec_exe_dyn"],
      [1744, "exec_com_dyn:"],
      [1767, "    mov ss, ax"],
      [1771, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2498, "do_terminate:"],
      [2503, "    call restore_irq1_null_mask"],
      ...
      [2541, "    mov ax, [0x16]"],
      [2543, "    mov [cs:cur_psp], ax"],
      [2552, "    mov ax, [cs:saved_ss]"],
      [2555, "    mov sp, [cs:saved_sp]"],
