...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2640, "do_terminate:"],
      [2645, "    call restore_irq1_null_mask"],
      ...
      [2672, "    mov ax, [0x16]"],
      [2674, "    mov [cs:cur_psp], ax"],
      [2683, "    mov ax, [cs:saved_ss]"],
      [2686, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2640, 2655, 2640, 2674, {a: "do_terminate_return_to_parent"}],
