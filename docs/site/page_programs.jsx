...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2163, ".exec:"],
      [1153, "    cmp al, 0"],
      [2165, "    je .exec_program"],
      [2168, "    cmp al, 3"],
      [2169, "    je .exec_overlay"],
      [2190, "    mov [cs:exec_param_off], bx"],
      [2191, "    mov [cs:exec_param_seg], es"],
      [2192, "    mov [cs:exec_path_off], dx"],
      [2227, "    mov [cs:exec_path_seg], ds"],
      [2228, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      ...
      [889, "    mov [es:di], ax"],
      [1639, "    call exec_exe_dyn"],
      [1688, "exec_com_dyn:"],
      [1718, "    mov ss, ax"],
      [1722, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2290, ".exec_overlay:"],
      [2298, "    mov [cs:ov_param_off], bx"],
      [2303, "    mov ax, [es:bx]"],
      [2304, "    mov [cs:ov_load_seg], ax"],
      [2305, "    mov ax, [es:bx+2]"],
      [2306, "    mov [cs:ov_reloc_seg], ax"],
      [2442, "    call resolve_path"],
      [2342, "    call load_overlay_direct"],
      [783, "    xor ax, ax"],
      [530, "    jmp iret_nc"]],
