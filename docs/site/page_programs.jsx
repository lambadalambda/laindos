...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1908, ".exec:"],
      [1909, "    cmp al, 0"],
      [1910, "    je .exec_program"],
      [1911, "    cmp al, 3"],
      [1912, "    je .exec_overlay"],
      [1934, "    mov [cs:exec_param_off], bx"],
  ...
  },
  {
    ...
    code: [
      ...
      [285, ".copy_env:"],
      [296, "    call write_environment_vars"],
      [298, "    mov ax, 1"],
      [299, "    stosw"],
      [306, "    mov ds, [cs:exec_path_seg]"],
      [375, "    stosb"],
    ],
    hi: [275, 285, 296, 299],
    tests: ["scripts/test_execenv.py", "scripts/test_envmcb.py", "scripts/test_envpath.py"],
  },
  {
    id: "psp",
    ...
    code: [
      [844, "build_psp:"],
      [852, "    mov byte [es:0x00], 0xCD"],
      [853, "    mov byte [es:0x01], 0x20"],
      [866, "    mov ax, [0x22*4]"],
      [882, "    mov word [es:0x32], MAX_HANDLES"],
      [884, "    mov [es:0x36], ax"],
      [943, "    mov bx, [cs:cur_psp]"],
      [944, "    mov [es:0x16], bx"],
      [945, "    mov bx, [cs:exec_env_seg]"],
      [946, "    mov [es:0x2C], bx"],
      [950, "    call assign_exec_environment_owner"],
      [951, "    call exec_copy_default_fcbs"],
    ],
    hi: [844, 852, 882, 944, 946],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1103, "    mov ax, [cs:exe_reloc_count]"],
      [1106, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1125, "    mov ax, [cs:prog_seg]"],
      [1126, "    call build_psp"],
      [1142, "    mov di, [bx]"],
      [1143, "    mov ax, [bx+2]"],
      [1152, "    mov ax, [es:di]"],
      [1153, "    add ax, [cs:exe_load_seg]"],
      [1154, "    mov [es:di], ax"],
      [1186, "    call exec_exe_dyn"],
      [1225, "exec_com_dyn:"],
      [1255, "    mov ss, ax"],
      [1259, "    push word 0x0100"],
      [1260, "    retf"],
    ],
    hi: [1106, 1126, 1154, 1186, 1225, 1260],
  ...
  },
  {
    ...
    code: [
      [1961, ".exec_overlay:"],
      [1969, "    mov [cs:ov_param_off], bx"],
      [1974, "    mov ax, [es:bx]"],
      [1975, "    mov [cs:ov_load_seg], ax"],
      [1976, "    mov ax, [es:bx+2]"],
      [1977, "    mov [cs:ov_reloc_seg], ax"],
