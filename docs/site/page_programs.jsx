...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2654, "do_terminate:"],
      [2659, "    call restore_irq1_null_mask"],
      ...
      [2686, "    mov ax, [0x16]"],
      [2688, "    mov [cs:cur_psp], ax"],
      [2697, "    mov ax, [cs:saved_ss]"],
      [2700, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2654, 2669, 2654, 2686, {a: "do_terminate_return_to_parent"}],
