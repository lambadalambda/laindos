...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1962, ".exec:"],
      [910, "    cmp al, 0"],
      [1964, "    je .exec_program"],
      [1965, "    cmp al, 3"],
      [1966, "    je .exec_overlay"],
      [1987, "    mov [cs:exec_param_off], bx"],
      [1988, "    mov [cs:exec_param_seg], es"],
      [1989, "    mov [cs:exec_path_off], dx"],
      [1990, "    mov [cs:exec_path_seg], ds"],
  ...
  },
  {
    ...
    code: [
      [2013, ".exec_overlay:"],
      [2021, "    mov [cs:ov_param_off], bx"],
      [2026, "    mov ax, [es:bx]"],
      [2027, "    mov [cs:ov_load_seg], ax"],
      [2028, "    mov ax, [es:bx+2]"],
      [2029, "    mov [cs:ov_reloc_seg], ax"],
      [2032, "    call resolve_path"],
      [2040, "    call load_overlay_direct"],
      [606, "    xor ax, ax"],
      [393, "    jmp iret_nc"]],
    hi: [1985, 1999, 2001, 2012],
