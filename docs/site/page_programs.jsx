...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [518, "    mov word [cs:exec_env_src_seg], 0"],
      [461, "    mov ax, [cs:exec_param_seg]"],
      [524, "    mov ax, [bx]"],
      [531, "    mov [cs:exec_env_src_seg], ax"],
      [533, ".inherit_parent_env:"],
      [542, "    mov ax, [0x2C]"],
      [531, "    mov [cs:exec_env_src_seg], ax"],
      [573, "    call alloc_exec_environment"],
      [584, ".copy_env:"],
      [599, "    call write_environment_vars"],
      [605, "    mov ax, 1"],
      [606, "    stosw"],
  ...
  },
  {
    ...
    code: [
      [1389, "build_psp:"],
      [1397, "    mov byte [es:0x00], 0xCD"],
      [1398, "    mov byte [es:0x01], 0x20"],
      [1411, "    mov ax, [0x22*4]"],
      [1427, "    mov word [es:0x32], MAX_HANDLES"],
      [1429, "    mov [es:0x36], ax"],
      [1488, "    mov bx, [cs:cur_psp]"],
      [1489, "    mov [es:0x16], bx"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1584, "    mov ax, [cs:exe_reloc_count]"],
      [139, "    cmp dx, 0x1C"],
      [1680, "    mov ax, [cs:prog_seg]"],
      [1591, "    call build_psp"],
      [1608, "    mov di, [bx]"],
      [1609, "    mov ax, [bx+2]"],
      [1618, "    mov ax, [es:di]"],
      [1619, "    add ax, [cs:exe_load_seg]"],
      [1620, "    mov [es:di], ax"],
      [1654, "    call exec_exe_dyn"],
      [1703, "exec_com_dyn:"],
      [1726, "    mov ss, ax"],
  ...
  },
  {
    ...
    code: [
      [2559, "do_terminate:"],
      [2564, "    call restore_irq1_null_mask"],
      ...
      [2591, "    mov ax, [0x16]"],
      [2593, "    mov [cs:cur_psp], ax"],
      [2602, "    mov ax, [cs:saved_ss]"],
      [2605, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2559, 2574, 2559, 2593, {a: "do_terminate_return_to_parent"}],
