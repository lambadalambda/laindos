...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1942, ".exec:"],
      [910, "    cmp al, 0"],
      [1944, "    je .exec_program"],
      [1945, "    cmp al, 3"],
      [1946, "    je .exec_overlay"],
      [1967, "    mov [cs:exec_param_off], bx"],
      [1968, "    mov [cs:exec_param_seg], es"],
      [1969, "    mov [cs:exec_path_off], dx"],
      [1970, "    mov [cs:exec_path_seg], ds"],
  ...
  },
  {
    ...
    code: [
      [1993, ".exec_overlay:"],
      [2001, "    mov [cs:ov_param_off], bx"],
      [2006, "    mov ax, [es:bx]"],
      [2007, "    mov [cs:ov_load_seg], ax"],
      [2008, "    mov ax, [es:bx+2]"],
      [2009, "    mov [cs:ov_reloc_seg], ax"],
      [2012, "    call resolve_path"],
      [2020, "    call load_overlay_direct"],
      [606, "    xor ax, ax"],
      [393, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2155, "do_terminate:"],
      [2159, "    call restore_irq1_null_mask"],
      ...
      [2207, "    mov ax, [cs:saved_ss]"],
      [2210, "    mov sp, [cs:saved_sp]"],
      [2212, "    jmp exec_com.back"]],
