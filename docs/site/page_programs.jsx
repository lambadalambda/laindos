...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2650, "do_terminate:"],
      [2655, "    call restore_irq1_null_mask"],
      ...
      [2682, "    mov ax, [0x16]"],
      [2684, "    mov [cs:cur_psp], ax"],
      [2693, "    mov ax, [cs:saved_ss]"],
      [2696, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2650, 2665, 2650, 2682, {a: "do_terminate_return_to_parent"}],
