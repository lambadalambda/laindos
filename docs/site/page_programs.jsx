...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1970, ".exec:"],
      [918, "    cmp al, 0"],
      [1972, "    je .exec_program"],
      [1973, "    cmp al, 3"],
      [1974, "    je .exec_overlay"],
      [1995, "    mov [cs:exec_param_off], bx"],
      [1996, "    mov [cs:exec_param_seg], es"],
      [1997, "    mov [cs:exec_path_off], dx"],
      [1998, "    mov [cs:exec_path_seg], ds"],
      [1999, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      [2021, ".exec_overlay:"],
      [2029, "    mov [cs:ov_param_off], bx"],
      [2034, "    mov ax, [es:bx]"],
      [2035, "    mov [cs:ov_load_seg], ax"],
      [2036, "    mov ax, [es:bx+2]"],
      [2037, "    mov [cs:ov_reloc_seg], ax"],
      [2040, "    call resolve_path"],
      [2048, "    call load_overlay_direct"],
      [614, "    xor ax, ax"],
      [399, "    jmp iret_nc"]],
