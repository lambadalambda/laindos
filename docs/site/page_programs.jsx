...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2177, ".exec:"],
      [1167, "    cmp al, 0"],
      [2179, "    je .exec_program"],
      [2182, "    cmp al, 3"],
      [2183, "    je .exec_overlay"],
      [2204, "    mov [cs:exec_param_off], bx"],
      [2205, "    mov [cs:exec_param_seg], es"],
      [2206, "    mov [cs:exec_path_off], dx"],
      [2241, "    mov [cs:exec_path_seg], ds"],
      [2242, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      [2304, ".exec_overlay:"],
      [2312, "    mov [cs:ov_param_off], bx"],
      [2317, "    mov ax, [es:bx]"],
      [2318, "    mov [cs:ov_load_seg], ax"],
      [2319, "    mov ax, [es:bx+2]"],
      [2320, "    mov [cs:ov_reloc_seg], ax"],
      [2456, "    call resolve_path"],
      [2356, "    call load_overlay_direct"],
      [785, "    xor ax, ax"],
      [539, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2430, "do_terminate:"],
      [2435, "    call restore_irq1_null_mask"],
      ...
      [2473, "    mov ax, [0x16]"],
      [2475, "    mov [cs:cur_psp], ax"],
      [2484, "    mov ax, [cs:saved_ss]"],
      [2487, "    mov sp, [cs:saved_sp]"],
