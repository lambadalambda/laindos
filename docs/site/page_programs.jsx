...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2328, ".exec_overlay:"],
      [2336, "    mov [cs:ov_param_off], bx"],
      [2341, "    mov ax, [es:bx]"],
      [2342, "    mov [cs:ov_load_seg], ax"],
      [2343, "    mov ax, [es:bx+2]"],
      [2344, "    mov [cs:ov_reloc_seg], ax"],
      [2480, "    call resolve_path"],
      [2380, "    call load_overlay_direct"],
      [780, "    xor ax, ax"],
      [539, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2485, "do_terminate:"],
      [2490, "    call restore_irq1_null_mask"],
