...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2693, "do_terminate:"],
      [2698, "    call restore_irq1_null_mask"],
      ...
      [2725, "    mov ax, [0x16]"],
      [2727, "    mov [cs:cur_psp], ax"],
      [2736, "    mov ax, [cs:saved_ss]"],
      [2739, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2693, 2708, 2693, 2725, {a: "do_terminate_return_to_parent"}],
