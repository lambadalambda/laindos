...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [447, "    mov word [cs:exec_env_src_seg], 0"],
      [448, "    mov ax, [cs:exec_param_seg]"],
      [453, "    mov ax, [bx]"],
      [460, "    mov [cs:exec_env_src_seg], ax"],
      [462, ".inherit_parent_env:"],
      [471, "    mov ax, [0x2C]"],
      [478, "    mov [cs:exec_env_src_seg], ax"],
      [480, "    call alloc_exec_environment"],
      [491, ".copy_env:"],
      [506, "    call write_environment_vars"],
      [512, "    mov ax, 1"],
      [513, "    stosw"],
      [514, "    mov ds, [cs:exec_path_seg]"],
      [524, "    stosb"]],
    hi: [309, 320, 335, 342],
  ...
  },
  {
    ...
    code: [
      [1319, "build_psp:"],
      [1327, "    mov byte [es:0x00], 0xCD"],
      [1328, "    mov byte [es:0x01], 0x20"],
      [1341, "    mov ax, [0x22*4]"],
      [1357, "    mov word [es:0x32], MAX_HANDLES"],
      [1359, "    mov [es:0x36], ax"],
      [1360, "    mov bx, [cs:cur_psp]"],
      [1419, "    mov [es:0x16], bx"],
      [688, "    mov bx, [cs:exec_env_seg]"],
      [1421, "    mov [es:0x2C], bx"],
      [1425, "    call assign_exec_environment_owner"],
      [1426, "    call exec_copy_default_fcbs"]],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1513, "    mov ax, [cs:exe_reloc_count]"],
      [1516, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1535, "    mov ax, [cs:prog_seg]"],
      [1536, "    call build_psp"],
      [838, "    mov di, [bx]"],
      [839, "    mov ax, [bx+2]"],
      [848, "    mov ax, [es:di]"],
      [1564, "    add ax, [cs:exe_load_seg]"],
      [850, "    mov [es:di], ax"],
      [1597, "    call exec_exe_dyn"],
      [1642, "exec_com_dyn:"],
      [1672, "    mov ss, ax"],
      [1676, "    push word 0x0100"],
      [1677, "    retf"]],
