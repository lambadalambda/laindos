...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1288, "build_psp:"],
      [1296, "    mov byte [es:0x00], 0xCD"],
      [1297, "    mov byte [es:0x01], 0x20"],
      [1310, "    mov ax, [0x22*4]"],
      [1326, "    mov word [es:0x32], MAX_HANDLES"],
      [1328, "    mov [es:0x36], ax"],
      [1329, "    mov bx, [cs:cur_psp]"],
      [1388, "    mov [es:0x16], bx"],
      [687, "    mov bx, [cs:exec_env_seg]"],
      [1390, "    mov [es:0x2C], bx"],
      [1394, "    call assign_exec_environment_owner"],
      [1395, "    call exec_copy_default_fcbs"]],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1482, "    mov ax, [cs:exe_reloc_count]"],
      [1485, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1504, "    mov ax, [cs:prog_seg]"],
      [1505, "    call build_psp"],
      [833, "    mov di, [bx]"],
      [834, "    mov ax, [bx+2]"],
      [843, "    mov ax, [es:di]"],
      [1533, "    add ax, [cs:exe_load_seg]"],
      [845, "    mov [es:di], ax"],
      [1566, "    call exec_exe_dyn"],
      [1609, "exec_com_dyn:"],
      [1639, "    mov ss, ax"],
      [1643, "    push word 0x0100"],
      [1607, "    retf"]],
  ...
  },
  {
    ...
    code: [
      [2370, "do_terminate:"],
      [2374, "    call restore_irq1_null_mask"],
      ...
      [2412, "    mov ax, [0x16]"],
      [2414, "    mov [cs:cur_psp], ax"],
      [2423, "    mov ax, [cs:saved_ss]"],
      [2426, "    mov sp, [cs:saved_sp]"],
