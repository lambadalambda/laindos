...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1449, "build_psp:"],
      [1457, "    mov byte [es:0x00], 0xCD"],
      [1458, "    mov byte [es:0x01], 0x20"],
      [1471, "    mov ax, [0x22*4]"],
      [1487, "    mov word [es:0x32], MAX_HANDLES"],
      [1489, "    mov [es:0x36], ax"],
      [1490, "    mov bx, [cs:cur_psp]"],
      [1549, "    mov [es:0x16], bx"],
      [781, "    mov bx, [cs:exec_env_seg]"],
      [1551, "    mov [es:0x2C], bx"],
      [1555, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1644, "    mov ax, [cs:exe_reloc_count]"],
      [139, "    cmp dx, 0x1C"],
      [1650, "    mov ax, [cs:prog_seg]"],
      [1651, "    call build_psp"],
      [1668, "    mov di, [bx]"],
      [1669, "    mov ax, [bx+2]"],
      [1678, "    mov ax, [es:di]"],
      [1675, "    add ax, [cs:exe_load_seg]"],
      [1680, "    mov [es:di], ax"],
      [1714, "    call exec_exe_dyn"],
      [1763, "exec_com_dyn:"],
      [1786, "    mov ss, ax"],
      [1790, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2427, "do_terminate:"],
      [2493, "    call restore_irq1_null_mask"],
      ...
      [2470, "    mov ax, [0x16]"],
      [2556, "    mov [cs:cur_psp], ax"],
      [2561, "    mov ax, [cs:saved_ss]"],
      [2564, "    mov sp, [cs:saved_sp]"],
