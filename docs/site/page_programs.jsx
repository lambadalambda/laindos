...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2172, ".exec:"],
      [1162, "    cmp al, 0"],
      [2174, "    je .exec_program"],
      [2177, "    cmp al, 3"],
      [2178, "    je .exec_overlay"],
      [2199, "    mov [cs:exec_param_off], bx"],
      [2200, "    mov [cs:exec_param_seg], es"],
      [2201, "    mov [cs:exec_path_off], dx"],
      [2264, "    mov [cs:exec_path_seg], ds"],
      [2231, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      [1415, "build_psp:"],
      [1423, "    mov byte [es:0x00], 0xCD"],
      [1424, "    mov byte [es:0x01], 0x20"],
      [1437, "    mov ax, [0x22*4]"],
      [1453, "    mov word [es:0x32], MAX_HANDLES"],
      [1455, "    mov [es:0x36], ax"],
      [1456, "    mov bx, [cs:cur_psp]"],
      [1515, "    mov [es:0x16], bx"],
      [724, "    mov bx, [cs:exec_env_seg]"],
      [1517, "    mov [es:0x2C], bx"],
      [1521, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1610, "    mov ax, [cs:exe_reloc_count]"],
      [1613, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1632, "    mov ax, [cs:prog_seg]"],
      [1633, "    call build_psp"],
      [1650, "    mov di, [bx]"],
      [1651, "    mov ax, [bx+2]"],
      [1660, "    mov ax, [es:di]"],
      [1657, "    add ax, [cs:exe_load_seg]"],
      [1662, "    mov [es:di], ax"],
      [1696, "    call exec_exe_dyn"],
      [1745, "exec_com_dyn:"],
      [1775, "    mov ss, ax"],
      [1779, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2327, ".exec_overlay:"],
      [2335, "    mov [cs:ov_param_off], bx"],
      [2340, "    mov ax, [es:bx]"],
      [2341, "    mov [cs:ov_load_seg], ax"],
      [2342, "    mov ax, [es:bx+2]"],
      [2343, "    mov [cs:ov_reloc_seg], ax"],
      [2479, "    call resolve_path"],
      [2379, "    call load_overlay_direct"],
      [780, "    xor ax, ax"],
      [539, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2436, "do_terminate:"],
      [2441, "    call restore_irq1_null_mask"],
      ...
      [2479, "    mov ax, [0x16]"],
      [2481, "    mov [cs:cur_psp], ax"],
      [2490, "    mov ax, [cs:saved_ss]"],
      [2493, "    mov sp, [cs:saved_sp]"],
