...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      ...
      [2166, "    cmp al, 3"],
      [2167, "    je .exec_overlay"],
      [2188, "    mov [cs:exec_param_off], bx"],
      [2189, "    mov [cs:exec_param_seg], es"],
      [2190, "    mov [cs:exec_path_off], dx"],
      [2191, "    mov [cs:exec_path_seg], ds"],
  ...
  },
  {
    ...
    code: [
      [2214, ".exec_overlay:"],
      [2222, "    mov [cs:ov_param_off], bx"],
      [2227, "    mov ax, [es:bx]"],
      [2228, "    mov [cs:ov_load_seg], ax"],
      [2229, "    mov ax, [es:bx+2]"],
      [2230, "    mov [cs:ov_reloc_seg], ax"],
      [2366, "    call resolve_path"],
      [2266, "    call load_overlay_direct"],
      [783, "    xor ax, ax"],
      [530, "    jmp iret_nc"]],
