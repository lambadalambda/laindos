...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1966, ".exec:"],
      [914, "    cmp al, 0"],
      [1968, "    je .exec_program"],
      [1969, "    cmp al, 3"],
      [1970, "    je .exec_overlay"],
      [1991, "    mov [cs:exec_param_off], bx"],
      [1992, "    mov [cs:exec_param_seg], es"],
      [1993, "    mov [cs:exec_path_off], dx"],
      [1994, "    mov [cs:exec_path_seg], ds"],
      [1995, "    call load_exec_program"]],
    hi: [1936, 1962, 1966],
  ...
  },
  {
    ...
    code: [
      [1, "load_exec_program:"],
      [4, "    mov ds, [cs:exec_path_seg]"],
      [5, "    mov si, [cs:exec_path_off]"],
      [6, "    call resolve_path"],
      [19, "    call exec_read_first_sector"],
      [21, "    call update_exec_environment_path"],
      [27, "    mov ax, SEC_BUF"],
      [29, "    cmp word [0], 0x5A4D"],
      [30, "    jne .com_size"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [294, "    mov word [cs:exec_env_src_seg], 0"],
      [295, "    mov ax, [cs:exec_param_seg]"],
      [300, "    mov ax, [bx]"],
      [307, "    mov [cs:exec_env_src_seg], ax"],
      [309, "    call alloc_exec_environment"],
      [320, ".copy_env:"],
      [335, "    call write_environment_vars"],
      [341, "    mov ax, 1"],
      [342, "    stosw"],
      [355, "    mov ds, [cs:exec_path_seg]"],
      [430, "    stosb"]],
    hi: [309, 320, 335, 342],
  ...
  },
  {
    ...
    code: [
      [913, "build_psp:"],
      [921, "    mov byte [es:0x00], 0xCD"],
      [922, "    mov byte [es:0x01], 0x20"],
      [935, "    mov ax, [0x22*4]"],
      [951, "    mov word [es:0x32], MAX_HANDLES"],
      [953, "    mov [es:0x36], ax"],
      [1012, "    mov bx, [cs:cur_psp]"],
      [1013, "    mov [es:0x16], bx"],
      [1014, "    mov bx, [cs:exec_env_seg]"],
      [1015, "    mov [es:0x2C], bx"],
      [1019, "    call assign_exec_environment_owner"],
      [1020, "    call exec_copy_default_fcbs"]],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1107, "    mov ax, [cs:exe_reloc_count]"],
      [1110, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1129, "    mov ax, [cs:prog_seg]"],
      [1130, "    call build_psp"],
      [1147, "    mov di, [bx]"],
      [1148, "    mov ax, [bx+2]"],
      [1157, "    mov ax, [es:di]"],
      [1158, "    add ax, [cs:exe_load_seg]"],
      [1159, "    mov [es:di], ax"],
      [1191, "    call exec_exe_dyn"],
      [1234, "exec_com_dyn:"],
      [1264, "    mov ss, ax"],
      [1268, "    push word 0x0100"],
      [1269, "    retf"]],
  ...
  },
  {
    ...
    code: [
      [2017, ".exec_overlay:"],
      [2025, "    mov [cs:ov_param_off], bx"],
      [2030, "    mov ax, [es:bx]"],
      [2031, "    mov [cs:ov_load_seg], ax"],
      [2032, "    mov ax, [es:bx+2]"],
      [2033, "    mov [cs:ov_reloc_seg], ax"],
      [2036, "    call resolve_path"],
      [2044, "    call load_overlay_direct"],
      [610, "    xor ax, ax"],
      [397, "    jmp iret_nc"]],
    hi: [1989, 2003, 2005, 2016],
  ...
  },
  {
    ...
    code: [
      [2175, "do_terminate:"],
      [2179, "    call restore_irq1_null_mask"],
      ...
      [2227, "    mov ax, [cs:saved_ss]"],
      [2230, "    mov sp, [cs:saved_sp]"],
      [2232, "    jmp exec_com.back"]],
