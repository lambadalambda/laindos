...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [872, "build_psp:"],
      [880, "    mov byte [es:0x00], 0xCD"],
      [881, "    mov byte [es:0x01], 0x20"],
      [894, "    mov ax, [0x22*4]"],
      [910, "    mov word [es:0x32], MAX_HANDLES"],
      [912, "    mov [es:0x36], ax"],
      [971, "    mov bx, [cs:cur_psp]"],
      [972, "    mov [es:0x16], bx"],
      [973, "    mov bx, [cs:exec_env_seg]"],
      [974, "    mov [es:0x2C], bx"],
      [978, "    call assign_exec_environment_owner"],
      [979, "    call exec_copy_default_fcbs"],
    ],
    hi: [872, 880, 910, 972, 974],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1131, "    mov ax, [cs:exe_reloc_count]"],
      [1134, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1153, "    mov ax, [cs:prog_seg]"],
      [1154, "    call build_psp"],
      [1170, "    mov di, [bx]"],
      [1171, "    mov ax, [bx+2]"],
      [1180, "    mov ax, [es:di]"],
      [1181, "    add ax, [cs:exe_load_seg]"],
      [1182, "    mov [es:di], ax"],
      [1214, "    call exec_exe_dyn"],
      [1253, "exec_com_dyn:"],
      [1283, "    mov ss, ax"],
      [1287, "    push word 0x0100"],
      [1288, "    retf"],
    ],
    hi: [1134, 1154, 1182, 1214, 1253, 1288],
