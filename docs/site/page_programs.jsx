...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [878, "build_psp:"],
      [886, "    mov byte [es:0x00], 0xCD"],
      [887, "    mov byte [es:0x01], 0x20"],
      [900, "    mov ax, [0x22*4]"],
      [916, "    mov word [es:0x32], MAX_HANDLES"],
      [918, "    mov [es:0x36], ax"],
      [977, "    mov bx, [cs:cur_psp]"],
      [978, "    mov [es:0x16], bx"],
      [979, "    mov bx, [cs:exec_env_seg]"],
      [980, "    mov [es:0x2C], bx"],
      [984, "    call assign_exec_environment_owner"],
      [985, "    call exec_copy_default_fcbs"]],
    hi: [878, 886, 916, 978, 980],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1072, "    mov ax, [cs:exe_reloc_count]"],
      [1075, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1094, "    mov ax, [cs:prog_seg]"],
      [1095, "    call build_psp"],
      [1111, "    mov di, [bx]"],
      [1112, "    mov ax, [bx+2]"],
      [1121, "    mov ax, [es:di]"],
      [1122, "    add ax, [cs:exe_load_seg]"],
      [1123, "    mov [es:di], ax"],
      [1155, "    call exec_exe_dyn"],
      [1194, "exec_com_dyn:"],
      [1224, "    mov ss, ax"],
      [1228, "    push word 0x0100"],
      [1229, "    retf"]],
    hi: [1075, 1095, 1123, 1155, 1194, 1229],
