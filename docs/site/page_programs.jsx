...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2695, "do_terminate:"],
      [2700, "    call restore_irq1_null_mask"],
      ...
      [2727, "    mov ax, [0x16]"],
      [2729, "    mov [cs:cur_psp], ax"],
      [2738, "    mov ax, [cs:saved_ss]"],
      [2741, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2695, 2710, 2695, 2727, {a: "do_terminate_return_to_parent"}],
