...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2129, ".exec:"],
      [1121, "    cmp al, 0"],
      [2131, "    je .exec_program"],
      [2132, "    cmp al, 3"],
      [2133, "    je .exec_overlay"],
      [2154, "    mov [cs:exec_param_off], bx"],
      [2155, "    mov [cs:exec_param_seg], es"],
      [2156, "    mov [cs:exec_path_off], dx"],
      [2157, "    mov [cs:exec_path_seg], ds"],
      [2158, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [457, "    mov word [cs:exec_env_src_seg], 0"],
      [458, "    mov ax, [cs:exec_param_seg]"],
      [463, "    mov ax, [bx]"],
      [470, "    mov [cs:exec_env_src_seg], ax"],
      [472, ".inherit_parent_env:"],
      [481, "    mov ax, [0x2C]"],
      [488, "    mov [cs:exec_env_src_seg], ax"],
      [512, "    call alloc_exec_environment"],
      [523, ".copy_env:"],
      [538, "    call write_environment_vars"],
      [544, "    mov ax, 1"],
      [545, "    stosw"],
      [546, "    mov ds, [cs:exec_path_seg]"],
  ...
  },
  {
    ...
    code: [
      [1358, "build_psp:"],
      [1366, "    mov byte [es:0x00], 0xCD"],
      [1367, "    mov byte [es:0x01], 0x20"],
      [1380, "    mov ax, [0x22*4]"],
      [1396, "    mov word [es:0x32], MAX_HANDLES"],
      [1398, "    mov [es:0x36], ax"],
      [1399, "    mov bx, [cs:cur_psp]"],
      [1458, "    mov [es:0x16], bx"],
      [724, "    mov bx, [cs:exec_env_seg]"],
      [1460, "    mov [es:0x2C], bx"],
      [1464, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1553, "    mov ax, [cs:exe_reloc_count]"],
      [1556, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1575, "    mov ax, [cs:prog_seg]"],
      [1576, "    call build_psp"],
      [877, "    mov di, [bx]"],
      [878, "    mov ax, [bx+2]"],
      [887, "    mov ax, [es:di]"],
      [1600, "    add ax, [cs:exe_load_seg]"],
      [889, "    mov [es:di], ax"],
      [1637, "    call exec_exe_dyn"],
      [1682, "exec_com_dyn:"],
      [1712, "    mov ss, ax"],
      [1716, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2180, ".exec_overlay:"],
      [2188, "    mov [cs:ov_param_off], bx"],
      [2193, "    mov ax, [es:bx]"],
      [2194, "    mov [cs:ov_load_seg], ax"],
      [2195, "    mov ax, [es:bx+2]"],
      [2196, "    mov [cs:ov_reloc_seg], ax"],
      [2332, "    call resolve_path"],
      [2232, "    call load_overlay_direct"],
      [751, "    xor ax, ax"],
      [528, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2411, "do_terminate:"],
      [2416, "    call restore_irq1_null_mask"],
      ...
      [2454, "    mov ax, [0x16]"],
      [2456, "    mov [cs:cur_psp], ax"],
      [2465, "    mov ax, [cs:saved_ss]"],
      [2468, "    mov sp, [cs:saved_sp]"],
