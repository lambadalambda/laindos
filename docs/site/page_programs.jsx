...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2182, ".exec:"],
      [1172, "    cmp al, 0"],
      [2184, "    je .exec_program"],
      [2187, "    cmp al, 3"],
      [2188, "    je .exec_overlay"],
      [2209, "    mov [cs:exec_param_off], bx"],
      [2210, "    mov [cs:exec_param_seg], es"],
      [2211, "    mov [cs:exec_path_off], dx"],
      [2275, "    mov [cs:exec_path_seg], ds"],
      [2241, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      [2338, ".exec_overlay:"],
      [2346, "    mov [cs:ov_param_off], bx"],
      [2351, "    mov ax, [es:bx]"],
      [2352, "    mov [cs:ov_load_seg], ax"],
      [2353, "    mov ax, [es:bx+2]"],
      [2354, "    mov [cs:ov_reloc_seg], ax"],
      [2490, "    call resolve_path"],
      [2390, "    call load_overlay_direct"],
      [790, "    xor ax, ax"],
      [549, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2499, "do_terminate:"],
      [2504, "    call restore_irq1_null_mask"],
      ...
      [2542, "    mov ax, [0x16]"],
      [2544, "    mov [cs:cur_psp], ax"],
      [2553, "    mov ax, [cs:saved_ss]"],
      [2556, "    mov sp, [cs:saved_sp]"],
