...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [270, "    mov ax, [bx]"],
      [273, "    mov [cs:exec_env_src_seg], ax"],
      [275, "    call alloc_exec_environment"],
      [286, ".copy_env:"],
      [301, "    call write_environment_vars"],
      [307, "    mov ax, 1"],
      [308, "    stosw"],
  ...
  },
  {
    ...
    code: [
      [885, "build_psp:"],
      [893, "    mov byte [es:0x00], 0xCD"],
      [894, "    mov byte [es:0x01], 0x20"],
      [907, "    mov ax, [0x22*4]"],
      [923, "    mov word [es:0x32], MAX_HANDLES"],
      [925, "    mov [es:0x36], ax"],
      [984, "    mov bx, [cs:cur_psp]"],
      [985, "    mov [es:0x16], bx"],
      [986, "    mov bx, [cs:exec_env_seg]"],
      [987, "    mov [es:0x2C], bx"],
      [991, "    call assign_exec_environment_owner"],
      [992, "    call exec_copy_default_fcbs"]],
    hi: [885, 893, 923, 985, 987],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1079, "    mov ax, [cs:exe_reloc_count]"],
      [1082, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1101, "    mov ax, [cs:prog_seg]"],
      [1102, "    call build_psp"],
      [1118, "    mov di, [bx]"],
      [1119, "    mov ax, [bx+2]"],
      [1128, "    mov ax, [es:di]"],
      [1129, "    add ax, [cs:exe_load_seg]"],
      [1130, "    mov [es:di], ax"],
      [1162, "    call exec_exe_dyn"],
      [1201, "exec_com_dyn:"],
      [1231, "    mov ss, ax"],
      [1235, "    push word 0x0100"],
      [1236, "    retf"]],
    hi: [1082, 1102, 1130, 1162, 1201, 1236],
