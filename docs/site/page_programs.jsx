...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2173, ".exec:"],
      [1163, "    cmp al, 0"],
      [2175, "    je .exec_program"],
      [2178, "    cmp al, 3"],
      [2179, "    je .exec_overlay"],
      [2200, "    mov [cs:exec_param_off], bx"],
      [2201, "    mov [cs:exec_param_seg], es"],
      [2202, "    mov [cs:exec_path_off], dx"],
      [2266, "    mov [cs:exec_path_seg], ds"],
      [2232, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      [2329, ".exec_overlay:"],
      [2337, "    mov [cs:ov_param_off], bx"],
      [2342, "    mov ax, [es:bx]"],
      [2343, "    mov [cs:ov_load_seg], ax"],
      [2344, "    mov ax, [es:bx+2]"],
      [2345, "    mov [cs:ov_reloc_seg], ax"],
      [2481, "    call resolve_path"],
      [2381, "    call load_overlay_direct"],
      [781, "    xor ax, ax"],
      [540, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2483, "do_terminate:"],
      [2488, "    call restore_irq1_null_mask"],
      ...
      [2526, "    mov ax, [0x16]"],
      [2528, "    mov [cs:cur_psp], ax"],
      [2537, "    mov ax, [cs:saved_ss]"],
      [2540, "    mov sp, [cs:saved_sp]"],
