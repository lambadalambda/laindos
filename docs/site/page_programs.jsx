...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2698, "do_terminate:"],
      [2703, "    call restore_irq1_null_mask"],
      ...
      [2730, "    mov ax, [0x16]"],
      [2732, "    mov [cs:cur_psp], ax"],
      [2741, "    mov ax, [cs:saved_ss]"],
      [2744, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2698, 2713, 2698, 2730, {a: "do_terminate_return_to_parent"}],
