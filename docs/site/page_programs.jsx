...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [511, "    mov word [cs:exec_env_src_seg], 0"],
      [454, "    mov ax, [cs:exec_param_seg]"],
      [517, "    mov ax, [bx]"],
      [524, "    mov [cs:exec_env_src_seg], ax"],
      [526, ".inherit_parent_env:"],
      [535, "    mov ax, [0x2C]"],
      [524, "    mov [cs:exec_env_src_seg], ax"],
      [566, "    call alloc_exec_environment"],
      [577, ".copy_env:"],
      [592, "    call write_environment_vars"],
      [598, "    mov ax, 1"],
      [599, "    stosw"],
      [600, "    mov ds, [cs:exec_path_seg]"],
  ...
  },
  {
    ...
    code: [
      [1450, "build_psp:"],
      [1458, "    mov byte [es:0x00], 0xCD"],
      [1459, "    mov byte [es:0x01], 0x20"],
      [1472, "    mov ax, [0x22*4]"],
      [1488, "    mov word [es:0x32], MAX_HANDLES"],
      [1490, "    mov [es:0x36], ax"],
      [1491, "    mov bx, [cs:cur_psp]"],
      [1550, "    mov [es:0x16], bx"],
      [780, "    mov bx, [cs:exec_env_seg]"],
      [1552, "    mov [es:0x2C], bx"],
      [1556, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1645, "    mov ax, [cs:exe_reloc_count]"],
      [139, "    cmp dx, 0x1C"],
      [1656, "    mov ax, [cs:prog_seg]"],
      [1652, "    call build_psp"],
      [1669, "    mov di, [bx]"],
      [1670, "    mov ax, [bx+2]"],
      [1679, "    mov ax, [es:di]"],
      [1680, "    add ax, [cs:exe_load_seg]"],
      [1681, "    mov [es:di], ax"],
      [1715, "    call exec_exe_dyn"],
      [1764, "exec_com_dyn:"],
      [1787, "    mov ss, ax"],
      [1791, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2428, "do_terminate:"],
      [2483, "    call restore_irq1_null_mask"],
