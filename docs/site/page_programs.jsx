...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [1475, "build_psp:"],
      [1483, "    mov byte [es:0x00], 0xCD"],
      [1484, "    mov byte [es:0x01], 0x20"],
      [1497, "    mov ax, [0x22*4]"],
      [1513, "    mov word [es:0x32], MAX_HANDLES"],
      [1515, "    mov [es:0x36], ax"],
      [1574, "    mov bx, [cs:cur_psp]"],
      [1575, "    mov [es:0x16], bx"],
      [1576, "    mov bx, [cs:exec_env_seg]"],
      [1577, "    mov [es:0x2C], bx"],
      [1581, "    call assign_exec_environment_owner"],
      [{a: "build_psp_copy_fcbs"}, "    call exec_copy_default_fcbs"]],
    hi: [1475, 1483, 1513, 1575, 1577],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1670, "    mov ax, [cs:exe_reloc_count]"],
      [139, "    cmp dx, 0x1C"],
      [1766, "    mov ax, [cs:prog_seg]"],
      [1677, "    call build_psp"],
      [1694, "    mov di, [bx]"],
      [1695, "    mov ax, [bx+2]"],
      [1704, "    mov ax, [es:di]"],
      [1705, "    add ax, [cs:exe_load_seg]"],
      [1706, "    mov [es:di], ax"],
      [1740, "    call exec_exe_dyn"],
      [1789, "exec_com_dyn:"],
      [1813, "    mov ss, ax"],
      [1817, "    push word 0x0100"],
      [{a: "exec_com_entry_jump"}, "    retf"]],
    hi: [139, 1677, 1706, 1740, 1789, {a: "exec_com_entry_jump"}],
  ...
  },
  {
    ...
    code: [
      [2111, ".exec_overlay:"],
      [2119, "    mov [cs:ov_param_off], bx"],
      [2124, "    mov ax, [es:bx]"],
      [2125, "    mov [cs:ov_load_seg], ax"],
      [2126, "    mov ax, [es:bx+2]"],
      [2127, "    mov [cs:ov_reloc_seg], ax"],
      [2255, "    call resolve_path"],
      [2163, "    call load_overlay_direct"],
      [836, "    xor ax, ax"],
      [555, "    jmp iret_nc"]],
    hi: [2111, 2119, 2124, 2163],
  ...
  },
  {
    ...
    code: [
      [2727, "do_terminate:"],
      [2732, "    call restore_irq1_null_mask"],
      ...
      [2758, "    mov ax, [0x16]"],
      [2760, "    mov [cs:cur_psp], ax"],
      [2769, "    mov ax, [cs:saved_ss]"],
      [2772, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2727, 2741, 2742, 2744, 2750, 2753, 2760, {a: "do_terminate_return_to_parent"}],
