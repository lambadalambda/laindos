...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2795, "do_terminate:"],
      [2799, "    call load_exec_resume_state"],
      [2801, "    call restore_irq1_null_mask"],
      ...
      [2827, "    mov ax, [0x16]"],
      [2829, "    mov [cs:cur_psp], ax"],
      [2838, "    mov ax, [cs:term_resume_ss]"],
      [2841, "    mov sp, [cs:term_resume_sp]"],
      [2842, "    mov ax, [cs:term_resume_kbase]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2795, 2799, 2810, 2811, 2813, 2819, 2822, 2829, 2838, {a: "do_terminate_return_to_parent"}],
