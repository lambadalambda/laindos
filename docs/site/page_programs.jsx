...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2648, "do_terminate:"],
      [2653, "    call restore_irq1_null_mask"],
      ...
      [2680, "    mov ax, [0x16]"],
      [2682, "    mov [cs:cur_psp], ax"],
      [2691, "    mov ax, [cs:saved_ss]"],
      [2694, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2648, 2663, 2648, 2682, {a: "do_terminate_return_to_parent"}],
