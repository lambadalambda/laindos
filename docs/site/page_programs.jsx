...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [2159, ".exec:"],
      [1151, "    cmp al, 0"],
      [2161, "    je .exec_program"],
      [2162, "    cmp al, 3"],
      [2163, "    je .exec_overlay"],
      [2184, "    mov [cs:exec_param_off], bx"],
      [2185, "    mov [cs:exec_param_seg], es"],
      [2186, "    mov [cs:exec_path_off], dx"],
      [2187, "    mov [cs:exec_path_seg], ds"],
      [2188, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    code: [
      [2210, ".exec_overlay:"],
      [2218, "    mov [cs:ov_param_off], bx"],
      [2223, "    mov ax, [es:bx]"],
      [2224, "    mov [cs:ov_load_seg], ax"],
      [2225, "    mov ax, [es:bx+2]"],
      [2226, "    mov [cs:ov_reloc_seg], ax"],
      [2362, "    call resolve_path"],
      [2262, "    call load_overlay_direct"],
      [781, "    xor ax, ax"],
      [528, "    jmp iret_nc"]],
