...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2690, "do_terminate:"],
      [2695, "    call restore_irq1_null_mask"],
      ...
      [2722, "    mov ax, [0x16]"],
      [2724, "    mov [cs:cur_psp], ax"],
      [2733, "    mov ax, [cs:saved_ss]"],
      [2736, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2690, 2705, 2690, 2722, {a: "do_terminate_return_to_parent"}],
