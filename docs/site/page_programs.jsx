...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1932, ".exec:"],
      [1933, "    cmp al, 0"],
      [1934, "    je .exec_program"],
      [1935, "    cmp al, 3"],
      [1936, "    je .exec_overlay"],
      [1958, "    mov [cs:exec_param_off], bx"],
      [1959, "    mov [cs:exec_param_seg], es"],
      [1960, "    mov [cs:exec_path_off], dx"],
      [1961, "    mov [cs:exec_path_seg], ds"],
      [1962, "    call load_exec_program"]],
    hi: [1932, 1958, 1962],
  ...
  },
  {
    ...
    code: [
      ...
      [265, "    mov ax, [cs:exec_param_seg]"],
      [270, "    mov ax, [bx]"],
      [277, "    mov [cs:exec_env_src_seg], ax"],
      [279, "    call alloc_exec_environment"],
      [290, ".copy_env:"],
      [305, "    call write_environment_vars"],
      [311, "    mov ax, 1"],
      [312, "    stosw"],
      [325, "    mov ds, [cs:exec_path_seg]"],
      [400, "    stosb"]],
    hi: [279, 290, 305, 312],
  ...
  },
  {
    ...
    code: [
      [889, "build_psp:"],
      [897, "    mov byte [es:0x00], 0xCD"],
      [898, "    mov byte [es:0x01], 0x20"],
      [911, "    mov ax, [0x22*4]"],
      [927, "    mov word [es:0x32], MAX_HANDLES"],
      [929, "    mov [es:0x36], ax"],
      [988, "    mov bx, [cs:cur_psp]"],
      [989, "    mov [es:0x16], bx"],
      [990, "    mov bx, [cs:exec_env_seg]"],
      [991, "    mov [es:0x2C], bx"],
      [995, "    call assign_exec_environment_owner"],
      [996, "    call exec_copy_default_fcbs"]],
    hi: [889, 897, 927, 989, 991],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1083, "    mov ax, [cs:exe_reloc_count]"],
      [1086, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1105, "    mov ax, [cs:prog_seg]"],
      [1106, "    call build_psp"],
      [1122, "    mov di, [bx]"],
      [1123, "    mov ax, [bx+2]"],
      [1132, "    mov ax, [es:di]"],
      [1133, "    add ax, [cs:exe_load_seg]"],
      [1134, "    mov [es:di], ax"],
      [1166, "    call exec_exe_dyn"],
      [1205, "exec_com_dyn:"],
      [1235, "    mov ss, ax"],
      [1239, "    push word 0x0100"],
      [1240, "    retf"]],
    hi: [1086, 1106, 1134, 1166, 1205, 1240],
  ...
  },
  {
    ...
    code: [
      [1985, ".exec_overlay:"],
      [1993, "    mov [cs:ov_param_off], bx"],
      [1998, "    mov ax, [es:bx]"],
      [1999, "    mov [cs:ov_load_seg], ax"],
      [2000, "    mov ax, [es:bx+2]"],
      [2001, "    mov [cs:ov_reloc_seg], ax"],
      [2004, "    call resolve_path"],
      [2012, "    call load_overlay_direct"],
      [2015, "    xor ax, ax"],
      [2016, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2144, "do_terminate:"],
      [2148, "    call restore_irq1_null_mask"],
      ...
      [2196, "    mov ax, [cs:saved_ss]"],
      [2199, "    mov sp, [cs:saved_sp]"],
      [2201, "    jmp exec_com.back"]],
