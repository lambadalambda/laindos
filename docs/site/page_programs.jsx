...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [883, "build_psp:"],
      [891, "    mov byte [es:0x00], 0xCD"],
      [892, "    mov byte [es:0x01], 0x20"],
      [905, "    mov ax, [0x22*4]"],
      [921, "    mov word [es:0x32], MAX_HANDLES"],
      [923, "    mov [es:0x36], ax"],
      [982, "    mov bx, [cs:cur_psp]"],
      [983, "    mov [es:0x16], bx"],
      [984, "    mov bx, [cs:exec_env_seg]"],
      [985, "    mov [es:0x2C], bx"],
      [989, "    call assign_exec_environment_owner"],
      [990, "    call exec_copy_default_fcbs"]],
    hi: [883, 891, 921, 983, 985],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1077, "    mov ax, [cs:exe_reloc_count]"],
      [1080, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1099, "    mov ax, [cs:prog_seg]"],
      [1100, "    call build_psp"],
      [1116, "    mov di, [bx]"],
      [1117, "    mov ax, [bx+2]"],
      [1126, "    mov ax, [es:di]"],
      [1127, "    add ax, [cs:exe_load_seg]"],
      [1128, "    mov [es:di], ax"],
      [1160, "    call exec_exe_dyn"],
      [1199, "exec_com_dyn:"],
      [1229, "    mov ss, ax"],
      [1233, "    push word 0x0100"],
      [1234, "    retf"]],
    hi: [1080, 1100, 1128, 1160, 1199, 1234],
