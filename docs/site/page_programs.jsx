...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1981, ".exec:"],
      [1172, "    cmp al, 0"],
      [1983, "    je .exec_program"],
      [1986, "    cmp al, 3"],
      [1987, "    je .exec_overlay"],
      [2071, "    mov [cs:exec_param_off], bx"],
      [2072, "    mov [cs:exec_param_seg], es"],
      [2073, "    mov [cs:exec_path_off], dx"],
      [2074, "    mov [cs:exec_path_seg], ds"],
      [2075, "    call load_exec_program"]],
    hi: [1940, 1966, 1970],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [514, "    mov word [cs:exec_env_src_seg], 0"],
      [457, "    mov ax, [cs:exec_param_seg]"],
      [520, "    mov ax, [bx]"],
      [527, "    mov [cs:exec_env_src_seg], ax"],
      [529, ".inherit_parent_env:"],
      [538, "    mov ax, [0x2C]"],
      [527, "    mov [cs:exec_env_src_seg], ax"],
      [569, "    call alloc_exec_environment"],
      [580, ".copy_env:"],
      [595, "    call write_environment_vars"],
      [601, "    mov ax, 1"],
      [602, "    stosw"],
      [603, "    mov ds, [cs:exec_path_seg]"],
  ...
  },
  {
    ...
    code: [
      [1453, "build_psp:"],
      [1461, "    mov byte [es:0x00], 0xCD"],
      [1462, "    mov byte [es:0x01], 0x20"],
      [1475, "    mov ax, [0x22*4]"],
      [1491, "    mov word [es:0x32], MAX_HANDLES"],
      [1493, "    mov [es:0x36], ax"],
      [1494, "    mov bx, [cs:cur_psp]"],
      [1553, "    mov [es:0x16], bx"],
      [783, "    mov bx, [cs:exec_env_seg]"],
      [1555, "    mov [es:0x2C], bx"],
      [1559, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1648, "    mov ax, [cs:exe_reloc_count]"],
      [139, "    cmp dx, 0x1C"],
      [1654, "    mov ax, [cs:prog_seg]"],
      [1655, "    call build_psp"],
      [1672, "    mov di, [bx]"],
      [1673, "    mov ax, [bx+2]"],
      [1682, "    mov ax, [es:di]"],
      [1679, "    add ax, [cs:exe_load_seg]"],
      [1684, "    mov [es:di], ax"],
      [1718, "    call exec_exe_dyn"],
      [1767, "exec_com_dyn:"],
      [1790, "    mov ss, ax"],
      [1794, "    push word 0x0100"],
  ...
  },
  {
    ...
    code: [
      [2137, ".exec_overlay:"],
      [2145, "    mov [cs:ov_param_off], bx"],
      [2150, "    mov ax, [es:bx]"],
      [2151, "    mov [cs:ov_load_seg], ax"],
      [2152, "    mov ax, [es:bx+2]"],
      [2153, "    mov [cs:ov_reloc_seg], ax"],
      [2289, "    call resolve_path"],
      [2189, "    call load_overlay_direct"],
      [790, "    xor ax, ax"],
      [549, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2427, "do_terminate:"],
      [2482, "    call restore_irq1_null_mask"],
      ...
      [2459, "    mov ax, [0x16]"],
      [2533, "    mov [cs:cur_psp], ax"],
      [2538, "    mov ax, [cs:saved_ss]"],
      [2541, "    mov sp, [cs:saved_sp]"],
