...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [389, "    mov ax, [cs:exec_param_seg]"],
      [452, "    mov ax, [bx]"],
      [459, "    mov [cs:exec_env_src_seg], ax"],
      [461, "    call alloc_exec_environment"],
      [472, ".copy_env:"],
      [487, "    call write_environment_vars"],
      [372, "    mov ax, 1"],
      [494, "    stosw"],
      [507, "    mov ds, [cs:exec_path_seg]"],
      [476, "    stosb"]],
    hi: [309, 320, 335, 342],
  ...
  },
  {
    ...
    code: [
      [1265, "build_psp:"],
      [1273, "    mov byte [es:0x00], 0xCD"],
      [1274, "    mov byte [es:0x01], 0x20"],
      [1287, "    mov ax, [0x22*4]"],
      [1303, "    mov word [es:0x32], MAX_HANDLES"],
      [1305, "    mov [es:0x36], ax"],
      [1306, "    mov bx, [cs:cur_psp]"],
      [1365, "    mov [es:0x16], bx"],
      [664, "    mov bx, [cs:exec_env_seg]"],
      [1367, "    mov [es:0x2C], bx"],
      [1371, "    call assign_exec_environment_owner"],
      [1372, "    call exec_copy_default_fcbs"]],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1459, "    mov ax, [cs:exe_reloc_count]"],
      [1462, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1393, "    mov ax, [cs:prog_seg]"],
      [1482, "    call build_psp"],
      [810, "    mov di, [bx]"],
      [811, "    mov ax, [bx+2]"],
      [820, "    mov ax, [es:di]"],
      [1506, "    add ax, [cs:exe_load_seg]"],
      [822, "    mov [es:di], ax"],
      [1543, "    call exec_exe_dyn"],
      [1586, "exec_com_dyn:"],
      [1255, "    mov ss, ax"],
      [1620, "    push word 0x0100"],
      [1584, "    retf"]],
  ...
  },
  {
    ...
    code: [
      ...
      [2063, "    call resolve_path"],
      [2071, "    call load_overlay_direct"],
      [630, "    xor ax, ax"],
      [407, "    jmp iret_nc"]],
  ...
  },
  {
    ...
    code: [
      [2215, "do_terminate:"],
      [2219, "    call restore_irq1_null_mask"],
      ...
      [2267, "    mov ax, [cs:saved_ss]"],
      [2270, "    mov sp, [cs:saved_sp]"],
      [2272, "    jmp exec_com.back"]],
