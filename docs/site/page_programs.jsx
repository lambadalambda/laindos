...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1934, ".exec:"],
      [902, "    cmp al, 0"],
      [1936, "    je .exec_program"],
      [1937, "    cmp al, 3"],
      [1938, "    je .exec_overlay"],
      [1959, "    mov [cs:exec_param_off], bx"],
      [1960, "    mov [cs:exec_param_seg], es"],
      [1961, "    mov [cs:exec_path_off], dx"],
      [1962, "    mov [cs:exec_path_seg], ds"],
