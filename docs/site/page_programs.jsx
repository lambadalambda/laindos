...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      [2684, "do_terminate:"],
      [2689, "    call restore_irq1_null_mask"],
      ...
      [2716, "    mov ax, [0x16]"],
      [2718, "    mov [cs:cur_psp], ax"],
      [2727, "    mov ax, [cs:saved_ss]"],
      [2730, "    mov sp, [cs:saved_sp]"],
      [{a: "do_terminate_return_to_parent"}, "    jmp exec_resume_parent"]],
    hi: [2684, 2699, 2684, 2716, {a: "do_terminate_return_to_parent"}],
