...
const PROGRAM_SECTIONS = [
  ...
  },
  {
    ...
    code: [
      ...
      [490, "    call alloc_exec_environment"],
      [501, ".copy_env:"],
      [516, "    call write_environment_vars"],
      [522, "    mov ax, 1"],
      [523, "    stosw"],
      [524, "    mov ds, [cs:exec_path_seg]"],
  ...
  },
  {
    ...
    code: [
      [1333, "build_psp:"],
      [1341, "    mov byte [es:0x00], 0xCD"],
      [1342, "    mov byte [es:0x01], 0x20"],
      [1355, "    mov ax, [0x22*4]"],
      [1371, "    mov word [es:0x32], MAX_HANDLES"],
      [1373, "    mov [es:0x36], ax"],
      [1374, "    mov bx, [cs:cur_psp]"],
      [1433, "    mov [es:0x16], bx"],
      [699, "    mov bx, [cs:exec_env_seg]"],
      [1435, "    mov [es:0x2C], bx"],
      [1439, "    call assign_exec_environment_owner"],
  ...
  },
  {
    ...
    file: "src/kernel/exec.inc",
    code: [
      [1528, "    mov ax, [cs:exe_reloc_count]"],
      [1531, "    cmp word [cs:exe_reloc_off], 0x1C"],
      [1550, "    mov ax, [cs:prog_seg]"],
      [1551, "    call build_psp"],
      [852, "    mov di, [bx]"],
      [853, "    mov ax, [bx+2]"],
      [862, "    mov ax, [es:di]"],
      [1575, "    add ax, [cs:exe_load_seg]"],
      [864, "    mov [es:di], ax"],
      [1612, "    call exec_exe_dyn"],
      [1657, "exec_com_dyn:"],
      [1687, "    mov ss, ax"],
      [1691, "    push word 0x0100"],
