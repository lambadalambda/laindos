...
const PROGRAM_SECTIONS = [
  {
    ...
    code: [
      [1978, ".exec:"],
      [926, "    cmp al, 0"],
      [1980, "    je .exec_program"],
      [1981, "    cmp al, 3"],
      [1982, "    je .exec_overlay"],
      [2003, "    mov [cs:exec_param_off], bx"],
      [2004, "    mov [cs:exec_param_seg], es"],
      [2005, "    mov [cs:exec_path_off], dx"],
      [2006, "    mov [cs:exec_path_seg], ds"],
  ...
  },
  {
    ...
    code: [
      [2029, ".exec_overlay:"],
      [2037, "    mov [cs:ov_param_off], bx"],
      [2042, "    mov ax, [es:bx]"],
      [2043, "    mov [cs:ov_load_seg], ax"],
      [2044, "    mov ax, [es:bx+2]"],
      [2045, "    mov [cs:ov_reloc_seg], ax"],
      [2048, "    call resolve_path"],
      [2056, "    call load_overlay_direct"],
      [622, "    xor ax, ax"],
      [399, "    jmp iret_nc"]],
