...
- `make test` currently runs the automated QEMU regression ladder and passes `167/167` tests.
...
- Minimal XMS detection, query, single-block allocation, handle-release behavior, XMS block moves, and single-handle EMS.
