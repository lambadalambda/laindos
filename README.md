...
- `make test` currently runs the automated QEMU regression ladder and passes `90/90` tests.
...
Norton Commander has startup, child-launch, and file-copy smokes when `vendor/003064_norton_commander.7z` is present:
